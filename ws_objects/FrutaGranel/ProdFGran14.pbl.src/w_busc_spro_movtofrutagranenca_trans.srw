$PBExportHeader$w_busc_spro_movtofrutagranenca_trans.srw
forward
global type w_busc_spro_movtofrutagranenca_trans from w_busqueda
end type
...
global w_busc_spro_movtofrutagranenca_trans w_busc_spro_movtofrutagranenca_trans

type variables
datawindowchild  idwc_especie, idwc_planta, idwc_especiedet


end variables

on w_busc_spro_movtofrutagranenca_trans.create
int iCurrent
call super::create
end on

on w_busc_spro_movtofrutagranenca_trans.destroy
call super::destroy
end on
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_spro_movtofrutagranenca_trans
...
type dw_1 from w_busqueda`dw_1 within w_busc_spro_movtofrutagranenca_trans
integer x = 41
integer y = 708
integer width = 2816
integer height = 948
integer taborder = 60
string dataobject = "dw_mues_spro_movtofrutagranenca_trans"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_spro_movtofrutagranenca_trans
integer x = 2939
integer y = 1408
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_spro_movtofrutagranenca_trans
integer x = 59
integer y = 80
integer width = 2496
integer height = 580
