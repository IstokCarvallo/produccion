$PBExportHeader$w_maed_spro_lotefrutagranel_apertura_pc.srw
$PBExportComments$Apertura de Lotes Fruta Granel
forward
global type w_maed_spro_lotefrutagranel_apertura_pc from w_mant_encab_deta_csd
end type
type dw_3 from uo_dw within w_maed_spro_lotefrutagranel_apertura_pc
end type
type ids_base from datawindow within w_maed_spro_lotefrutagranel_apertura_pc
end type
type ids_lotedeta from datawindow within w_maed_spro_lotefrutagranel_apertura_pc
end type
type ids_movto from datawindow within w_maed_spro_lotefrutagranel_apertura_pc
end type
type dw_detmovto from datawindow within w_maed_spro_lotefrutagranel_apertura_pc
end type
end forward
...
ids_movto ids_movto
dw_detmovto dw_detmovto
end type
global w_maed_spro_lotefrutagranel_apertura_pc w_maed_spro_lotefrutagranel_apertura_pc
...
on w_maed_spro_lotefrutagranel_apertura_pc.create
int iCurrent
call super::create
...
this.dw_detmovto=create dw_detmovto
...
this.Control[iCurrent+5]=this.dw_detmovto
end on

on w_maed_spro_lotefrutagranel_apertura_pc.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.ids_base)
destroy(this.ids_lotedeta)
destroy(this.ids_movto)
destroy(this.dw_detmovto)
end on
...
dw_detmovto.SetTransObject(SQLCA)
end event

event ue_recuperadatos();Long		ll_fila_d, ll_fila_e, ll_Fila
	...
	ELSE
		DO
			IF dw_3.Retrieve(Integer(istr_mant.argumento[1]), &
				...
				dw_detmovto.Retrieve(gstr_paramplanta.CodigoPlanta, &
...
event ue_antesguardar();Long		ll_Fila = 1, ll_FilaM
Integer	li_Planta, li_Especie, li_NumeroLote, li_LoteOrigen, &
			li_TipoEnvase, li_Envase, li_CantBultos, li_Bultos
...
IF MessageBox("Apertura de Lote", "Está seguro de Abrir Lote : " + &
	...
	DO WHILE ll_Fila <= dw_1.RowCount()
		...
		ELSE
			...
			ids_Movto.Object.mvca_fecmov[ll_FilaM]	=	F_FechaHora()
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_spro_lotefrutagranel_apertura_pc
integer x = 37
integer y = 1336
integer width = 3095
integer height = 792
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_spro_lotefrutagranel_apertura_pc
integer x = 37
integer y = 32
integer width = 3077
integer height = 492
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_spro_lotefrutagranel_apertura_pc
integer x = 3250
integer y = 324
integer taborder = 40
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_spro_lotefrutagranel_apertura_pc
...
type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_spro_lotefrutagranel_apertura_pc
integer x = 3250
integer y = 680
integer taborder = 60
end type
...
type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_spro_lotefrutagranel_apertura_pc
boolean visible = false
integer x = 3250
integer y = 860
integer taborder = 70
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_spro_lotefrutagranel_apertura_pc
integer x = 3250
integer y = 1044
integer taborder = 100
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_spro_lotefrutagranel_apertura_pc
boolean visible = false
integer x = 3264
integer y = 1336
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_spro_lotefrutagranel_apertura_pc
boolean visible = false
integer x = 3264
integer y = 1512
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_spro_lotefrutagranel_apertura_pc
boolean visible = false
integer x = 3255
integer y = 140
integer taborder = 30
...
boolean bringtotop = true
string title = "none"
string dataobject = "dw_mues_movtofrutagraneldeta_apertlote"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
