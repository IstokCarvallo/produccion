...
type variables
Integer	Cliente, Planta, Especie, Variedad, Predio , Cuartel, Packing, &
			Etiqueta, Categoria, Estado
...
public function boolean existe (integer ai_planta, integer ai_cliente, long al_proceso, integer ai_tipo, boolean ab_mensaje, readonly transaction at_transaccion)
end prototypes
...
public function boolean existe (integer ai_planta, integer ai_cliente, long al_proceso, integer ai_tipo, boolean ab_mensaje, readonly transaction at_transaccion);Boolean	lb_Retorno	


lb_Retorno	=	True

SELECT	clie_codigo,	plde_codigo,	orpr_fecpro,	prod_codigo,	espe_codigo,	vari_codigo,	frio_tipofr, orpr_estado
	INTO 	:Cliente, 		:Planta, 		:Fecha, 			:Productor, 	:Especie, 		:Variedad,   :frio_tipofr, :Estado
