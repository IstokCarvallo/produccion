$PBExportHeader$w_mant_lotesfrutagranel_desverd.srw
forward
global type w_mant_lotesfrutagranel_desverd from w_mant_detalle_csd
end type
end forward
...
global w_mant_lotesfrutagranel_desverd w_mant_lotesfrutagranel_desverd
...
ldt_fechaentrada	=	DateTime(dw_1.Object.lode_fecing[dw_1.GetRow()], dw_1.Object.lode_horing[dw_1.GetRow()])
...
If ldt_fechasalida < ldt_fechaentrada Then
	MessageBox("Error de Datos", "La Fecha y Hora de salida no puede ser menor que la Fecha y Hora de entrada", StopSign!)
	Return False
End If

DECLARE hrsdIf PROCEDURE FOR dbo.fgran_horasdIferencia  
...
If ai_columna	=	6 Then
	If IsNull(dw_1.Object.lode_fecing[dw_1.GetRow()]) OR IsNull(Time(ai_horas)) Then Return
	ldt_fechaingreso	=	DateTime(dw_1.Object.lode_fecing[dw_1.GetRow()], Time(ai_horas))										
ElseIf ai_columna	=	7 Then
	If IsNull(Date(ai_horas)) OR IsNull(dw_1.Object.lode_horing[dw_1.GetRow()]) Then Return
	ldt_fechaingreso	=	DateTime(Date(ai_horas), dw_1.Object.lode_horing[dw_1.GetRow()])										
Else
	If IsNull(dw_1.Object.lode_fecing[dw_1.GetRow()]) OR IsNull(dw_1.Object.lode_horing[dw_1.GetRow()]) Then Return
	ldt_fechaingreso	=	DateTime(dw_1.Object.lode_fecing[dw_1.GetRow()],  dw_1.Object.lode_horing[dw_1.GetRow()])
End If
...
CHOOSE CASE ai_columna
	...
	CASE 1
		...
		li_temp	=	dw_1.Object.lode_mohod4[dw_1.GetRow()]
		If IsNull(li_temp) Then li_temp = 0
		li_horas	=	li_horas + li_temp
		
		li_temp	=	dw_1.Object.lode_mohod5[dw_1.GetRow()]
		If IsNull(li_temp) Then li_temp = 0
		li_horas	=	li_horas + li_temp
...
public subroutine habilitalote ();IF istr_mant.Argumento[30] = '1' THEN
	CHOOSE CASE dw_1.Object.lode_estado[il_fila]
		CASE 0
			...
			dw_1.Object.lode_observ.Protect	=	RGB(255, 255, 255)
			dw_1.Object.lode_obsdre.Protect	=	RGB(255, 255, 255)
			dw_1.Object.lode_hordes.Protect	=	RGB(255, 255, 255)

			dw_1.Object.ccag_codigo.Color	=	553648127
			dw_1.Object.lode_fecing.Color		=	553648127
			dw_1.Object.lode_horing.Color		=	553648127
			dw_1.Object.ccev_codigo.Color		=	553648127
			dw_1.Object.lode_hocuhu.Color	=	553648127
...
on w_mant_lotesfrutagranel_desverd.destroy
call super::destroy
end on
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_lotesfrutagranel_desverd
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_lotesfrutagranel_desverd
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_lotesfrutagranel_desverd
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_lotesfrutagranel_desverd
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_lotesfrutagranel_desverd
integer x = 3502
integer y = 308
end type
...
type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_lotesfrutagranel_desverd
integer x = 3502
integer y = 128
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_lotesfrutagranel_desverd
integer x = 3502
integer y = 488
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_lotesfrutagranel_desverd
integer x = 91
integer y = 104
integer width = 3351
integer height = 1384
string dataobject = "dw_mant_spro_lotesfrutagranel_desverd"
end type
...
CHOOSE CASE ls_columna
	CASE "lode_horing"
		CalculaFechaEstimada(6, data)
		
	CASE "lode_fecing"
		CalculaFechaEstimada(7, data)
	...
	CASE "lode_mohod4"
		This.Object.lode_mousu4[row]	=	gstr_us.Nombre
		CalculaFechaEstimada(4, data)
		
	CASE "lode_mohod5"
		This.Object.lode_mousu5[row]	=	gstr_us.Nombre
