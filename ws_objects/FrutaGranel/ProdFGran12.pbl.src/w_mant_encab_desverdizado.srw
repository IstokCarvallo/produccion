$PBExportHeader$w_mant_encab_desverdizado.srw
forward
global type w_mant_encab_desverdizado from w_mant_encab_deta_csd
end type
end forward
...
integer width = 4814
integer height = 2052
string title = "MANTENCION DE DESVERDIZADO DE LOTES"
string menuname = ""
event ue_validapassword ( )
end type
global w_mant_encab_desverdizado w_mant_encab_desverdizado

type variables
w_mant_lotesfrutagranel_desverd	iw_mantencion
...
istr_mant.argumento[10] = String(cliente)
...
on w_mant_encab_desverdizado.create
call super::create
end on

on w_mant_encab_desverdizado.destroy
call super::destroy
end on
		...
		DO
			...
			ELSEIF ll_fila_d = 0 THEN
				MessageBox("Error", "La recepción seleccionada no tiene asociados lotes para "	+	&
										  "desverdizado. ~r~nPor favor, de aviso al encargado del "		+	&
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_mant_encab_desverdizado
integer x = 69
integer y = 972
integer width = 3991
integer height = 852
string title = "Detalle de Lotes Recepcionados a Desverdizado"
string dataobject = "dw_mues_spro_lotesfrutagranel_desverd"
end type
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_mant_encab_desverdizado
integer y = 28
integer width = 3301
integer height = 924
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_mant_encab_desverdizado
integer x = 4261
integer y = 332
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_mant_encab_desverdizado
boolean visible = false
integer x = 4709
integer y = 428
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_mant_encab_desverdizado
integer x = 4261
integer y = 444
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_mant_encab_desverdizado
integer x = 4261
integer y = 624
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_mant_encab_desverdizado
integer x = 4261
integer y = 804
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_mant_encab_desverdizado
boolean visible = false
integer x = 4261
integer y = 1132
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_mant_encab_desverdizado
boolean visible = false
integer x = 4261
integer y = 1304
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_mant_encab_desverdizado
integer x = 4261
integer y = 80
end type
