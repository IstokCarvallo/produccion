...
li_Fila	=	dw_3.Retrieve(Integer(istr_Mant.Argumento[2]), &
								  ...
								  Integer(istr_Mant.Argumento[7]),Integer(istr_Mant.Argumento[13]))
...
//
//FOR li_Fila = 1 TO dw_2.RowCount()
//	IF dw_2.Object.orpd_secuen[li_Fila] > li_Secuencia THEN
//		li_Secuencia = dw_2.Object.orpd_secuen[li_Fila]
//	END IF
//NEXT
//
//li_Secuencia ++
...
This.Height			=	dw_1.Height + dw_2.Height + dw_3.Height + 500
This.Width			=	dw_1.width + 650
