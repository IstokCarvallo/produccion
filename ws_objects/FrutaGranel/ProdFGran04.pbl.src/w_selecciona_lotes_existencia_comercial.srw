$PBExportHeader$w_selecciona_lotes_existencia_comercial.srw
$PBExportComments$Muestra y Selecciona los lotes en existencia
forward
global type w_selecciona_lotes_existencia_comercial from w_mant_detalle_csd
end type
type dw_2 from uo_dw within w_selecciona_lotes_existencia_comercial
end type
type pb_ins_det from picturebutton within w_selecciona_lotes_existencia_comercial
end type
type pb_eli_det from picturebutton within w_selecciona_lotes_existencia_comercial
end type
type st_1 from statictext within w_selecciona_lotes_existencia_comercial
end type
type em_total from editmask within w_selecciona_lotes_existencia_comercial
end type
type dw_3 from uo_dw within w_selecciona_lotes_existencia_comercial
end type
type st_3 from statictext within w_selecciona_lotes_existencia_comercial
end type
type cb_aplicar from commandbutton within w_selecciona_lotes_existencia_comercial
end type
type cb_aplicatodo from commandbutton within w_selecciona_lotes_existencia_comercial
end type
type st_4 from statictext within w_selecciona_lotes_existencia_comercial
end type
type cb_desaplica from commandbutton within w_selecciona_lotes_existencia_comercial
end type
type cb_desaplicatodo from commandbutton within w_selecciona_lotes_existencia_comercial
end type
type st_5 from statictext within w_selecciona_lotes_existencia_comercial
end type
end forward
...
global w_selecciona_lotes_existencia_comercial w_selecciona_lotes_existencia_comercial
...
on w_selecciona_lotes_existencia_comercial.create
int iCurrent
call super::create
...
on w_selecciona_lotes_existencia_comercial.destroy
call super::destroy
destroy(this.dw_2)
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_selecciona_lotes_existencia_comercial
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_selecciona_lotes_existencia_comercial
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_selecciona_lotes_existencia_comercial
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_selecciona_lotes_existencia_comercial
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_selecciona_lotes_existencia_comercial
integer x = 3159
integer y = 284
integer taborder = 50
end type
...
type pb_acepta from w_mant_detalle_csd`pb_acepta within w_selecciona_lotes_existencia_comercial
integer x = 3159
integer y = 108
integer taborder = 40
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_selecciona_lotes_existencia_comercial
integer x = 3159
integer y = 456
integer taborder = 60
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_selecciona_lotes_existencia_comercial
integer x = 69
integer y = 68
integer width = 2903
integer height = 408
