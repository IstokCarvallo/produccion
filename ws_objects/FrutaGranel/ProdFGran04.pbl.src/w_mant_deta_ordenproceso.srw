$PBExportHeader$w_mant_deta_ordenproceso.srw
$PBExportComments$Mantención Detalle de Ordenes de Proceso
forward
global type w_mant_deta_ordenproceso from w_mant_detalle_csd
end type
type dw_2 from uo_dw within w_mant_deta_ordenproceso
end type
type pb_ins_det from picturebutton within w_mant_deta_ordenproceso
end type
type pb_eli_det from picturebutton within w_mant_deta_ordenproceso
end type
type st_1 from statictext within w_mant_deta_ordenproceso
end type
type em_total from editmask within w_mant_deta_ordenproceso
end type
type dw_3 from uo_dw within w_mant_deta_ordenproceso
end type
type st_3 from statictext within w_mant_deta_ordenproceso
end type
type cb_aplicar from commandbutton within w_mant_deta_ordenproceso
end type
type cb_aplicatodo from commandbutton within w_mant_deta_ordenproceso
end type
type st_4 from statictext within w_mant_deta_ordenproceso
end type
type cb_desaplica from commandbutton within w_mant_deta_ordenproceso
end type
type cb_desaplicatodo from commandbutton within w_mant_deta_ordenproceso
end type
type st_5 from statictext within w_mant_deta_ordenproceso
end type
end forward
...
global w_mant_deta_ordenproceso w_mant_deta_ordenproceso
...
on w_mant_deta_ordenproceso.create
int iCurrent
call super::create
...
on w_mant_deta_ordenproceso.destroy
call super::destroy
destroy(this.dw_2)
...
dw_2.SetFilter("")
dw_2.Filter()
dw_2.SetFilter("orpr_numero = " + istr_mant.Argumento[9] + " And orpr_tipord = " + istr_mant.Argumento[12])
dw_2.Filter()
...
FOR li_Fila = 1 TO dw_2.RowCount()
	IF dw_2.Getitemstatus(li_fila,0,Primary!) = NewModified! THEN
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ordenproceso
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ordenproceso
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ordenproceso
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ordenproceso
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ordenproceso
integer x = 3154
integer y = 364
integer taborder = 50
...
type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ordenproceso
integer x = 3159
integer y = 108
integer taborder = 40
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ordenproceso
integer x = 3159
integer y = 632
integer taborder = 60
end type
...
type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ordenproceso
integer x = 110
integer y = 116
integer width = 2843
integer height = 344
