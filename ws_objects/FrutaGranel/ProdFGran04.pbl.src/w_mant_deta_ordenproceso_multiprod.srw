$PBExportHeader$w_mant_deta_ordenproceso_multiprod.srw
$PBExportComments$Mantención Detalle de Ordenes de Proceso
forward
global type w_mant_deta_ordenproceso_multiprod from w_mant_detalle_csd
end type
type dw_2 from uo_dw within w_mant_deta_ordenproceso_multiprod
end type
type pb_ins_det from picturebutton within w_mant_deta_ordenproceso_multiprod
end type
type pb_eli_det from picturebutton within w_mant_deta_ordenproceso_multiprod
end type
type st_1 from statictext within w_mant_deta_ordenproceso_multiprod
end type
type em_total from editmask within w_mant_deta_ordenproceso_multiprod
end type
type dw_3 from uo_dw within w_mant_deta_ordenproceso_multiprod
end type
type st_3 from statictext within w_mant_deta_ordenproceso_multiprod
end type
type cb_aplicar from commandbutton within w_mant_deta_ordenproceso_multiprod
end type
type cb_aplicatodo from commandbutton within w_mant_deta_ordenproceso_multiprod
end type
type st_4 from statictext within w_mant_deta_ordenproceso_multiprod
end type
type cb_desaplica from commandbutton within w_mant_deta_ordenproceso_multiprod
end type
type cb_desaplicatodo from commandbutton within w_mant_deta_ordenproceso_multiprod
end type
type st_5 from statictext within w_mant_deta_ordenproceso_multiprod
end type
end forward
...
global w_mant_deta_ordenproceso_multiprod w_mant_deta_ordenproceso_multiprod
...
on w_mant_deta_ordenproceso_multiprod.create
int iCurrent
call super::create
...
on w_mant_deta_ordenproceso_multiprod.destroy
call super::destroy
destroy(this.dw_2)
...
li_Fila	=	dw_3.Retrieve(Integer(istr_Mant.Argumento[2]), &
								  ...
								  gstr_paramplanta.MinBulProceso)
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ordenproceso_multiprod
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ordenproceso_multiprod
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ordenproceso_multiprod
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ordenproceso_multiprod
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ordenproceso_multiprod
integer x = 3159
integer y = 360
integer taborder = 50
...
type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ordenproceso_multiprod
integer x = 3159
integer y = 108
integer taborder = 40
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ordenproceso_multiprod
integer x = 3159
integer y = 616
integer taborder = 60
end type
...
type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ordenproceso_multiprod
integer x = 96
integer y = 132
integer width = 2839
integer height = 336
...
string dataobject = "dw_mant_spro_lotes_clasificados_multipro"
boolean hscrollbar = true
boolean livescroll = true
end type
