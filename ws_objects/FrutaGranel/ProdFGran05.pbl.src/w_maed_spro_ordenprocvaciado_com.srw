$PBExportHeader$w_maed_spro_ordenprocvaciado_com.srw
forward
global type w_maed_spro_ordenprocvaciado_com from w_mant_encab_deta_csd
end type
type dw_3 from datawindow within w_maed_spro_ordenprocvaciado_com
end type
type dw_4 from datawindow within w_maed_spro_ordenprocvaciado_com
end type
end forward
...
global w_maed_spro_ordenprocvaciado_com w_maed_spro_ordenprocvaciado_com
...
ELSE
	...
	dw_2.Object.opve_fecvac.BackGround.Color	=	RGB(192,192,192)
	dw_2.Object.opve_turno.Protect				=	1
	dw_2.Object.opve_turno.BackGround.Color	=	RGB(192,192,192)
	dw_2.Object.orpr_tipord.Protect				=	1
	dw_2.Object.orpr_tipord.BackGround.Color	=	RGB(192,192,192)
	dw_2.Object.orpr_numero.Protect				=	1
	dw_2.Object.orpr_numero.BackGround.Color	=	RGB(192,192,192)
...
ELSEIF sqlca.SQLCode<>100 THEN
	...
	SELECT	mfcd_bulent
		...
		WHERE	plde_codigo		=	:gstr_ParamPlanta.CodigoPlanta
			...
			AND  lofc_pltcod 		=  :li_lotepl
			AND  lofc_espcod		=	:li_lotesp
...
SELECT	Count(*)
	INTO	:li_Cantidad
	FROM	dba.spro_ordenprocvacenca as sop
...
SELECT 	Sum(mfgp.lfcd_kilnet)
	INTO 	:ldec_KilOri
	FROM 	dba.spro_lotesfrutacomdeta as mfgp
...
on w_maed_spro_ordenprocvaciado_com.create
int iCurrent
call super::create
...
on w_maed_spro_ordenprocvaciado_com.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.dw_4)
end on
...
IF gstr_paramplanta.binsabins OR gstr_paramplanta.palletdebins THEN
...
IF NOT gstr_paramplanta.binsabins AND NOT gstr_paramplanta.palletdebins THEN
...
event ue_modifica_detalle;call super::ue_modifica_detalle;IF NOT gstr_paramplanta.binsabins AND NOT gstr_paramplanta.palletdebins THEN
	IF dw_1.RowCount() > 0 THEN
...
//				li_lotepl	=	Integer(Mid(dw_1.Object.lote[ll_fila],1,4))
//				li_lotesp	=	Integer(mid(dw_1.Object.lote[ll_fila],5,2))
//				li_lote		=	Integer(mid(dw_1.Object.lote[ll_fila],7,10))
				 
//				dw_1.Object.lote_pltcod[ll_Fila]	=	li_lotepl
//				dw_1.Object.lote_espcod[ll_Fila]	=	li_lotesp
//				dw_1.Object.lote_codigo[ll_Fila]	=	li_lote
				PesoOriginalBultos()
			ELSE
				PesosBultoABulto()
			END IF
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_spro_ordenprocvaciado_com
integer x = 46
integer y = 676
integer width = 3159
integer height = 1112
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_spro_ordenprocvaciado_com
integer x = 59
integer y = 52
integer width = 3017
integer height = 596
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_spro_ordenprocvaciado_com
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_spro_ordenprocvaciado_com
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_spro_ordenprocvaciado_com
integer weight = 400
fontcharset fontcharset = ansi!
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_spro_ordenprocvaciado_com
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_spro_ordenprocvaciado_com
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_spro_ordenprocvaciado_com
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_spro_ordenprocvaciado_com
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_spro_ordenprocvaciado_com
end type
