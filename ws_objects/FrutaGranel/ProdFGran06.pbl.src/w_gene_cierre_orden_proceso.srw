$PBExportHeader$w_gene_cierre_orden_proceso.srw
$PBExportComments$Genera Datos para Pronóstico de Cierre
forward
global type w_gene_cierre_orden_proceso from window
end type
type uo_selcliente from uo_seleccion_clientesprod within w_gene_cierre_orden_proceso
end type
type uo_selplanta from uo_seleccion_plantas within w_gene_cierre_orden_proceso
end type
type st_12 from statictext within w_gene_cierre_orden_proceso
end type
type st_9 from statictext within w_gene_cierre_orden_proceso
end type
type sle_prod from singlelineedit within w_gene_cierre_orden_proceso
end type
type sle_codpro from singlelineedit within w_gene_cierre_orden_proceso
end type
type st_20 from statictext within w_gene_cierre_orden_proceso
end type
type sle_varie from singlelineedit within w_gene_cierre_orden_proceso
end type
type sle_codvar from singlelineedit within w_gene_cierre_orden_proceso
end type
type sle_espe from singlelineedit within w_gene_cierre_orden_proceso
end type
type sle_codesp from singlelineedit within w_gene_cierre_orden_proceso
end type
type cb_1 from commandbutton within w_gene_cierre_orden_proceso
end type
type em_fecha from editmask within w_gene_cierre_orden_proceso
end type
type st_8 from statictext within w_gene_cierre_orden_proceso
end type
type em_proceso from editmask within w_gene_cierre_orden_proceso
end type
type st_7 from statictext within w_gene_cierre_orden_proceso
end type
type ddlb_tipoproc from dropdownlistbox within w_gene_cierre_orden_proceso
end type
type st_6 from statictext within w_gene_cierre_orden_proceso
end type
type sle_mensa from singlelineedit within w_gene_cierre_orden_proceso
end type
type st_5 from statictext within w_gene_cierre_orden_proceso
end type
type pb_salir from picturebutton within w_gene_cierre_orden_proceso
end type
type pb_acepta from picturebutton within w_gene_cierre_orden_proceso
end type
type st_4 from statictext within w_gene_cierre_orden_proceso
end type
type st_2 from statictext within w_gene_cierre_orden_proceso
end type
type st_1 from statictext within w_gene_cierre_orden_proceso
end type
type st_titulo from statictext within w_gene_cierre_orden_proceso
end type
type r_1 from rectangle within w_gene_cierre_orden_proceso
end type
type st_3 from statictext within w_gene_cierre_orden_proceso
end type
end forward
...
global w_gene_cierre_orden_proceso w_gene_cierre_orden_proceso
...
public function boolean buscaorden (long al_orden, integer ai_tipo);Integer li_especie, li_variedad, li_estado, li_Cliente
...
ELSEIF sqlca.SQLCode <> 100 THEN
   ...
   IF li_estado = 1 THEN
   	sle_mensa.text    =  'Vigente'
		...
		Messagebox("Error", "La orden ingresada no se puede cerrar, ya que no ha sido realizado el termino de proceso", StopSign!)
		Return False
...
on w_gene_cierre_orden_proceso.create
...
on w_gene_cierre_orden_proceso.destroy
...
IF sle_mensa.text	= "Cerrada" THEN
	MessageBox("Atención","La Orden de Proceso ya se encuentra Cerrada",Exclamation!)
	Return 1
END IF
...
UPDATE dbo.spro_movtofrutagranenca  SET mfge_estmov = 3
...
Update dbo.spro_ordenproceso SET orpr_estado = 3
 WHERE plde_codigo	=	:uo_SelPlanta.Codigo
