$PBExportHeader$w_info_resultado_contratista_palletfruta.srw
$PBExportComments$Resultado de Proceso Kilos
forward
global type w_info_resultado_contratista_palletfruta from w_para_informes
end type
type cb_buscaorden from commandbutton within w_info_resultado_contratista_palletfruta
end type
type em_fecdes from editmask within w_info_resultado_contratista_palletfruta
end type
type st_fecha from statictext within w_info_resultado_contratista_palletfruta
end type
type em_proceso from editmask within w_info_resultado_contratista_palletfruta
end type
type st_7 from statictext within w_info_resultado_contratista_palletfruta
end type
type st_6 from statictext within w_info_resultado_contratista_palletfruta
end type
type st_2 from statictext within w_info_resultado_contratista_palletfruta
end type
type ddlb_tipoproc from dropdownlistbox within w_info_resultado_contratista_palletfruta
end type
type cbx_todosproc from checkbox within w_info_resultado_contratista_palletfruta
end type
type em_fecter from editmask within w_info_resultado_contratista_palletfruta
end type
type st_12 from statictext within w_info_resultado_contratista_palletfruta
end type
type st_1 from statictext within w_info_resultado_contratista_palletfruta
end type
type st_3 from statictext within w_info_resultado_contratista_palletfruta
end type
type cbx_todfec from checkbox within w_info_resultado_contratista_palletfruta
end type
type gb_3 from groupbox within w_info_resultado_contratista_palletfruta
end type
type st_fecter from statictext within w_info_resultado_contratista_palletfruta
end type
type st_9 from statictext within w_info_resultado_contratista_palletfruta
end type
type uo_selcontratista from uo_seleccion_contratista within w_info_resultado_contratista_palletfruta
end type
type uo_selcliente from uo_seleccion_clientesprod within w_info_resultado_contratista_palletfruta
end type
type uo_selplantas from uo_seleccion_plantas within w_info_resultado_contratista_palletfruta
end type
end forward
...
integer width = 2514
integer height = 1652
string title = "Informe Contratista Cajas Emitidas"
...
global w_info_resultado_contratista_palletfruta w_info_resultado_contratista_palletfruta
...
on w_info_resultado_contratista_palletfruta.create
int iCurrent
call super::create
...
this.Control[iCurrent+18]=this.uo_selcontratista
this.Control[iCurrent+19]=this.uo_selcliente
this.Control[iCurrent+20]=this.uo_selplantas
end on

on w_info_resultado_contratista_palletfruta.destroy
call super::destroy
...
type pb_excel from w_para_informes`pb_excel within w_info_resultado_contratista_palletfruta
end type

type st_computador from w_para_informes`st_computador within w_info_resultado_contratista_palletfruta
end type

type st_usuario from w_para_informes`st_usuario within w_info_resultado_contratista_palletfruta
end type

type st_temporada from w_para_informes`st_temporada within w_info_resultado_contratista_palletfruta
end type

type p_logo from w_para_informes`p_logo within w_info_resultado_contratista_palletfruta
string picturename = "\Desarrollo 17\Imagenes\Logos\RBlanco.jpg"
end type

type st_titulo from w_para_informes`st_titulo within w_info_resultado_contratista_palletfruta
integer width = 1755
string text = "Informe Contratista Cajas Emitidas"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_resultado_contratista_palletfruta
integer x = 2062
integer y = 828
integer taborder = 80
end type
...
Integer 	li_Especie, li_Variedad, li_origen = 1, &
			li_ConsPredio, li_TipoInforme, li_Linea, li_Periodo, li_ConsFecha
...
istr_info.Titulo		=	"Informe Contratista Cajas Emitidas"
...
Vinf.dw_1.DataObject =	"dw_info_procesokilos_contratista_palletfruta"
...
ll_Fila	=	vinf.dw_1.Retrieve(uo_SelCliente.Codigo, uo_SelPlantas.Codigo, ii_TipoOrden,ll_orden, ll_Productor,&
									    ...
									    ld_fecter, li_ConsPredio,li_ConsFecha,uo_SelContratista.Codigo,li_origen)
...
type pb_salir from w_para_informes`pb_salir within w_info_resultado_contratista_palletfruta
integer x = 2062
integer y = 1092
integer taborder = 90
end type
