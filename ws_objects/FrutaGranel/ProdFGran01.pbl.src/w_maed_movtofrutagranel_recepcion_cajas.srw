$PBExportHeader$w_maed_movtofrutagranel_recepcion_cajas.srw
$PBExportComments$Recepción de Fruta Granel de Huerto
forward
global type w_maed_movtofrutagranel_recepcion_cajas from w_mant_encab_deta_csd
end type
type cb_guia from commandbutton within w_maed_movtofrutagranel_recepcion_cajas
end type
type dw_4 from datawindow within w_maed_movtofrutagranel_recepcion_cajas
end type
type dw_spro_bins from datawindow within w_maed_movtofrutagranel_recepcion_cajas
end type
type dw_9 from datawindow within w_maed_movtofrutagranel_recepcion_cajas
end type
type dw_6 from datawindow within w_maed_movtofrutagranel_recepcion_cajas
end type
type ole_puerta from olecustomcontrol within w_maed_movtofrutagranel_recepcion_cajas
end type
type tab_1 from tab within w_maed_movtofrutagranel_recepcion_cajas
end type
...
type ole_puerta1 from olecustomcontrol within w_maed_movtofrutagranel_recepcion_cajas
end type
type str_productores_envases from structure within w_maed_movtofrutagranel_recepcion_cajas
end type
type str_pesaje from structure within w_maed_movtofrutagranel_recepcion_cajas
end type
type productoresxlote from structure within w_maed_movtofrutagranel_recepcion_cajas
end type
end forward
...
global w_maed_movtofrutagranel_recepcion_cajas w_maed_movtofrutagranel_recepcion_cajas
...
dw_2.Object.buscacamion.Enabled	=	TRUE 
...
ll_Numero			=	luo_OrdenProceso.MaximoNumero(li_plde_codigo, 4, Sqlca, li_clie_codigo)
...
VALUES ( :li_plde_codigo, 4, :ll_Numero,   
...
INSERT INTO dbo.spro_terminoproceso  
		( plde_codigo, tpmv_codigo, tepr_numero,   
		  ...
		  tepr_bulvac )  
VALUES (:li_plde_codigo, 21, :ll_Numero,   
...
//integer 	li_clie_codigo, li_i, li_hora, li_mins, li_mfge_numero, li_error
//date 		ld_date_actual
//
////---------------variables para spro_ordenprocvacdeta
//String 	ls_cale_calida
...
//
////---------------variables para lotefrutagranel
//integer 	li_vari_codigo, li_prod_codigo, li_flag
//
////---------------variables para lotefrutagrandeta
//integer 	li_plde_codigo, li_lote_espcod, li_lote_codigo, li_enva_tipoen, &
//		  	li_enva_codigo, li_lotd_totbul, li_lotd_totnet, li_lotd_kilpro
...
//lt_hora_tvaciado 	= 	time(li_hora + 1, li_mins,0)
//
// DECLARE ProcesoPacking PROCEDURE FOR dbo.fgran_movimientopackingauto  
//         @clie_codigo 		= 	:li_clie_codigo,   
//         @plde_codigo 		= 	:li_plde_codigo,   
//         @mfge_numero 	= 	:li_mfge_numero,   
//         @lote_espcod 		= 	:li_lote_espcod,   
//         @lote_codigo 		= 	:li_lote_codigo,   
//         @enva_tipoen 		=	:li_enva_tipoen,   
//         @enva_codigo 		= 	:li_enva_codigo,   
//         @lotd_totbul 		= 	:li_lotd_totbul,   
//         @lotd_totnet 		= 	:li_lotd_totnet,   
//         @lotd_kilpro 		= 	:li_lotd_kilpro,   
//         @date_actual 		= 	:ld_date_actual,
//		@hora_ivaciado 	= 	:lt_hora_ivaciado,
//		@hora_tvaciado 	= 	:lt_hora_tvaciado
//Using SQLCA;
//Execute ProcesoPacking;
//Fetch ProcesoPacking into :li_error, :li_flag, :a1, :a2, :a3, :a4, :a5, :a6, :a7, :a8, :a9, :a10, :a11, :a12, :a13, :a14;
///*		@plde_codigo,    21,             @mfge_numero,   
//               @clie_codigo,    correl,         @plde_codigo,   
//               0,               lote_pltcod,    lote_espcod,   
//               lote_codigo,     enva_tipoen,    enva_codigo,   
//               lotd_totbul,     lotd_totnet*/
//IF SQLCA.SQLCode <> 0 THEN
//	F_ErrorBaseDatos(SQLCA,"Proceso Automático Packing Terceros")
//	RETURN FALSE
//END IF
//IF li_error <> 0 THEN
//	MessageBox("Atención","El proceso automatico ha encontrado un error, no es posible completar la grabación.~nCodigo de error : " + String(li_error) + ", " +String(li_flag))
//	Return FALSE
//ELSE
//	RETURN TRUE
//END IF
...
on w_maed_movtofrutagranel_recepcion_cajas.create
int iCurrent
call super::create
...
this.Control[iCurrent+6]=this.ole_puerta
this.Control[iCurrent+7]=this.tab_1
this.Control[iCurrent+8]=this.ole_puerta1
end on

on w_maed_movtofrutagranel_recepcion_cajas.destroy
call super::destroy
...
//dw_2.Object.lote_pakori.visible 		= 	TRUE
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_movtofrutagranel_recepcion_cajas
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_movtofrutagranel_recepcion_cajas
integer x = 128
integer y = 0
integer width = 3479
integer height = 1032
...
CHOOSE CASE ls_Columna
	...
	CASE "mfge_numero"
		IF NOT ExisteRecepcion(gstr_ParamPlanta.CodigoPlanta, 1, Integer(data),Integer(istr_mant.argumento[10])) THEN
...
//			This.SetItem(1, "lote_pakori", Integer(ls_Nula) )
//			This.SetFocus()
//			RETURN 1
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 280
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 456
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 640
boolean enabled = true
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 820
end type
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 1000
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 1472
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 1644
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_movtofrutagranel_recepcion_cajas
integer x = 4366
integer y = 96
end type
...
string binarykey = "w_maed_movtofrutagranel_recepcion_cajas.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
event doubleclicked;call super::doubleclicked;w_maed_movtofrutagranel_recepcion_cajas.TriggerEvent("ue_modifica_detalle")
...
0Bw_maed_movtofrutagranel_recepcion_cajas.bin 
...
1Bw_maed_movtofrutagranel_recepcion_cajas.bin 
