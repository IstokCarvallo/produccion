$PBExportHeader$w_maed_movtofrutagranel_recepcion.srw
$PBExportComments$Recepción de Fruta Granel de Huerto
forward
global type w_maed_movtofrutagranel_recepcion from w_mant_encab_deta_csd
end type
type cb_guia from commandbutton within w_maed_movtofrutagranel_recepcion
end type
type dw_4 from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_spro_bins from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_9 from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_6 from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_exideta from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_exiencab from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_exismovtodetanulos from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_exidetaborra from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_envases_comer from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_lotescategoria from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_pdf from uo_dw within w_maed_movtofrutagranel_recepcion
end type
type dw_docto from uo_dw within w_maed_movtofrutagranel_recepcion
end type
type dw_desverd from datawindow within w_maed_movtofrutagranel_recepcion
end type
type dw_anexopesaje from datawindow within w_maed_movtofrutagranel_recepcion
end type
type ole_puerta from olecustomcontrol within w_maed_movtofrutagranel_recepcion
end type
type tab_1 from tab within w_maed_movtofrutagranel_recepcion
end type
...
type str_productores_envases from structure within w_maed_movtofrutagranel_recepcion
end type
type str_pesaje from structure within w_maed_movtofrutagranel_recepcion
end type
type productoresxlote from structure within w_maed_movtofrutagranel_recepcion
end type
type str_envase from structure within w_maed_movtofrutagranel_recepcion
end type
end forward
...
event type integer ue_despuesguardar ( )
event ue_despuesborrar ( )
event ue_despuesborrar2 ( )
event type integer ue_despuesguardar2 ( )
event anulamovto ( )
event anulamovto2 ( )
cb_guia cb_guia
dw_4 dw_4
...
dw_anexopesaje dw_anexopesaje
ole_puerta ole_puerta
tab_1 tab_1
end type
global w_maed_movtofrutagranel_recepcion w_maed_movtofrutagranel_recepcion
...
Boolean				ib_AutoCommit, ib_Salida, ib_Destare, ib_ocx, ib_graba_destare, ib_ConectadoExistencia
String					is_rut, is_rutprod, is_RutProductor, is_NombreProductor, is_chofer
Integer				ii_Cantidad, ii_Productor, ii_kildec=0, ii_especie, il_coneccion, il_conexiste, il_packing
DateTime			idt_FechaSistema
Decimal				id_KilosEnv
String					is_enva_tipoen[], is_enva_codigo[], is_cale_calida[], is_cantidad[], is_pesone[], is_cale_nombre[], is_error, is_correo
...
Integer 				li_imprimir, li_bultos = 1, li_tarjas
...
If li_imprimir <> 3 Then
	...
	DO 
		...
		ll_fila	= lds_Informe.Retrieve(dw_2.Object.plde_codigo[dw_2.GetRow()],Integer(istr_mant.argumento[10]),&
										  Integer(istr_mant.argumento[2]),dw_2.Object.mfge_numero[dw_2.GetRow()])
		If fila = -1 Then
		...
		Else
			FOR ll_fila = 1 TO tab_1.tp_1.dw_lotes.RowCount()
				...
				If li_imprimir = 1 Then li_bultos	=	tab_1.tp_1.dw_lotes.Object.lote_totbul[ll_fila]
...
If li_imprimir = 1 Then
	dw_anexopesaje.Reset()
	
//	If NOT gstr_paramplanta.palletdebins Then
//		dw_anexopesaje.DataObject = "dw_info_anexo_pesaje_recepcion_granel"
//	Else
		dw_anexopesaje.DataObject = "dw_info_anexo_pesaje_recepcion_granel"
//	End If
	
	dw_anexopesaje.SetTransObject(Sqlca)
	ll_fila	= dw_anexopesaje.Retrieve(dw_2.Object.plde_codigo[dw_2.GetRow()],&
										  Integer(istr_mant.argumento[2]),dw_2.Object.mfge_numero[dw_2.GetRow()],&
	...
	Else
		f_membrete(dw_anexopesaje)
		dw_anexopesaje.Print()
	End If
End If
end event

event type integer ue_despuesguardar();integer	li_bodega, li_fila, li_cliente, li_enva_codigo, li_enva_tipoen, &
...
String	ls_item_codigo, ls_productor, ls_prod, ls_calidad, ls_calilote, ls_correozonal, ls_correo, ls_texto, ls_asunto, ls_error, serrormsg, ERRORS,sql_syntax
	...
	FOR ll_filote = 1 TO dw_lotescategoria.RowCount()
		...
		FOR ll_filaenva = 1 TO dw_envases_comer.RowCount()			
			IF li_secuencia = 1 THEN
				...
				IF luo_existencia.count = 0 THEN
					IF Not luo_existencia.correlativobode(1,li_bodzonal,li_bodzonal,True,sqlexi) THEN
						Message.DoubleParm = -1
						is_error = 'Error en Correlativo Bodega '+ String(li_bodzonal)
						li_retorno = 2
						RETURN 2
					ELSE
						ll_numero = luo_existencia.numero
					...
					IF isnull(dw_3.Object.lote_prdpak[1]) THEN
						IF NOT packingproductor(long(ls_productor)) THEN
							...
							iuo_Mail.Of_Send({ls_correo},ls_asunto,ls_texto,2)
			...
			IF Not iuo_calicosechero.Existe(li_enva_tipoen,li_enva_codigo,ls_calidad,True,sqlca) THEN
				Message.DoubleParm = -1
				li_retorno = 2
				is_error = 'Error con los Envases o Item'
				RETURN 2
			ELSE
...
event type integer ue_despuesguardar2();integer	li_bodega, li_fila, li_cliente, li_enva_codigo, li_enva_tipoen, &
			li_bodevirtual, li_bodzonal, li_planta, li_tipomov, li_lote, li_categoria, li_envase,li_tipoenva,li_bodecomercial, li_devcorreo
Long 		ll_fila, ll_numero, li_secuencia = 1, ll_numnuevoini, ll_numnuevofin, ll_count, ll_docrel, &
			ll_recepcion, ll_filote, ll_filas, ll_Filexiste, ll_filaenva, ll_cantidad, ll_secuencia2
...
//					END IF
				...
				IF luo_existencia.count = 0 THEN
					...
					dw_exiencab.Object.mden_docrel[1] = dw_2.Object.mfge_numero[1]
					dw_exiencab.Object.mden_fecdre[1] = dw_2.Object.mfge_fecmov[1]
					dw_exiencab.Object.mden_observ[1] = 'Recepción Fruta Envases Fruta Granel'
					dw_exiencab.Object.mden_estado[1] = 1
					dw_exiencab.Object.mden_pcopda[1] = 1
					dw_exiencab.Object.mden_gdprod[1] = dw_4.Object.meen_guisii[1]
				ELSE
...
dw_2.Object.refg_fecsal.Color		=	0
...
IF NOT gstr_paramplanta.semipacking THEN
	Return ProcesoPackingFull()
END IF
...
//VALUES ( :li_clie_codigo, :li_plde_codigo, 21,
//		  :li_lote_codigo, :li_plde_codigo, :ll_prod_codigo,
//		  null, null, null,
...
For Li_i = 1 to dw_6.RowCount()	
	...
	INSERT INTO dbo.spro_ordenproceso  
		( clie_codigo, plde_codigo, orpr_tipord,   
		  ...
		  ppre_feccre )  
	VALUES (:li_clie_codigo, :li_plde_codigo, 4,   
	  :li_lote_codigo, :ld_date_actual, :ll_prod_codigo,   
...
FOR li_rectipenv = LowerBound(is_enva_tipoen) TO UpperBound(is_enva_tipoen)
	IF Integer(is_enva_tipoen[li_rectipenv]) > 0 THEN
		...
		Tab_1.Tp_2.dw_envrec.Object.prod_codigo[li_filadw_5]		=	Tab_1.Tp_1.dw_lotes.Object.prod_codigo[il_fila]
		Tab_1.Tp_2.dw_envrec.Object.prod_nombre[li_filadw_5]	=	Tab_1.Tp_1.dw_lotes.Object.prod_nombre[il_fila]
	...
	If dw_pdf.Update(True,False) = 1 THEN
			...
			ELSE
				...
				For ll_Fila = 1 To dw_pdf.RowCount()
					If wf_CreaArchivo('c:\'+dw_pdf.Object.rehu_archiv[ll_Fila]) Then
...
ll_Resultado 			= dw_docto.Retrieve(Long(istr_mant.Argumento[1]),Long(istr_mant.Argumento[2]), &
							Long(istr_mant.Argumento[3]),	Integer(istr_mant.argumento[10]), ld_FechaRecepcion, ld_FechaRecepcion)
...
public function boolean procesopackingfull ();integer 	li_clie_codigo, li_i, li_hora, li_mins, li_mfge_numero
date 		ld_date_actual
...
this.dw_anexopesaje=create dw_anexopesaje
...
this.Control[iCurrent+12]=this.dw_pdf
this.Control[iCurrent+13]=this.dw_docto
this.Control[iCurrent+14]=this.dw_desverd
this.Control[iCurrent+15]=this.dw_anexopesaje
this.Control[iCurrent+16]=this.ole_puerta
this.Control[iCurrent+17]=this.tab_1
end on

on w_maed_movtofrutagranel_recepcion.destroy
call super::destroy
...
If dw_4.RowCount() > 0 Then il_numeroenva = dw_4.Object.meen_numero[1]
...
//		END IF
		...
		ll_fila_env	=	dw_4.Retrieve(Long(istr_mant.argumento[1]),Long(istr_mant.argumento[2]),&
...
For ll_fila = 1 TO dw_desverd.RowCount()
	If ib_Destare Then dw_desverd.Object.lode_estado[ll_fila]	=	1
Next
...
fila = vinf.dw_1.Retrieve(Long(istr_mant.Argumento[1]), Long(istr_mant.Argumento[2]), 		&
								  Long(istr_mant.Argumento[3]),Integer(istr_mant.argumento[10]), ld_FechaRecepcion, ld_FechaRecepcion)
If fila = -1 Then
	MessageBox( "Error en Base de Datos", "Se ha producido un error en Base " + &
					"de datos : ~n" + sqlca.SQLErrText, StopSign!, Ok!)
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_movtofrutagranel_recepcion
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_movtofrutagranel_recepcion
integer x = 5
integer y = 24
integer width = 3259
integer height = 824
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_movtofrutagranel_recepcion
integer x = 4279
integer y = 276
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_movtofrutagranel_recepcion
integer x = 4274
integer y = 452
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_movtofrutagranel_recepcion
integer x = 4279
integer y = 636
boolean enabled = true
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_movtofrutagranel_recepcion
integer x = 4279
integer y = 816
end type
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_movtofrutagranel_recepcion
integer x = 4279
integer y = 996
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_movtofrutagranel_recepcion
integer x = 4288
integer y = 1468
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_movtofrutagranel_recepcion
integer x = 4283
integer y = 1640
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_movtofrutagranel_recepcion
integer x = 4279
integer y = 92
end type
...
FOR ll_Fila = 1 TO UpperBound(wstr_Prod_Enva.Productor)
	...
	ll_Fila_Busca	=	dw_4.Find("clie_codigo = "+istr_Mant.Argumento[10]+" and "+&
							 ...
							 "tpmv_codigo = 41 and prod_codigo = "+String(ll_Productor),1,dw_4.RowCount())
...
string binarykey = "w_maed_movtofrutagranel_recepcion.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
CHOOSE CASE key
	CASE KeyEnter!
		w_maed_movtofrutagranel_recepcion.PostEvent("ue_modifica_detalle")
...
0Aw_maed_movtofrutagranel_recepcion.bin 
...
1Aw_maed_movtofrutagranel_recepcion.bin 
