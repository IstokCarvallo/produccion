$PBExportHeader$w_mant_deta_movtodespacho_comercial.srw
$PBExportComments$Mantención Detalle de Ordenes de Proceso
forward
global type w_mant_deta_movtodespacho_comercial from w_mant_detalle_csd
end type
type dw_2 from uo_dw within w_mant_deta_movtodespacho_comercial
end type
type pb_ins_det from picturebutton within w_mant_deta_movtodespacho_comercial
end type
type pb_eli_det from picturebutton within w_mant_deta_movtodespacho_comercial
end type
type st_1 from statictext within w_mant_deta_movtodespacho_comercial
end type
type em_total from editmask within w_mant_deta_movtodespacho_comercial
end type
type dw_3 from uo_dw within w_mant_deta_movtodespacho_comercial
end type
type st_3 from statictext within w_mant_deta_movtodespacho_comercial
end type
type cb_aplicar from commandbutton within w_mant_deta_movtodespacho_comercial
end type
type cb_aplicatodo from commandbutton within w_mant_deta_movtodespacho_comercial
end type
type st_4 from statictext within w_mant_deta_movtodespacho_comercial
end type
type cb_desaplica from commandbutton within w_mant_deta_movtodespacho_comercial
end type
type cb_desaplicatodo from commandbutton within w_mant_deta_movtodespacho_comercial
end type
type st_5 from statictext within w_mant_deta_movtodespacho_comercial
end type
end forward
...
global w_mant_deta_movtodespacho_comercial w_mant_deta_movtodespacho_comercial
...
on w_mant_deta_movtodespacho_comercial.create
int iCurrent
call super::create
...
on w_mant_deta_movtodespacho_comercial.destroy
call super::destroy
destroy(this.dw_2)
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_movtodespacho_comercial
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_movtodespacho_comercial
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_movtodespacho_comercial
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_movtodespacho_comercial
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_movtodespacho_comercial
integer x = 3159
integer y = 284
integer taborder = 50
...
type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_movtodespacho_comercial
integer x = 3159
integer y = 108
integer taborder = 40
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_movtodespacho_comercial
integer x = 3159
integer y = 456
integer taborder = 60
end type
...
type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_movtodespacho_comercial
boolean visible = false
integer x = 69
integer y = 1316
integer width = 2971
...
DO WHILE ll_fila2 > 0
	ll_fila1	=	dw_2.InsertRow(0) //RowCount() + 1

	iuo_lote.Existe(dw_3.Object.plde_codigo[ll_fila2], dw_3.Object.lote_espcod[ll_fila2], dw_3.Object.lote_codigo[ll_fila2], false, sqlca)
	iuo_calidad.Existe(dw_3.Object.enva_tipoen[ll_fila2], dw_3.Object.enva_codigo[ll_fila2], '1' , false, sqlca)

	dw_2.Object.lfcd_nturno[ll_fila1]		=	1
	dw_2.Object.lofc_pltcod[ll_fila1]		=	dw_3.Object.plde_codigo[ll_fila2]
	dw_2.Object.lofc_espcod[ll_fila1]		=	dw_3.Object.lote_espcod[ll_fila2]
	dw_2.Object.lofc_lotefc[ll_fila1]		=	dw_3.Object.lote_codigo[ll_fila2]
	...
	dw_2.Object.cale_calida[ll_fila1]		=	'1'
	dw_2.Object.cale_nombre[ll_fila1]		=	iuo_calidad.Nombre
	dw_2.Object.cate_codigo[ll_fila1]		=	120
	dw_2.Object.lfcd_bultos[ll_fila1]		=	dw_3.Object.caex_canbul[ll_fila2]
	dw_2.Object.lfcd_kilbru[ll_fila1]		=	iuo_lote.TotalNeto + ( iuo_calidad.Peso * dw_3.Object.caex_canbul[ll_fila2] )
	dw_2.Object.lfcd_kilnet[ll_fila1]		=	iuo_lote.TotalNeto
