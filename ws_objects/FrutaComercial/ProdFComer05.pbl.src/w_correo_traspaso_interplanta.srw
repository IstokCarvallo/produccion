...
type gb_2 from groupbox within w_correo_traspaso_interplanta
end type
type pb_correo from picturebutton within w_correo_traspaso_interplanta
end type
type gb_1 from groupbox within w_correo_traspaso_interplanta
end type
type st_3 from statictext within w_correo_traspaso_interplanta
end type
end forward
