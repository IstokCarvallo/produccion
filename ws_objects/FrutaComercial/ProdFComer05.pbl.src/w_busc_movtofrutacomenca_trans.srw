$PBExportHeader$w_busc_movtofrutacomenca_trans.srw
$PBExportComments$Ventana de Busqueda  de Movimientos de Fruta Comercial.
forward
global type w_busc_movtofrutacomenca_trans from w_busqueda
end type
...
global w_busc_movtofrutacomenca_trans w_busc_movtofrutacomenca_trans
...
on w_busc_movtofrutacomenca_trans.create
int iCurrent
call super::create
end on

on w_busc_movtofrutacomenca_trans.destroy
call super::destroy
end on
...
IF istr_Busq.Argum[2] <> "" THEN
	...
	IF istr_Busq.Argum[2] = '25' or istr_Busq.Argum[2] = '32' or istr_Busq.Argum[2] = '35' THEN
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_movtofrutacomenca_trans
...
type dw_1 from w_busqueda`dw_1 within w_busc_movtofrutacomenca_trans
integer x = 101
integer y = 656
integer width = 2770
integer height = 948
integer taborder = 60
string dataobject = "dw_mues_movtofrutacomenca_trans"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_movtofrutacomenca_trans
integer x = 2871
integer y = 1268
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_movtofrutacomenca_trans
integer x = 101
integer y = 80
integer width = 2459
integer height = 544
...
IF dw_1.Retrieve(ii_planta, &
					  ii_tipomov, &
					  ii_estado, ld_FechaMovto) > 0 THEN
	dw_1.SetFocus()
