$PBExportHeader$w_mant_deta_movtofrutacomdeta_multiconex.srw
$PBExportComments$Mantención Detalle de Movimiento de Fruta Comercial.
forward
global type w_mant_deta_movtofrutacomdeta_multiconex from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_movtofrutacomdeta_multiconex w_mant_deta_movtofrutacomdeta_multiconex
...
ELSE
	...
	IF sqlca.SQLCode = -1 THEN
		MessageBox("Atención", "No hay Existe Calidad.~r~r" + "Ingrese o seleccione otros antecedentes.")
			lb_Retorno	=	False
	Else
...
on w_mant_deta_movtofrutacomdeta_multiconex.create
call super::create
end on

on w_mant_deta_movtofrutacomdeta_multiconex.destroy
call super::destroy
end on
...
IF istr_mant.Argumento[2]='25' THEN
   dw_1.Object.lofc_espcod[il_Fila]	=	integer(istr_mant.Argumento[5])
	...
	dw_1.Object.lofc_espcod.Protect = 1
	dw_1.Object.lofc_espcod.BackGround.Color = RGB(192,192,192)
ELSE
   dw_1.Object.lofc_espcod[il_Fila]	=	gstr_ParamPlanta.CodigoEspecie
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_movtofrutacomdeta_multiconex
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_movtofrutacomdeta_multiconex
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_movtofrutacomdeta_multiconex
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_movtofrutacomdeta_multiconex
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_movtofrutacomdeta_multiconex
integer x = 2391
integer y = 308
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_movtofrutacomdeta_multiconex
integer x = 2391
integer y = 132
end type

type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_movtofrutacomdeta_multiconex
integer x = 2391
integer y = 480
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_movtofrutacomdeta_multiconex
integer width = 2071
integer height = 1488
string title = "dw_mant_movtofrutacomdeta_interplt"
string dataobject = "dw_mant_movtofrutacomdeta_interplt"
end type
...
CHOOSE CASE ls_Columna
	...
	CASE "lfcd_secuen"
		...
		ELSE
			...
			This.SetItem(il_Fila, "vari_codigo", istr_Variedad.Codigo)
			This.SetItem(il_Fila, "vari_nombre", istr_Variedad.Nombre)
			This.SetItem(il_Fila, "prod_codigo", iuo_Productor.Codigo)
			...
			IF iuo_TipoMovto.Sentido = 2 THEN
				...
				ELSE
					IF Not isnull(this.Object.lofc_lotefc[il_fila]) THEN
						IF iuo_LoteFC.Existe(This.Object.lofc_pltcod[il_fila], This.Object.lofc_espcod[il_fila], This.Object.lofc_lotefc[il_fila], Integer(data), True, SqlCa) THEN
							This.Object.mfcd_kgnent[il_Fila]	=	iuo_LoteFC.TotalBulto * iuo_LoteFC.KilosPromed
							This.Object.enva_tipoen[il_Fila]	=	iuo_LoteFC.Tipoenvase
							This.Object.enva_codigo[il_Fila]	=	iuo_LoteFC.Envase
						END IF	
