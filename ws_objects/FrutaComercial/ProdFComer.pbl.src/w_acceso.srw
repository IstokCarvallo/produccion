...
event ue_datosempresa;call super::ue_datosempresa;String	empr_razsoc, empr_nombre, empr_rutemp, empr_direcc, empr_comuna, &
			...
			empr_rutrle, empr_oficin, empr_dirres,	empr_admenv
...
SELECT	empr_razsoc, empr_nombre, empr_rutemp, empr_direcc, empr_comuna,
	...
	INTO	:empr_razsoc, :empr_nombre, :empr_rutemp, :empr_direcc, :empr_comuna,
			...
			:gi_admenvase, :gs_Password
	FROM	dbo.parempresa using sqlca;

IF sqlca.SQLCode = -1 THEN
	F_ErrorBaseDatos(sqlca, "Lectura de Tabla parempresa")
	Halt
ELSEIF sqlca.SQLCode = 100 THEN
	MessageBox("Error", "Atención, no se ha cargado la tabla de parametros de empresa", StopSign!)
	Halt
END IF
...
string picturename = "\Desarrollo 12\Imagenes\Sistemas\fruta_comercial.jpg"
end type
