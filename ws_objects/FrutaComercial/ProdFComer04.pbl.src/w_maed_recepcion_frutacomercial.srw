$PBExportHeader$w_maed_recepcion_frutacomercial.srw
forward
global type w_maed_recepcion_frutacomercial from w_mant_encab_deta_csd
end type
type tab_1 from tab within w_maed_recepcion_frutacomercial
end type
...
type em_kilos from editmask within w_maed_recepcion_frutacomercial
end type
type dw_3 from uo_dw within w_maed_recepcion_frutacomercial
end type
type ole_puerta from olecustomcontrol within w_maed_recepcion_frutacomercial
end type
type str_pesaje from structure within w_maed_recepcion_frutacomercial
end type
end forward
...
integer width = 4891
integer height = 2052
string title = "RECEPCION FRUTA COMERCIAL"
string menuname = ""
...
global w_maed_recepcion_frutacomercial w_maed_recepcion_frutacomercial
...
DataStore				dw_6, dw_7,ids_calidad
...
IF lstr_Busq.Argum[1] <> "" THEN
	...
	IF iuo_productores.Existe(Long(lstr_Busq.Argum[1]),False,SqlCa) THEN
...
//lstr_Busq.Argum[16]	=	string(iuo_cliente.clie_codigo)
//
...
//											  Long(lstr_Busq.Argum[6]), True, SqlCa, iuo_cliente.clie_codigo) THEN
//						  
...
//				 							  Long(istr_Mant.Argumento[3]),1, iuo_cliente.clie_codigo)
//				 
//		END IF
//		
//		
...
ids_calidad = Create DataStore
ids_calidad.DataObject = 'dw_mues_spro_calicosechero'
ids_calidad.SetTransObject(SqlCa)

ids_calidad.Retrieve(dw_4.Object.enva_tipoen[il_Fila],dw_4.Object.enva_codigo[il_Fila],&
                     dw_4.Object.cale_calida[il_Fila] )

ls_calidad = dw_4.Object.cale_calida[al_fila]

IF IsNull(ls_calidad) or ls_calidad = "" THEN RETURN False

li_encuentra = ids_calidad.Find("Cale_calida = '" + ls_calidad + "'", 1, ids_calidad.RowCount())

IF li_encuentra * dw_4.Object.lfcd_bultos[al_fila] < 1 THEN RETURN False

ld_TaraEnvase	=	( ids_calidad.GetItemDecimal(li_encuentra, "cale_pesoen") * dw_4.Object.lfcd_bultos[al_fila] ) + dw_4.Object.lfcd_kilobp[al_fila]
...
public subroutine buscacalidad ();str_busqueda	lstr_busq
String			ls_Nula

SetNull(ls_Nula)

lstr_busq.argum[1]	=	String(dw_4.Object.enva_tipoen[il_Fila])
lstr_busq.argum[2]   =  String(dw_4.Object.enva_codigo[il_fila])
lstr_busq.argum[3]   =  dw_4.Object.cale_calida[il_fila]
IF IsNull(lstr_busq.argum[1]) OR lstr_busq.argum[1] = "" THEN lstr_busq.argum[1] = '0' 
IF IsNull(lstr_busq.argum[2]) OR lstr_busq.argum[2] = "" THEN lstr_busq.argum[2] = '0'
IF IsNull(lstr_busq.argum[3]) OR lstr_busq.argum[3] = "" THEN lstr_busq.argum[3] = '*' 

OpenWithParm(w_busc_calicosechero, lstr_busq)

lstr_busq	= Message.PowerObjectParm

IF lstr_busq.argum[3] = "" THEN
	dw_4.SetColumn("cale_calida")
	dw_4.SetFocus()
ELSE
	dw_4.Object.enva_tipoen[il_Fila] =  Integer(lstr_busq.argum[1])
	dw_4.Object.enva_codigo[il_Fila] =  Integer(lstr_busq.argum[2])
	dw_4.Object.cale_calida[il_Fila] =  lstr_busq.argum[3]
	dw_4.Object.cale_nombre[il_Fila]	=	lstr_busq.argum[4]
	dw_4.Object.enva_nombre[il_Fila]	=	lstr_busq.argum[5]
...
on w_maed_recepcion_frutacomercial.create
int iCurrent
call super::create
...
this.Control[iCurrent+2]=this.em_kilos
this.Control[iCurrent+3]=this.dw_3
this.Control[iCurrent+4]=this.ole_puerta
end on

on w_maed_recepcion_frutacomercial.destroy
call super::destroy
destroy(this.tab_1)
...
x	= 0
y	= 0
/*controla posiciones de campo variedad y periodo 
mientras no se ocupa el tipo docto*/
dw_2.Object.t_3.y         = 148
dw_2.Object.t_6.y         = 232
dw_2.Object.vari_codigo.y = 144
dw_2.Object.pefr_codigo.y = 232
...
IF idwc_variedad.Retrieve(0) = 0 THEN
	MessageBox("Atención", "Falta Registrar Variedad")
...
istr_Mant.Argumento[2]	=	"1"												// Tipo Movto. (Recep. de Proceso)
...
iuo_prodempresa.Existe(gstr_paramplanta.productorempresa,True,SqlCa)
dw_2.SetItem(1, "prod_codigo", gstr_paramplanta.productorempresa)
dw_2.SetItem(1, "prod_nombre", iuo_prodempresa.nombre )
...
event ue_antesguardar;call super::ue_antesguardar;Integer li_planta, li_especie, li_cliente,li_tipomv, li_secuencia
Long ll_lote, ll_numero

This.TriggerEvent("ue_validaregistro")

li_planta  = dw_2.Object.plde_codigo[1]
li_especie = dw_2.Object.espe_codigo[1]
li_tipomv  = Integer(istr_mant.argumento[2])
li_cliente = dw_2.Object.clie_codigo[1]

IF dw_2.GetItemStatus(1,0,Primary!) = New! OR &
	dw_2.GetItemStatus(1,0,Primary!) = NewModified! THEN
	
	SELECT Max(mfco_numero)
	INTO  :ll_numero
	FROM  dba.Spro_movtofrutacomenca
	WHERE clie_codigo = :li_cliente
	AND   plde_codigo = :li_planta
	AND   tpmv_codigo = :li_tipomv;
	
	IF IsNull(ll_numero) THEN ll_numero = 0
	ll_numero ++ 
	dw_2.SetItem(1,"mfco_numero",ll_numero)
	
END IF	

IF dw_3.GetItemStatus(1,0,Primary!) = New! OR &
	dw_3.GetItemStatus(1,0,Primary!) = NewModified! THEN
	...
	IF IsNull(ll_lote) THEN ll_lote = 0
	 ...
	 dw_3.Object.lofc_totkil[1] = dw_4.Object.lfcd_kilnet[il_Fila]
	 dw_3.Object.lofc_totbul[1] = dw_4.Object.lfcd_bultos[il_Fila]
	 dw_3.SetItem(1,"lofc_lotefc",ll_lote)
 
END IF

//IF dw_4.GetItemStatus(1,0,Primary!) = New! OR &
	//dw_4.GetItemStatus(1,0,Primary!) = NewModified! THEN
	...
	IF IsNull(li_secuencia) THEN li_secuencia = 0
		...
		dw_4.Object.lofc_pltcod[il_Fila] = dw_3.Object.lofc_pltcod[1]
		dw_4.Object.lofc_espcod[il_Fila] = dw_3.Object.lofc_espcod[1]
		dw_4.Object.lofc_lotefc[il_Fila] = dw_3.Object.lofc_lotefc[1]
		dw_4.Object.vari_codigo[il_Fila] = dw_2.Object.vari_codigo[1]
		dw_4.Object.pefr_codigo[il_Fila] = dw_2.Object.pefr_codigo[1]
		dw_4.Object.frio_tipofr[il_Fila] = dw_2.Object.frio_tipofr[1]
		dw_4.Object.lfcd_secuen[il_Fila] = li_secuencia
 
 

end event

type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_recepcion_frutacomercial
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_recepcion_frutacomercial
integer x = 649
integer y = 32
integer width = 2862
integer height = 436
integer taborder = 10
string dataobject = "dw_mant_frutacomenca_recepcion"
end type
...
CHOOSE CASE ls_Columna
	...
	CASE "espe_codigo"
		...
		ELSE
			...
			dw_3.SetItem(1,"lofc_espcod",Integer(istr_mant.argumento[7]))
		END IF	
		
	CASE "vari_codigo"
		IF Not iuo_variedades.Existe(Integer(istr_mant.argumento[7]),Integer(Data),True,SqlCa) THEN
			This.SetItem(1,ls_columna,Integer(ls_Null))
		END IF	
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 268
integer taborder = 50
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_recepcion_frutacomercial
integer x = 4521
integer taborder = 60
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 632
integer taborder = 70
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 808
integer taborder = 80
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 988
integer taborder = 90
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 1440
integer taborder = 100
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_recepcion_frutacomercial
integer x = 4521
integer y = 1612
integer taborder = 110
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_recepcion_frutacomercial
integer x = 4521
integer taborder = 40
end type
...
integer height = 796
integer taborder = 21
string dataobject = "dw_mues_receplotesfrutacomdeta"
boolean hscrollbar = true
...
CHOOSE CASE ls_Columna
	...
	CASE "cale_calida"
		IF Not iuo_calicosechero.Existe(Integer(istr_Mant.Argumento[8]),Integer(istr_Mant.Argumento[9]),&
		                                Data,True,SqlCa) THEN
			This.SetItem(il_Fila,ls_columna,ls_Null)
			RETURN 1
		ELSE
			This.Object.cale_nombre[il_Fila] = iuo_calicosechero.nombre
		END IF
...
integer taborder = 20
boolean enabled = false
string dataobject = "dw_mant_receplotesfrutacomenc"
...
string binarykey = "w_maed_recepcion_frutacomercial.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
0Bw_maed_recepcion_frutacomercial.bin 
...
1Bw_maed_recepcion_frutacomercial.bin 
