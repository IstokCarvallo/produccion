$PBExportHeader$w_busc_lotesfrutacomdeta_venta.srw
$PBExportComments$Ventana de Busqueda de Lotes Fruta Comercial.
forward
global type w_busc_lotesfrutacomdeta_venta from w_busqueda
end type
...
global w_busc_lotesfrutacomdeta_venta w_busc_lotesfrutacomdeta_venta
...
on w_busc_lotesfrutacomdeta_venta.create
int iCurrent
call super::create
end on

on w_busc_lotesfrutacomdeta_venta.destroy
call super::destroy
end on
...
is_ordena = 'Número Tarja:fgmb_nrotar,Número Lote:lofc_lotefc,Variedad:vari_nombre:Productor:prod_nombre,' + &
...
IF istr_busq.Argum[1] <> "" THEN
	...
	tab_1.tabpage_1.dw_planta.Object.plde_codigo.BackGround.Color	=	rgb(166,180,210)
...
IF istr_busq.Argum[2] <> "" THEN
	...
	tab_1.tabpage_1.dw_camara.Object.cama_codigo.BackGround.Color	=	rgb(166,180,210)
...
IF istr_busq.Argum[3] <> "" THEN
	...
	tab_1.tabpage_1.dw_especie.Object.espe_codigo.BackGround.Color	=	rgb(166,180,210)
...
istr_Busq.Argum[18]  = dw_1.Object.refe_gcalib[dw_1.GetRow()]
istr_Busq.Argum[19]  = String(dw_1.Object.fgmb_nrotar[dw_1.GetRow()])
istr_Busq.Argum[20]  = String(dw_1.Object.lfcd_kilbru[dw_1.GetRow()])
istr_Busq.Argum[21]  = String(dw_1.Object.lfcd_bultos[dw_1.GetRow()])
istr_Busq.Argum[22]  = dw_1.Object.cale_calida[dw_1.GetRow()]
istr_Busq.Argum[23]  = String(dw_1.Object.lfcd_kilobp[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_lotesfrutacomdeta_venta
...
type dw_1 from w_busqueda`dw_1 within w_busc_lotesfrutacomdeta_venta
integer x = 87
integer width = 2606
integer height = 892
integer taborder = 60
string dataobject = "dw_mues_lotesfrutacomdeta_venta_ex"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_lotesfrutacomdeta_venta
integer x = 2949
integer y = 1344
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_lotesfrutacomdeta_venta
integer x = 105
integer y = 80
integer width = 2171
end type
...
IF (istr_busq.argum[1] <> "") and (istr_busq.argum[2]<>"") and (istr_busq.argum[3]<>"") THEN
	...
	IF dw_1.Retrieve(Integer(istr_busq.argum[1]), Integer(istr_busq.argum[2]), &
      ...
      IF istr_busq.argum[4]<>"" THEN
			dw_1.SetFilter("prod_codigo =" + istr_busq.argum[4] + " And expo_codigo="+String(gi_codexport))
			dw_1.Filter()
		ELSE
			dw_1.SetFilter("expo_codigo = " + string(gi_codexport))
			dw_1.Filter()
		END IF
