$PBExportHeader$w_maed_movtofrutacomer_ctrlcal.srw
$PBExportComments$Ventana de Recepción Fruta Embalada de Proceso
forward
global type w_maed_movtofrutacomer_ctrlcal from w_mant_encab_deta_csd
end type
type dw_3 from uo_dw within w_maed_movtofrutacomer_ctrlcal
end type
type tab_1 from tab within w_maed_movtofrutacomer_ctrlcal
end type
...
type em_kilos from editmask within w_maed_movtofrutacomer_ctrlcal
end type
type ole_puerta from olecustomcontrol within w_maed_movtofrutacomer_ctrlcal
end type
type dw_exideta from datawindow within w_maed_movtofrutacomer_ctrlcal
end type
type dw_exiencab from datawindow within w_maed_movtofrutacomer_ctrlcal
end type
type dw_exidetaborra from datawindow within w_maed_movtofrutacomer_ctrlcal
end type
type dw_exismovtodetanulos from datawindow within w_maed_movtofrutacomer_ctrlcal
end type
type str_pesaje from structure within w_maed_movtofrutacomer_ctrlcal
end type
end forward
...
integer width = 5056
integer height = 2060
string title = "INGRESO COMERCIAL CONTROL DE CALIDAD"
string menuname = ""
...
global w_maed_movtofrutacomer_ctrlcal w_maed_movtofrutacomer_ctrlcal
...
Integer             		 				ii_tipool=0, il_coneccion, il_conexiste, il_numeroenva
String										is_ultimacol
...
IF ib_Conectadoexistencia THEN
	...
	dw_exiencab.Object.mden_bodest[ll_fila_nueva] 	= 	li_bodzonal
	...
	dw_exiencab.Object.mden_observ[ll_fila_nueva] 	= 	'Recepción Control de Calidad'
	dw_exiencab.Object.mden_estado[ll_fila_nueva] 	= 	1
	dw_exiencab.Object.mden_pcopda[ll_fila_nueva] 	= 	1
	
	FOR li_filarecep = 1 TO dw_5.RowCount()
		ll_filarecep		=	dw_exideta.InsertRow(0)
		
		li_enva_codigo	=	dw_5.Object.enva_codigo[li_filarecep]
		li_enva_tipoen =	dw_5.Object.enva_tipoen[li_filarecep]
		ls_calidad		=  dw_5.Object.cale_calida[li_filarecep]
		...
		dw_exideta.Object.mdde_cantid[ll_filarecep] 	= 	dw_5.Object.fgme_cantid[li_filarecep]
...
//		ls_texto	 = "No es posible actualizar movto. Recepción Control de Calidad, por modificación anterior al mes de proceso"
//		ls_asunto = "Modifica Fruta Comercial Recepción Control de Calidad Movto. Nº "+String(ll_numero)
//		li_devcorreo =  Send_mail("smtp.rioblanco.cl","<frutaComercial@rioblanco.cl>","<"+ls_correo+">","","",ls_asunto,ls_texto,"",ls_error)
//	
...
event ue_despuesborrar();Long 		ll_numero, respuesta, ll_nueva, ll_fila, li_devcorreo, li_tipdoc
Boolean lb_AutoCommit
Integer	li_bodecomercial, li_bodzonal
...
IF as_Columna <> "frio_tipofr" AND &
	(dw_2.Object.frio_tipofr[1] = "" OR IsNull(dw_2.Object.frio_tipofr[1])) THEN
	lb_Estado = False
END IF

IF as_Columna <> "pefr_codigo" AND &
	(dw_2.Object.pefr_codigo[1] = 0 OR IsNull(dw_2.Object.pefr_codigo[1])) THEN
	lb_Estado = False
END IF
...
ELSE
	IF istr_mant.Argumento[11] = "1" THEN
		IF gstr_paramplanta.PoolVenta = 5 OR gstr_paramplanta.PoolVenta = 1 THEN
			SELECT loco_ultcom  into :ll_lote
			  FROM dba.spro_lotescorrelequipo
			 WHERE espe_codigo = :li_especie
			 	AND equi_nombre =:gstr_us.computador
	...
	ELSE
		IF gstr_paramplanta.PoolRetiro = 4 OR gstr_paramplanta.PoolRetiro = 1 THEN
			...
			UPDATE dba.spro_lotescorrelequipo
			   SET loco_ulcore = :ll_lote
			 WHERE espe_codigo = :li_especie
			 	AND equi_nombre = :gstr_us.computador
				AND plde_codigo = :li_planta;
			ll_lote = ll_lote - 1
...
ELSE
	...
	dw_2.Object.pefr_codigo.BackGround.Color 	= 	rgb(166,180,210)
	dw_2.Object.frio_tipofr.Protect					=	1 
	dw_2.Object.frio_tipofr.BackGround.Color 		= 	rgb(166,180,210)
	//////////////////////////////////////////////////////////////////////////////
END IF
end subroutine
...
Integer	li_encuentra, li_CodiEnvase, li_TipoEnvase
String		ls_calidad

li_TipoEnvase 	= 	dw_4.object.enva_tipoen[al_fila]
li_CodiEnvase 	= 	dw_4.object.enva_codigo[al_fila]
ls_calidad 		= 	dw_4.Object.cale_calida[al_fila]

IF NOT iuo_calidad.Existe(li_TipoEnvase, li_CodiEnvase, ls_calidad, True, sqlca) THEN Return False
...
on w_maed_movtofrutacomer_ctrlcal.create
int iCurrent
call super::create
...
on w_maed_movtofrutacomer_ctrlcal.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.tab_1)
...
istr_Mant.Argumento[2]	=	"12"												// Tipo Movto. (Recep. de Ctrl de Cal)
...
DO
	...
	ELSE
		IF dw_3.RowCount() < 1 THEN 
			Return
		END IF
		dw_2.Object.espe_codigo[1]	=	dw_3.Object.lofc_espcod[1]
	 	...
	 	DO
			...
			ELSE
				...
				IF dw_1.RowCount() < 1 THEN 
					MEssageBox("Error", 'dw_1.RowCount: ' + String(dw_1.RowCount()))
					Return
				END IF
				
				istr_Mant.Argumento[1] 	= 	String(dw_1.Object.lofc_pltcod[1])
				istr_Mant.Argumento[7] 	= 	String(dw_1.Object.lofc_espcod[1])
				istr_Mant.Argumento[6]	=	String(dw_1.Object.lofc_lotefc[1])
				ll_Fila_d = dw_4.Retrieve(Integer(istr_Mant.Argumento[1]), &
								  Integer(istr_Mant.Argumento[7]), &
								  Long(istr_Mant.Argumento[6])) 
								  
			  	dw_2.Object.vari_codigo[1] 	= 	dw_4.Object.vari_codigo[1]
				dw_2.Object.pefr_codigo[1] 	= 	dw_4.Object.pefr_codigo[1]
				dw_2.Object.frio_tipofr[1] 		= 	dw_4.Object.frio_tipofr[1]
...
//									  	  Long(istr_Mant.Argumento[5]), True, SqlCa, iuo_cliente.clie_codigo) THEN
//
//		istr_Mant.Argumento[7]	= String(iuo_spro_ordenproceso.Especie)
//		iuo_spro_ordenproceso.CapturaReferencias(1,0,1,0,0,False,Sqlca)
//		
...
vinf.dw_1.DataObject = "dw_info_identificacion_fruta_comercial_ctrlcal"
...
event ue_borrar;Long		ll_Fila, ll_NrLote, ll_Secuen, ll_Envases
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_movtofrutacomer_ctrlcal
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_movtofrutacomer_ctrlcal
integer x = 32
integer y = 32
integer width = 2853
integer height = 400
integer taborder = 10
string dataobject = "dw_mant_movtofrutacomenca_ctrlcal"
end type
...
//
	...
	CASE "espe_codigo"
		IF iuo_especies.Existe(Integer(data), true, sqlca) THEN
			...
			IF idwc_variedad.Retrieve( Integer(data) ) < 1 THEN
				MessageBox("Error", "No existen variedades para la especie seleccionada")
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 312
integer taborder = 50
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 492
integer taborder = 60
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 676
integer taborder = 70
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 852
integer taborder = 80
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 1032
integer taborder = 90
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 1484
integer taborder = 100
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 1656
integer taborder = 110
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_movtofrutacomer_ctrlcal
integer x = 4690
integer y = 132
integer taborder = 40
end type
...
string dataobject = "dw_mant_lotesfrutacomenc_ctrlcal"
boolean vscrollbar = false
...
event doubleclicked;//w_maed_movtofrutacomer_ctrlcal.TriggerEvent("ue_modifica_detalle")
...
event doubleclicked;call super::doubleclicked;w_maed_movtofrutacomer_ctrlcal.TriggerEvent("ue_modifica_detalle")
...
string binarykey = "w_maed_movtofrutacomer_ctrlcal.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
04w_maed_movtofrutacomer_ctrlcal.bin 
...
14w_maed_movtofrutacomer_ctrlcal.bin 
