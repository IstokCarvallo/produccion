$PBExportHeader$w_mant_deta_movtotraspaso.srw
$PBExportComments$Mantención Detalle de Movimiento de Fruta Comercial.
forward
global type w_mant_deta_movtotraspaso from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_movtotraspaso w_mant_deta_movtotraspaso
...
on w_mant_deta_movtotraspaso.create
call super::create
end on

on w_mant_deta_movtotraspaso.destroy
call super::destroy
end on
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_movtotraspaso
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_movtotraspaso
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_movtotraspaso
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_movtotraspaso
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_movtotraspaso
integer x = 2354
integer y = 308
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_movtotraspaso
integer x = 2354
integer y = 132
end type

type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_movtotraspaso
integer x = 2354
integer y = 480
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_movtotraspaso
integer width = 2153
integer height = 1572
