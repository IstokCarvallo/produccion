$PBExportHeader$w_busc_lotesfrutacomenc.srw
$PBExportComments$Ventana de Busqueda de Lotes Fruta Comercial.
forward
global type w_busc_lotesfrutacomenc from w_busqueda
end type
...
integer y = 304
integer width = 3296
string title = "BUsqueda de Lotes"
boolean resizable = false
end type
global w_busc_lotesfrutacomenc w_busc_lotesfrutacomenc
...
on w_busc_lotesfrutacomenc.create
int iCurrent
call super::create
end on

on w_busc_lotesfrutacomenc.destroy
call super::destroy
end on
...
istr_busq.argum[5]	= dw_1.Object.prod_nombre[dw_1.GetRow()]
istr_busq.argum[6]	= "" //categoria
istr_busq.argum[7]	= String(dw_1.Object.sepl_codigo[dw_1.GetRow()])
istr_busq.argum[8]	= String(dw_1.Object.lofc_diagra[dw_1.GetRow()])
istr_busq.argum[9]	= "" // Grupo Calibre 

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_lotesfrutacomenc
...
type dw_1 from w_busqueda`dw_1 within w_busc_lotesfrutacomenc
integer x = 82
integer y = 740
integer width = 2633
integer height = 868
integer taborder = 60
string dataobject = "dw_mues_lotesfrutacomenc"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_lotesfrutacomenc
integer x = 2903
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_lotesfrutacomenc
integer x = 101
integer y = 80
integer width = 2071
end type
