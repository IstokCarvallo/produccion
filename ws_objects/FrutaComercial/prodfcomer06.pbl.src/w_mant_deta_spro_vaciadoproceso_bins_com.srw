...
ELSE
	SELECT	enva_tipoen, enva_codigo
		...
		IF sqlca.SQLCode = -1 THEN
			F_ErrorBaseDatos(sqlca,"Lectura de la Tabla spro_bins" )
			Return True			
		ELSEIF sqlca.SQLCode = 100 THEN
			messagebox("Atención","No Existe la Tarja " + String(al_nrotarja, '00000000') + " " + &
		...
		ELSE
			...
			IF ( (dw_1.Object.enva_tipoen[il_Fila] <> li_TipoEnva) OR &
				  ...
				  (dw_1.Object.lofc_lotefc[il_fila] <> li_Lote ) ) AND &
				( dw_1.Object.opvd_canbul[il_fila] >= 1 ) THEN
				MessageBox("Error", "Tarja Ingresada no cumple con la caracteristica de las otras")
				Return True
			END IF
...
//IF gstr_paramplanta.palletdebins AND dw_1.Object.lofc_espcod[il_Fila] <> 82 THEN
//	SE ELIMINA CONTROL ESPECIFICO PARA PALLET DE BINS, PERMITIENDO SUMAR EL TOTAL DE BULTOS DE UNA TARJA
//	DIRECTAMENTE DESDE MOVTOGRANPESA, PARA EVITAR PROBLEMAS DE CARGA DE DATOS
//	07-042-011
	...
	ELSEIF sqlca.SQLCode = 100 THEN
		...
		li_Bultos 	= 	0
	ELSE
		SELECT Sum(IsNull(fgmb_canbul, 1)) INTO :li_bultos
		FROM dbo.spro_movtobins
		WHERE clie_codigo		=	:li_cliente
			AND plde_codigo	=	:li_planta
			AND fgmb_nrotar	=	:ll_tarja;
		...
		IF sqlca.SQLCode = -1 THEN
			...
			li_Bultos 	= 	0
		ELSEIF sqlca.SQLCode = 100 THEN
			messagebox("Atención","No Se encuentran Bultos para esta especificacion, "+&
									 "~r Favor de dar aviso a Administrador de Sistemas")			
			li_Bultos 	= 	0
		END IF
	END IF
//ELSE
...
public subroutine pesooriginalbins ();Long 		ll_NroTar1, ll_NroTar2, ll_NroTar3, ll_lote
...
ll_NroTar1	=	dw_1.Object.opve_nrtar1[il_fila]
ll_NroTar2	=	dw_1.Object.opve_nrtar2[il_fila]
ll_NroTar3	=	dw_1.Object.opve_nrtar3[il_fila]
li_bultos	=	dw_1.Object.opvd_canbul[il_fila]
li_TipEn		=	dw_1.Object.enva_tipoen[il_fila]
li_CodEn		=	dw_1.Object.enva_codigo[il_fila]
ls_Calid		=	dw_1.Object.cale_calida[il_fila]
ll_lote		=	dw_1.Object.lofc_lotefc[il_fila]
...
IF sqlca.SQLCode <> 0 THEN
	...
	dw_1.object.opvd_kilori[il_fila]	=	0
ELSE
	dw_1.object.opvd_kilori[il_fila]	=	Round(ldec_KilOri, 2)
END IF	
...
If gstr_paramplanta.palletdebins Then
	...
	dw_1.Object.opve_nrtar2.Color					=	RGB(255,255,255)
	dw_1.Object.opve_nrtar3.Color					=	RGB(255,255,255)
...
event ue_recuperadatos;call super::ue_recuperadatos;IF istr_mant.agrega = False and istr_mant.borra = False THEN
	ias_campo[1]  = String(dw_1.Object.opve_nrtar1[il_fila])
	ias_campo[2]  = String(dw_1.Object.opve_nrtar2[il_fila])
	ias_campo[3]  = String(dw_1.Object.opve_nrtar3[il_fila])
	ias_campo[4]  = String(dw_1.Object.opvd_pesone[il_fila])
	ias_campo[5]  = String(dw_1.Object.opvd_pesobr[il_fila])
	ias_campo[6]  = String(dw_1.Object.opvd_kilpro[il_fila])
	ias_campo[7]  = String(dw_1.Object.enva_tipoen[il_fila])
	ias_campo[8]  = String(dw_1.Object.enva_codigo[il_fila])
	ias_campo[9]  = String(dw_1.Object.opvd_canbul[il_fila])
	ias_campo[10] = dw_1.Object.cale_calida[il_fila]
END IF
end event
...
dw_1.Object.clie_codigo[il_Fila]	=	Integer(istr_mant2.Argumento[1])
end event
			...
			IF Not IsNull(data) THEN
				...
				ELSE
					This.Object.Lote[row] = String(This.Object.plde_codigo[row], '0000') &
												 + String(This.Object.lofc_espcod[row], '00') &
												 + String(This.Object.lofc_lotefc[row], '0000000000')
					il_tarja	=	Long(Data)
				END IF	
			END IF
