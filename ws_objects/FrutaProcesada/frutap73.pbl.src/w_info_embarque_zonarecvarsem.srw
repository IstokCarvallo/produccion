$PBExportHeader$w_info_embarque_zonarecvarsem.srw
forward
global type w_info_embarque_zonarecvarsem from w_para_informes
end type
type st_4 from statictext within w_info_embarque_zonarecvarsem
end type
type dw_cliente from datawindow within w_info_embarque_zonarecvarsem
end type
type st_6 from statictext within w_info_embarque_zonarecvarsem
end type
type st_3 from statictext within w_info_embarque_zonarecvarsem
end type
type st_13 from statictext within w_info_embarque_zonarecvarsem
end type
type em_semana from editmask within w_info_embarque_zonarecvarsem
end type
type st_14 from statictext within w_info_embarque_zonarecvarsem
end type
type em_ano from editmask within w_info_embarque_zonarecvarsem
end type
type st_10 from statictext within w_info_embarque_zonarecvarsem
end type
type dw_recibidor from datawindow within w_info_embarque_zonarecvarsem
end type
type cbx_recibidor from checkbox within w_info_embarque_zonarecvarsem
end type
type cbx_recibidorcons from checkbox within w_info_embarque_zonarecvarsem
end type
type st_1 from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_planta from checkbox within w_info_embarque_zonarecvarsem
end type
type cbx_plantascons from checkbox within w_info_embarque_zonarecvarsem
end type
type dw_planta from datawindow within w_info_embarque_zonarecvarsem
end type
type st_8 from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_peso from checkbox within w_info_embarque_zonarecvarsem
end type
type tit_peso from statictext within w_info_embarque_zonarecvarsem
end type
type dw_pesoneto from datawindow within w_info_embarque_zonarecvarsem
end type
type gb_3 from groupbox within w_info_embarque_zonarecvarsem
end type
type st_5 from statictext within w_info_embarque_zonarecvarsem
end type
type st_7 from statictext within w_info_embarque_zonarecvarsem
end type
type st_11 from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_mercado from checkbox within w_info_embarque_zonarecvarsem
end type
type dw_mercado from datawindow within w_info_embarque_zonarecvarsem
end type
type st_12 from statictext within w_info_embarque_zonarecvarsem
end type
type dw_zonas from datawindow within w_info_embarque_zonarecvarsem
end type
type cbx_zonas from checkbox within w_info_embarque_zonarecvarsem
end type
type st_16 from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_zonascons from checkbox within w_info_embarque_zonarecvarsem
end type
type st_variedad from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_merccons from checkbox within w_info_embarque_zonarecvarsem
end type
type st_envase from statictext within w_info_embarque_zonarecvarsem
end type
type cbx_envase from checkbox within w_info_embarque_zonarecvarsem
end type
type cbx_varirotula from checkbox within w_info_embarque_zonarecvarsem
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_embarque_zonarecvarsem
end type
type uo_selespecie from uo_seleccion_especie within w_info_embarque_zonarecvarsem
end type
type uo_selproductor from uo_seleccion_varios_productores_clientes within w_info_embarque_zonarecvarsem
end type
end forward
...
integer width = 3895
integer height = 2080
string title = "Embarque Zonas/Mercado/Recibidor/Variedad/Semanas"
...
global w_info_embarque_zonarecvarsem w_info_embarque_zonarecvarsem
...
DataWindowChild	idwc_tipopro, idwc_cliente, idwc_planta, &
						idwc_productor, idwc_packing, idwc_mercado, &
...
on w_info_embarque_zonarecvarsem.create
int iCurrent
call super::create
...
on w_info_embarque_zonarecvarsem.destroy
call super::destroy
destroy(this.st_4)
...
type st_computador from w_para_informes`st_computador within w_info_embarque_zonarecvarsem
end type

type st_usuario from w_para_informes`st_usuario within w_info_embarque_zonarecvarsem
end type

type st_temporada from w_para_informes`st_temporada within w_info_embarque_zonarecvarsem
end type

type p_logo from w_para_informes`p_logo within w_info_embarque_zonarecvarsem
end type

type st_titulo from w_para_informes`st_titulo within w_info_embarque_zonarecvarsem
integer width = 3122
string text = "Embarque Zonas / Mercado / Recibidor / Variedad / Semanas"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_embarque_zonarecvarsem
integer x = 3461
integer y = 1308
...
Integer	ll_Fila, li_cliente, li_planta, li_semana, li_NroSemana, &
			li_tipo = 1, li_varirotula, li_zonas,li_semanatope
...
istr_info.titulo	= 'EMBARQUES POR ZONAS/CONSIGNATARIO/VARIEDAD/SEMANAS'

OpenWithParm(vinf, istr_info)
vinf.dw_1.DataObject = "dw_info_embarque_semanal_03"
...
type pb_salir from w_para_informes`pb_salir within w_info_embarque_zonarecvarsem
integer x = 3465
integer y = 1596
