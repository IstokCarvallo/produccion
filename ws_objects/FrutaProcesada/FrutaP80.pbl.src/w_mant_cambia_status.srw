$PBExportHeader$w_mant_cambia_status.srw
$PBExportComments$Mantención Detalle de Pallets a Inspeccionar accesado directamente desde el Menu.
forward
global type w_mant_cambia_status from w_mant_directo
end type
type st_2 from statictext within w_mant_cambia_status
end type
type st_1 from statictext within w_mant_cambia_status
end type
type dw_productores from datawindow within w_mant_cambia_status
end type
type pb_recupera from picturebutton within w_mant_cambia_status
end type
type st_3 from statictext within w_mant_cambia_status
end type
type dw_status from datawindow within w_mant_cambia_status
end type
type st_6 from statictext within w_mant_cambia_status
end type
type dw_2 from datawindow within w_mant_cambia_status
end type
type dw_predio from datawindow within w_mant_cambia_status
end type
end forward
...
global w_mant_cambia_status w_mant_cambia_status
...
on w_mant_cambia_status.create
int iCurrent
call super::create
...
this.Control[iCurrent+9]=this.dw_predio
end on

on w_mant_cambia_status.destroy
call super::destroy
destroy(this.st_2)
destroy(this.st_1)
...
type st_encabe from w_mant_directo`st_encabe within w_mant_cambia_status
integer x = 59
integer y = 28
integer width = 2802
integer height = 316
...
type pb_nuevo from w_mant_directo`pb_nuevo within w_mant_cambia_status
integer x = 2962
integer y = 420
integer taborder = 70
end type
...
type pb_lectura from w_mant_directo`pb_lectura within w_mant_cambia_status
integer x = 2962
integer y = 160
integer taborder = 50
end type
...
ELSEIF IsNull(dw_predio.Object.prpr_codigo[1]) THEN
	...
	RETURN
ELSEIF IsNull(dw_status.Object.stat_codigo[1]) OR  dw_status.Object.stat_codigo[1] = 0 THEN
...
//	dw_3.Enabled				=	FALSE
	...
	dw_status.Object.stat_codigo.Background.Color		=	 RGB(166,180,210)
...
type pb_eliminar from w_mant_directo`pb_eliminar within w_mant_cambia_status
...
type pb_insertar from w_mant_directo`pb_insertar within w_mant_cambia_status
boolean visible = false
integer x = 2962
integer y = 600
integer taborder = 80
...
type pb_salir from w_mant_directo`pb_salir within w_mant_cambia_status
integer x = 2962
integer y = 1684
integer taborder = 120
end type

type pb_imprimir from w_mant_directo`pb_imprimir within w_mant_cambia_status
boolean visible = false
integer x = 2962
integer y = 1140
...
type pb_grabar from w_mant_directo`pb_grabar within w_mant_cambia_status
integer x = 2962
integer y = 960
integer taborder = 100
end type

type dw_1 from w_mant_directo`dw_1 within w_mant_cambia_status
integer x = 59
integer y = 360
integer width = 2802
integer height = 1516
integer taborder = 60
string dataobject = "dw_actualiza_status_positivo"
