$PBExportHeader$w_mant_deta_generapalletdesdecajas.srw
$PBExportComments$Mantención Detalle de Despacho Pallets
forward
global type w_mant_deta_generapalletdesdecajas from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_generapalletdesdecajas w_mant_deta_generapalletdesdecajas
...
public function boolean duplicado (string campo);Long		ll_fila,ll_numcaja
String		ls_numero
...
on w_mant_deta_generapalletdesdecajas.create
call super::create
end on

on w_mant_deta_generapalletdesdecajas.destroy
call super::destroy
end on
...
//
//IF istr_mant.Agrega THEN
//	dw_1.Object.capr_estado[il_Fila]	=  1
//END IF
//
//
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_generapalletdesdecajas
boolean visible = false
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_generapalletdesdecajas
boolean visible = false
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_generapalletdesdecajas
boolean visible = false
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_generapalletdesdecajas
boolean visible = false
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_generapalletdesdecajas
integer x = 2405
integer y = 372
integer taborder = 20
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_generapalletdesdecajas
integer x = 2405
integer y = 160
integer taborder = 10
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_generapalletdesdecajas
integer x = 2405
integer y = 592
integer taborder = 30
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_generapalletdesdecajas
integer x = 9
integer y = 12
integer width = 2309
integer height = 1496
