$PBExportHeader$w_maed_palletencab_encabezado.srw
forward
global type w_maed_palletencab_encabezado from w_mant_encab_deta_csd
end type
end forward
...
integer width = 3881
integer height = 2108
string title = "RECEPCION DETALLE DE PALLET"
string menuname = ""
boolean clientedge = true
event ue_imprimir ( )
end type
global w_maed_palletencab_encabezado w_maed_palletencab_encabezado

type variables
Integer	ii_yaexiste, ii_estado

w_mant_deta_palletfruta_encab iw_mantencion

DataWindowChild	dw_especie, dw_etiqueta, dw_planta,&
                  dw_cliente,dw_condiciones,dw_emba
						
uo_recepcion_pallet				iuo_recepcion_pallet
end variables
...
Long		fila,ll
String	ls_descri,ls_recepcion

istr_info.titulo	= "RECEPCION DE PALLETS POR DETALLE"
istr_info.copias	= 1

OpenWithParm(vinf,istr_info)
vinf.dw_1.DataObject = "dw_info_recepcion_detalle_encab"   
vinf.dw_1.SetTransObject(sqlca)
ll =iuo_recepcion_pallet.Numero
ls_descri = buscdescfruta(iuo_recepcion_pallet.Condicion)

ls_recepcion = "Recepcion " +String(iuo_recepcion_pallet.Numero)
ls_recepcion = ls_recepcion + "                       Fecha "+String(iuo_recepcion_pallet.FechaRec)
ls_recepcion = ls_recepcion + "                       Guia "+String(iuo_recepcion_pallet.nrores)
ls_recepcion = ls_recepcion + "                       En Planta "+String(iuo_recepcion_pallet.Planta)

fila = vinf.dw_1.Retrieve(Integer(istr_mant.argumento[1]),Integer(istr_mant.argumento[6]),&
								  iuo_recepcion_pallet.Numero)		
...
public function boolean existepallet (string ls_columna);Integer	li_cliente, li_planta
...
ELSEIF ll_cantid > 0 THEN
	...
	ELSE
		...
		ELSEIF ll_PFruta > 0 THEN	
				MessageBox("Atención","El Numero de Pallet Ingresado tiene Detalle. Ingrese Otro.", Exclamation!, Ok!)
				lb_retorno = True
		ELSE
			IF Not iuo_recepcion_pallet.Existe(li_cliente,li_planta,ll_nropal, True, sqlca) THEN
				lb_retorno = True
			ELSE			
				...
				iuo_recepcion_pallet.Recepcion(li_planta,iuo_recepcion_pallet.Numero, False, sqlca)
				istr_mant.argumento[21] = String(iuo_recepcion_pallet.PlantaOri)
				istr_mant.argumento[39] = String(iuo_recepcion_pallet.FechaRec)
...
public function boolean validacajas ();Boolean	lb_Retorno
Long		ll_Fila, ll_CajasEncab, ll_CajasFruta

lb_Retorno		=	False
ll_CajasFruta	=	0

ll_CajasEncab = dw_2.GetItemNumber(1, "paen_ccajas")

For ll_Fila=1 to dw_1.RowCount()
	ll_CajasFruta +=	dw_1.GetitemNumber(ll_Fila,"pafr_ccajas")
Next

IF	ll_CajasEncab > 0 AND ll_CajasEncab > ll_CajasFruta THEN
	MessageBox("Atención","Cantidad de Cajas Detalle "+String(ll_CajasFruta)+&
				  " no es igual al Total Cajas Encabezado "+String(ll_CajasEncab)+". Verifique.", Exclamation!, Ok!)
	lb_Retorno = False
ELSE
	lb_Retorno = True
END IF
...
Integer 	li_Respuesta,li_cliente,li_planta,li_Entrada,li_Proceso
Long 	  	ll_Nropal
Date 		ld_Fecha
String	ls_Observa
...
ld_Fecha		=	iuo_recepcion_pallet.FechaRec
li_Entrada	=  iuo_recepcion_pallet.TipoEn

IF li_Entrada = 1  then
	ls_Observa = 'Recepción Packing';
   li_Proceso = 1 
ELSE
   ls_Observa = 'Recepción Otros';     
   li_Proceso = 2
END IF
...
public function integer varirotula ();Integer	li_VariRotula, li_Especie, li_Variedad
...
IF IsNull(li_VariRotula) THEN li_VariRotula = 0
...
iuo_recepcion_pallet			=	Create uo_recepcion_pallet
...
istr_mant.argumento[41]=String(dw_2.object.prod_codigo[1])
istr_mant.argumento[42]=String(dw_2.object.paen_calibr[1])
...
on w_maed_palletencab_encabezado.create
call super::create
end on

on w_maed_palletencab_encabezado.destroy
call super::destroy
end on
...
istr_busq.argum[2]	=	""
istr_busq.argum[5]	=  ""
istr_busq.argum[12]	=	String(dw_2.Object.plde_codigo[1])
...
Integer	li_Secuencia, li_cliente, li_planta, li_paen_mixto, li_VariRotu
...
li_VariRotu = VariRotula()

IF li_VariRotu = 0 THEN
	li_VariRotu = dw_2.Object.vari_codigo[1]	
END IF
dw_2.Object.paen_varrot[1] = li_VariRotu
...
//	dw_1.Object.pafr_nroori[ll_fila]	=	dw_2.Object.paen_numero[1]
	
	dw_1.Object.pafr_prdrot[ll_fila]	=	dw_1.Object.prod_codigo[1]
	dw_1.Object.pafr_calrot[ll_fila]	=	dw_1.Object.pafr_calibr[1]		
	dw_1.Object.pafr_varrot[ll_fila]	=	li_VariRotu						//dw_2.Object.vari_codigo[1]
	dw_1.Object.pafr_rotpak[ll_fila]	=	dw_1.Object.pafr_rotpak[1]
	
	
	dw_1.Object.pafr_embrea[ll_fila]	= dw_2.Object.emba_codigo[1]   
	dw_1.Object.pafr_nroori[ll_fila]	= dw_2.Object.paen_numero[1]  
	dw_1.Object.pafr_fecrot[ll_fila]	= dw_2.Object.paen_fecemb[1]  
	
	IF dw_1.GetItemStatus(ll_Fila, 0, Primary!) = NewModified! THEN
		li_Secuencia ++
		dw_1.Object.pafr_secuen[ll_Fila] =	li_Secuencia
		dw_1.Object.pafr_secori[ll_fila]	=  li_Secuencia
	END IF	
NEXT
...
event ue_guardar;
IF Not ValidaCajas() THEN RETURN
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_palletencab_encabezado
integer x = 82
integer y = 1132
integer width = 3301
integer height = 752
...
string dataobject = "dw_mues_palletfruta_encadetalle"
end type

type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_palletencab_encabezado
integer x = 78
integer y = 56
integer width = 2930
integer height = 1040
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_palletencab_encabezado
integer x = 3433
integer y = 256
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_palletencab_encabezado
integer x = 3433
integer y = 484
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_palletencab_encabezado
integer x = 3433
integer y = 692
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_palletencab_encabezado
integer x = 3433
integer y = 900
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_palletencab_encabezado
integer x = 3433
integer y = 1160
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_palletencab_encabezado
integer x = 3433
integer y = 1488
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_palletencab_encabezado
integer x = 3433
integer y = 1664
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_palletencab_encabezado
integer x = 3429
integer y = 80
end type
