$PBExportHeader$w_mant_deta_palletfruta_encab.srw
forward
global type w_mant_deta_palletfruta_encab from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_encab w_mant_deta_palletfruta_encab
...
on w_mant_deta_palletfruta_encab.create
call super::create
end on

on w_mant_deta_palletfruta_encab.destroy
call super::destroy
end on
...
IF istr_mant.agrega THEN
	...
	dw_1.SetItem(il_Fila, "prod_codigo", Integer(istr_mant.argumento[41]))
	dw_1.SetItem(il_Fila, "pafr_calibr", istr_mant.argumento[42])
END IF
...
dw_calibres.Retrieve(Integer(istr_mant.Argumento[3]), 	Integer(istr_mant.Argumento[4]))
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_encab
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_encab
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_encab
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_encab
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_encab
integer x = 2725
integer y = 368
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_encab
integer x = 2725
integer y = 156
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_encab
integer x = 2725
integer y = 588
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_encab
integer x = 82
integer y = 100
integer width = 2560
integer height = 1168
string dataobject = "dw_mant_palletfruta_encab"
end type
