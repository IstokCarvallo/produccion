$PBExportHeader$w_mant_deta_palletfruta_nuevo.srw
forward
global type w_mant_deta_palletfruta_nuevo from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_nuevo w_mant_deta_palletfruta_nuevo
...
li_especie	= Integer(istr_mant.argumento[14])
li_variedad	= Integer(istr_mant.argumento[15])
...
on w_mant_deta_palletfruta_nuevo.create
call super::create
end on

on w_mant_deta_palletfruta_nuevo.destroy
call super::destroy
end on
...
IF istr_mant.agrega THEN
	...
	dw_1.SetItem(il_fila, "paen_numero", Long(istr_mant.argumento[17]))
	dw_1.SetItem(il_fila, "espe_codigo", Integer(istr_mant.argumento[14]))
	dw_1.SetItem(il_fila, "vari_codigo", Integer(istr_mant.argumento[15]))
	...
	dw_1.SetItem(il_fila, "cond_codigo", Integer(istr_mant.argumento[18]))
	...
	dw_1.SetItem(il_fila, "pafr_fecemb", Date(istr_mant.argumento[46]))
	dw_1.SetItem(il_fila, "pafr_copack", Long(istr_mant.argumento[19]))
	dw_1.SetItem(il_fila, "pafr_fecing", Date(istr_mant.argumento[45]))
END IF
...
dw_variedades.Retrieve(Integer(istr_mant.argumento[14]))
					  							  
dw_embalajes.Retrieve(Integer(istr_mant.Argumento[3]))
...
dw_calibres.Retrieve(Integer(istr_mant.Argumento[14]), &
							Integer(istr_mant.Argumento[15]))
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_nuevo
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_nuevo
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_nuevo
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_nuevo
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_nuevo
integer x = 2775
integer y = 736
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_nuevo
integer x = 2775
integer y = 524
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_nuevo
integer x = 2775
integer y = 956
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_nuevo
integer x = 9
integer y = 12
integer width = 2670
integer height = 1144
string dataobject = "dw_mant_palletfruta_nuevo"
end type
