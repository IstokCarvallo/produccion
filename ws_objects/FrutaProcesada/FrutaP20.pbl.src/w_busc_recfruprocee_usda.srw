$PBExportHeader$w_busc_recfruprocee_usda.srw
forward
global type w_busc_recfruprocee_usda from w_busqueda
end type
...
integer width = 3045
integer height = 1808
string title = "Búsqueda de Recepción USDA"
boolean resizable = false
end type
global w_busc_recfruprocee_usda w_busc_recfruprocee_usda
...
on w_busc_recfruprocee_usda.create
int iCurrent
call super::create
end on

on w_busc_recfruprocee_usda.destroy
call super::destroy
end on
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_recfruprocee_usda
...
type dw_1 from w_busqueda`dw_1 within w_busc_recfruprocee_usda
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_recfruprocee_usda"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_recfruprocee_usda
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_recfruprocee_usda
integer x = 82
integer width = 2551
integer height = 620
end type
