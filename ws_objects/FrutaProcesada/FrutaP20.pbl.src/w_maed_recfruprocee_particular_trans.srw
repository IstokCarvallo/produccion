$PBExportHeader$w_maed_recfruprocee_particular_trans.srw
forward
global type w_maed_recfruprocee_particular_trans from w_mant_encab_deta_csd
end type
type pb_recupera from picturebutton within w_maed_recfruprocee_particular_trans
end type
type pb_captura from picturebutton within w_maed_recfruprocee_particular_trans
end type
type dw_3 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_4 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_5 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_6 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_7 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_8 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_9 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_11 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_12 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_13 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_14 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_10 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_15 from datawindow within w_maed_recfruprocee_particular_trans
end type
type dw_16 from datawindow within w_maed_recfruprocee_particular_trans
end type
end forward
...
global w_maed_recfruprocee_particular_trans w_maed_recfruprocee_particular_trans
...
DO WHILE  FileRead(ll_Filas, ls_Registro)>=1 
	...
	IF li_tabla	=	3 THEN
		...
		ELSE
			IF li_count_def > 0 THEN
				...
				Return
			ELSE
				UPDATE dba.PALLETENCAB_TRANS SET
				paen_estado = 1
				WHERE plde_codigo = :li_planta
				AND	clie_codigo = :li_cliente
				AND 	paen_numero = :ll_numpal;
	...
	IF li_tabla	=	7 THEN
		...
		SELECT count() 
		INTO :li_count FROM dba.SPRO_CAJASPROD
...
ELSE
	...
	IF istr_mant.argumento[20] <> '2' AND istr_mant.argumento[20] <> '6' THEN
		OpenWithParm(w_maed_palletencab_recepcion_trans, istr_mant)
	ELSE
		OpenWithParm(w_maed_palletencab_recepcion_trans_inter, istr_mant)		
	END IF
...
on w_maed_recfruprocee_particular_trans.create
int iCurrent
call super::create
...
on w_maed_recfruprocee_particular_trans.destroy
call super::destroy
...
IF pb_recupera.Visible THEN
	...
	pb_recupera.width		= 233
	pb_recupera.height	= 196
	li_visible ++
	li_posic_y += 190
END IF
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_recfruprocee_particular_trans
integer x = 41
integer y = 1056
integer width = 3419
integer height = 1044
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_recfruprocee_particular_trans
integer x = 37
integer y = 28
integer width = 3145
integer height = 1012
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 340
end type
...
type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 520
end type
...
type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_recfruprocee_particular_trans
integer x = 3566
integer y = 704
end type
...
type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 884
end type
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 1420
end type
...
type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 1688
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_recfruprocee_particular_trans
integer x = 3561
integer y = 1864
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_recfruprocee_particular_trans
integer x = 3557
integer y = 160
end type
