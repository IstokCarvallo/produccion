$PBExportHeader$w_maed_palletencab_recepcion_rotulatrans_inter.srw
forward
global type w_maed_palletencab_recepcion_rotulatrans_inter from w_maed_palletencab_trans
end type
type dw_3 from datawindow within w_maed_palletencab_recepcion_rotulatrans_inter
end type
type dw_4 from datawindow within w_maed_palletencab_recepcion_rotulatrans_inter
end type
type dw_6 from datawindow within w_maed_palletencab_recepcion_rotulatrans_inter
end type
type dw_5 from datawindow within w_maed_palletencab_recepcion_rotulatrans_inter
end type
type dw_7 from datawindow within w_maed_palletencab_recepcion_rotulatrans_inter
end type
end forward
...
global w_maed_palletencab_recepcion_rotulatrans_inter w_maed_palletencab_recepcion_rotulatrans_inter
...
on w_maed_palletencab_recepcion_rotulatrans_inter.create
int iCurrent
call super::create
...
on w_maed_palletencab_recepcion_rotulatrans_inter.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.dw_4)
destroy(this.dw_6)
...
Integer  li_clien,li_especie,li_vari,li_planta, li_codpak , li_respue,&
			li_cliente, li_variedad, li_etique, li_cond, li_Secuen, li_cont
String   ls_emba,ls_calibr, ls_embala, ls_calibre
Date     ld_fecemb
Long		ll_fila_P, ll_CajasDet, ll_null
Integer	li_Secuencia, li_paen_mixto
...
ELSE
	...
	IF istr_mant2.argumento[20] <> '3' AND istr_mant2.argumento[20] <> '6' AND & 
		istr_mant2.argumento[20] <> '2' AND istr_mant2.argumento[20] <> '9' THEN
...
If istr_mant2.Argumento[5] = 'dw_mues_repalletdeta' Then
	...
	istr_mant.argumento[58]=	istr_mant2.argumento[58]		// Productores
...
ElseIf istr_mant2.Argumento[40] = '1' Or istr_mant.argumento[50] = '5' OR istr_mant.argumento[50] = '9' Then	
	istr_mant.Borra		= False
	istr_mant.Agrega	= True
	CuentaCajas()
	istr_mant.argumento[28]=String(dw_2.object.paen_fecemb[1])
...
DO
	...
	Else
		...
		End If
		DO
//			ll_fila_d	= dw_1.Retrieve(Integer(istr_mant.argumento[1]), Long(istr_mant.argumento[2]), Integer(istr_mant.argumento[6]))
			ll_fila_d = 1
			If ll_fila_d = -1 Then
...
dw_2.GetChild("tpem_codigo", dw_emba)
dw_emba.SetTransObject(sqlca)
If dw_emba.Retrieve(dw_2.Object.clie_codigo[1], dw_2.Object.emba_codigo[1]) = 0 Then dw_emba.Insertrow(0)
...
type dw_1 from w_maed_palletencab_trans`dw_1 within w_maed_palletencab_recepcion_rotulatrans_inter
string dataobject = "dw_mues_palletfruta_rotulatrans"
boolean righttoleft = false
end type

type dw_2 from w_maed_palletencab_trans`dw_2 within w_maed_palletencab_recepcion_rotulatrans_inter
integer y = 60
integer width = 2930
integer height = 1020
end type
...
type pb_nuevo from w_maed_palletencab_trans`pb_nuevo within w_maed_palletencab_recepcion_rotulatrans_inter
integer weight = 400
fontcharset fontcharset = ansi!
end type

type pb_eliminar from w_maed_palletencab_trans`pb_eliminar within w_maed_palletencab_recepcion_rotulatrans_inter
end type

type pb_grabar from w_maed_palletencab_trans`pb_grabar within w_maed_palletencab_recepcion_rotulatrans_inter
integer x = 3310
integer y = 696
end type
...
type pb_imprimir from w_maed_palletencab_trans`pb_imprimir within w_maed_palletencab_recepcion_rotulatrans_inter
end type

type pb_salir from w_maed_palletencab_trans`pb_salir within w_maed_palletencab_recepcion_rotulatrans_inter
end type
...
type pb_ins_det from w_maed_palletencab_trans`pb_ins_det within w_maed_palletencab_recepcion_rotulatrans_inter
integer y = 1488
end type

type pb_eli_det from w_maed_palletencab_trans`pb_eli_det within w_maed_palletencab_recepcion_rotulatrans_inter
end type

type pb_buscar from w_maed_palletencab_trans`pb_buscar within w_maed_palletencab_recepcion_rotulatrans_inter
boolean visible = false
end type

type dw_histoencab from w_maed_palletencab_trans`dw_histoencab within w_maed_palletencab_recepcion_rotulatrans_inter
end type

type dw_histofruta from w_maed_palletencab_trans`dw_histofruta within w_maed_palletencab_recepcion_rotulatrans_inter
integer y = 1444
end type
