$PBExportHeader$w_mant_deta_palletfruta_rotulatrans.srw
forward
global type w_mant_deta_palletfruta_rotulatrans from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_rotulatrans w_mant_deta_palletfruta_rotulatrans

type variables
DataWindowChild   dw_calibres, dw_productor, dw_embalajes, dw_variedades,&
		                  dw_plantadesp, dw_especies, dw_etiquetas	, dw_condiciones, dw_cliente,&
						idwc_predio, idwc_cuartel, idwc_calrot, idwc_prodrot, idwc_embarot, idwc_valrot,&
						idwc_prediorot, idwc_cuartelrot, idwc_categoria, idwc_caterotula
...
String	ls_client, ls_nropal, ls_especi, ls_varied, ls_embala, ls_produc, ls_condic, ls_etique, &
			ls_planta, ls_zonaco, ls_calibr, ls_huert1, ls_cuart1, ls_secuencia
...
ls_secuencia = String(dw_1.Object.pafr_secuen[il_fila])
...
public function boolean noexistecuartel (long al_productor, integer ai_predio, integer ai_cuartel, integer ai_especie, integer ai_variedad);Boolean	lb_Retorno
Integer 	li_existe
...
ElseIf li_existe = 0 Then
	...
	If Sqlca.Sqlcode= -1 Then
		F_errorbasedatos(sqlca,"Lectura tabla CuartelVariedad")
		lb_Retorno = False
	ElseIf li_existe = 0 Then	
...
on w_mant_deta_palletfruta_rotulatrans.destroy
call super::destroy
end on
...
If istr_mant.agrega Then
	...
	dw_1.SetItem(il_fila, "pafr_varrot", Integer(istr_mant.argumento[58]))
	...
	dw_1.SetItem(il_fila, "pafr_fecrot", Date(istr_mant.argumento[28]))
...
If iuo_Cliente.Existe(Integer(istr_mant.argumento[1]), False, SqlCa) Then
	If iuo_Cliente.Controla_Rotulado = 0 Then
		dw_1.Object.pafr_varrot.Protect 	= 1
		dw_1.Object.emba_codigo.Protect	= 1
		dw_1.Object.pafr_fecrot.Protect 	= 1
		dw_1.Object.pafr_prdrot.Protect 	= 1
		dw_1.Object.pafr_huert4.Protect 	= 1
		dw_1.Object.pafr_cuart4.Protect 	= 1
		dw_1.Object.pafr_calrot.Protect 	= 1
		dw_1.Object.pafr_catrot.Protect 	= 1
		
		dw_1.Object.pafr_varrot.BackGround.Color		= 553648127
		dw_1.Object.emba_codigo.BackGround.Color	= 553648127
		dw_1.Object.pafr_fecrot.BackGround.Color		= 553648127
		dw_1.Object.pafr_prdrot.BackGround.Color 		= 553648127
		dw_1.Object.pafr_huert4.BackGround.Color		= 553648127
		dw_1.Object.pafr_cuart4.BackGround.Color		= 553648127
		dw_1.Object.pafr_calrot.BackGround.Color		= 553648127
		dw_1.Object.pafr_catrot.BackGround.Color		= 553648127
		
		dw_1.Object.pafr_varrot.Color		= Rgb(255,255,255)
		dw_1.Object.emba_codigo.Color	= Rgb(255,255,255)
		dw_1.Object.pafr_fecrot.Color		= Rgb(255,255,255)
		dw_1.Object.pafr_prdrot.Color 		= Rgb(255,255,255)
		dw_1.Object.pafr_huert4.Color		= Rgb(255,255,255)
		dw_1.Object.pafr_cuart4.Color		= Rgb(255,255,255)
		dw_1.Object.pafr_calrot.Color		= Rgb(255,255,255)
		dw_1.Object.pafr_catrot.Color		= Rgb(255,255,255)
	End If	
End If
...
IF Isnull(dw_1.Object.pafr_catrot[il_fila]) OR dw_1.Object.pafr_catrot[il_fila] = 0 THEN
	li_cont ++
	ls_mensaje 			= ls_mensaje + "~nCategoria Rotulada"
	ls_colu[li_cont]	= "pafr_catrot"
END IF
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_rotulatrans
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_rotulatrans
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_rotulatrans
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_rotulatrans
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_rotulatrans
integer x = 3474
integer y = 916
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_rotulatrans
integer x = 3474
integer y = 700
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_rotulatrans
integer x = 3474
integer y = 1136
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_rotulatrans
integer x = 78
integer y = 112
integer width = 3291
integer height = 1376
...
//		End If
	...
	Case "pafr_ccajas"
		...
		If Long(data) > Long(istr_mant.Argumento[11]) Then
			MessageBox("Atención", "Cajas ingresadas sobrepasan las " + istr_mant.Argumento[11] + " cajas del Pallet")
			dw_1.SetItem(il_fila, ls_columna, Long(istr_mant.Argumento[11]))
			Return 1
		End If
...
//		End If	
	...
	Case "pafr_cuart4"
		If Not NoExisteCuartel(dw_1.Object.pafr_prdrot[row], dw_1.Object.pafr_huert4[row], Integer(data),&
									dw_1.Object.espe_codigo[row], dw_1.Object.pafr_varrot[row]) Then
