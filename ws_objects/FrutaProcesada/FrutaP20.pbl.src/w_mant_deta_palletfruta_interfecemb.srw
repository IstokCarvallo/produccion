$PBExportHeader$w_mant_deta_palletfruta_interfecemb.srw
forward
global type w_mant_deta_palletfruta_interfecemb from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_interfecemb w_mant_deta_palletfruta_interfecemb
...
on w_mant_deta_palletfruta_interfecemb.create
call super::create
end on

on w_mant_deta_palletfruta_interfecemb.destroy
call super::destroy
end on
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_interfecemb
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_interfecemb
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_interfecemb
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_interfecemb
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_interfecemb
integer x = 2725
integer y = 368
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_interfecemb
integer x = 2725
integer y = 156
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_interfecemb
integer x = 2725
integer y = 588
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_interfecemb
integer x = 14
integer y = 12
integer width = 2638
integer height = 1308
string dataobject = "dw_mant_palletfruta_interfecemb"
end type
