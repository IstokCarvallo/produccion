$PBExportHeader$w_busc_recfruprocee_devolucion_puerto.srw
forward
global type w_busc_recfruprocee_devolucion_puerto from w_busqueda
end type
...
integer width = 3045
integer height = 1808
string title = "Búsqueda de Despachos"
boolean resizable = false
end type
global w_busc_recfruprocee_devolucion_puerto w_busc_recfruprocee_devolucion_puerto
...
on w_busc_recfruprocee_devolucion_puerto.create
int iCurrent
call super::create
end on

on w_busc_recfruprocee_devolucion_puerto.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[5]	= String(dw_1.Object.rfpe_numero[dw_1.GetRow()])
istr_busq.argum[6]	= String(dw_1.Object.rfpe_fecrec[dw_1.GetRow()])
istr_busq.argum[7]	= String(dw_1.Object.rfpe_tarjas[dw_1.GetRow()])
istr_busq.argum[17]	= String(dw_1.Object.rfpe_tipoen[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_recfruprocee_devolucion_puerto
...
type dw_1 from w_busqueda`dw_1 within w_busc_recfruprocee_devolucion_puerto
integer y = 760
integer width = 2725
integer taborder = 60
string dataobject = "dw_mues_recfruprocee_devolucion_puerto"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_recfruprocee_devolucion_puerto
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_recfruprocee_devolucion_puerto
integer x = 82
integer width = 2619
integer height = 620
end type
...
event pb_filtrar::clicked;call super::clicked;IF dw_1.Retrieve( Integer(istr_busq.argum[1]),Integer(istr_busq.argum[2])) > 0 THEN
	dw_1.SetFocus()
	dw_1.SelectRow(1,True)
	//istr_busq.argum[5]	= String(dw_1.GetItemNumber(dw_1.GetRow(), "rfpe_numero"))
