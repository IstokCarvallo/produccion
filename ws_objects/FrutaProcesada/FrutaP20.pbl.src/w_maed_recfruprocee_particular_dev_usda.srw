$PBExportHeader$w_maed_recfruprocee_particular_dev_usda.srw
forward
global type w_maed_recfruprocee_particular_dev_usda from w_mant_encab_deta_csd
end type
end forward
...
global w_maed_recfruprocee_particular_dev_usda w_maed_recfruprocee_particular_dev_usda
...
OpenWithParm(w_maed_palletencab_recepcion_usda, istr_mant)
...
on w_maed_recfruprocee_particular_dev_usda.create
call super::create
end on

on w_maed_recfruprocee_particular_dev_usda.destroy
call super::destroy
end on
...
OpenWithParm(w_busc_recfruprocee_usda, istr_busq)
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_recfruprocee_particular_dev_usda
integer x = 41
integer y = 928
integer width = 3374
integer height = 972
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_recfruprocee_particular_dev_usda
integer x = 37
integer y = 28
integer width = 3113
integer height = 832
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_recfruprocee_particular_dev_usda
integer x = 3543
integer y = 276
end type
...
type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_recfruprocee_particular_dev_usda
...
type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_recfruprocee_particular_dev_usda
integer x = 3547
integer y = 640
end type
...
type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_recfruprocee_particular_dev_usda
boolean visible = false
integer x = 3543
integer y = 820
end type
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_recfruprocee_particular_dev_usda
integer x = 3557
integer y = 984
end type
...
type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_recfruprocee_particular_dev_usda
integer x = 3557
integer y = 1344
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_recfruprocee_particular_dev_usda
integer x = 3557
integer y = 1520
end type
...
type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_recfruprocee_particular_dev_usda
integer x = 3538
integer y = 96
end type
