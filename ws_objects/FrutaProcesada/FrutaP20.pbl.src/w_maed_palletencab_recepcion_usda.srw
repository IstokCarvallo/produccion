$PBExportHeader$w_maed_palletencab_recepcion_usda.srw
forward
global type w_maed_palletencab_recepcion_usda from w_maed_palletencab_trans
end type
type dw_3 from datawindow within w_maed_palletencab_recepcion_usda
end type
end forward
...
global w_maed_palletencab_recepcion_usda w_maed_palletencab_recepcion_usda
...
on w_maed_palletencab_recepcion_usda.create
int iCurrent
call super::create
...
on w_maed_palletencab_recepcion_usda.destroy
call super::destroy
destroy(this.dw_3)
end on
...
type dw_1 from w_maed_palletencab_trans`dw_1 within w_maed_palletencab_recepcion_usda
integer x = 78
integer y = 528
integer height = 1124
...
type dw_2 from w_maed_palletencab_trans`dw_2 within w_maed_palletencab_recepcion_usda
integer x = 471
integer y = 52
integer width = 1467
integer height = 172
...
type pb_nuevo from w_maed_palletencab_trans`pb_nuevo within w_maed_palletencab_recepcion_usda
boolean visible = false
end type

type pb_eliminar from w_maed_palletencab_trans`pb_eliminar within w_maed_palletencab_recepcion_usda
boolean visible = false
end type

type pb_grabar from w_maed_palletencab_trans`pb_grabar within w_maed_palletencab_recepcion_usda
end type

event pb_grabar::clicked;//
Integer 	li_Fila, li_filanew, li_cliente, li_planta, li_tipoen, li_Tipocamion, li_puerto, li_transportista
Long		ll_numero, ll_numerores
String	ls_nombre, ls_computador, ls_patente, ls_chofer, ls_embarque
...
//		END IF
		...
		w_maed_recfruprocee_particular_dev_usda.TriggerEvent("ue_traedatos")
...
type pb_imprimir from w_maed_palletencab_trans`pb_imprimir within w_maed_palletencab_recepcion_usda
boolean visible = false
end type

type pb_salir from w_maed_palletencab_trans`pb_salir within w_maed_palletencab_recepcion_usda
end type
...
type pb_ins_det from w_maed_palletencab_trans`pb_ins_det within w_maed_palletencab_recepcion_usda
boolean visible = false
integer y = 1488
end type

type pb_eli_det from w_maed_palletencab_trans`pb_eli_det within w_maed_palletencab_recepcion_usda
boolean visible = false
end type

type pb_buscar from w_maed_palletencab_trans`pb_buscar within w_maed_palletencab_recepcion_usda
boolean visible = false
end type

type dw_histoencab from w_maed_palletencab_trans`dw_histoencab within w_maed_palletencab_recepcion_usda
integer x = 1637
integer y = 2144
end type

type dw_histofruta from w_maed_palletencab_trans`dw_histofruta within w_maed_palletencab_recepcion_usda
integer x = 0
integer y = 2020
end type
