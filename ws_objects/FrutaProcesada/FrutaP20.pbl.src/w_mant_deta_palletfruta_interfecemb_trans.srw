$PBExportHeader$w_mant_deta_palletfruta_interfecemb_trans.srw
forward
global type w_mant_deta_palletfruta_interfecemb_trans from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_interfecemb_trans w_mant_deta_palletfruta_interfecemb_trans
...
on w_mant_deta_palletfruta_interfecemb_trans.create
call super::create
end on

on w_mant_deta_palletfruta_interfecemb_trans.destroy
call super::destroy
end on
...
ELSE
	...
	dw_1.Object.vari_codigo.BackGround.Color	=	RGB(192,192,192)
	dw_1.Object.emba_codigo.BackGround.Color	=	RGB(192,192,192)
END IF
end event

type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_interfecemb_trans
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_interfecemb_trans
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_interfecemb_trans
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_interfecemb_trans
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_interfecemb_trans
integer x = 2725
integer y = 368
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_interfecemb_trans
integer x = 2725
integer y = 156
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_interfecemb_trans
integer x = 2725
integer y = 588
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_interfecemb_trans
integer x = 9
integer y = 12
integer width = 2638
integer height = 1308
string dataobject = "dw_mant_palletfruta_interfecemb_trans"
end type
...
CHOOSE CASE ls_columna
	...
	CASE "prod_codigo"
		...
		ELSE//IF istr_mant.Argumento[20]='1' THEN
		...
		dw_1.SetItem(il_fila, "pafr_prdrot", ll_Prod)
