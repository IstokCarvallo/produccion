$PBExportHeader$w_maed_recfruprocee_particular_caja.srw
forward
global type w_maed_recfruprocee_particular_caja from w_mant_encab_deta_csd
end type
end forward
...
global w_maed_recfruprocee_particular_caja w_maed_recfruprocee_particular_caja
...
event ue_traedatos();dw_2.retrieve(Integer(istr_mant.argumento[1]),Long(istr_mant.argumento[37]),Integer(istr_mant.argumento[3]))
dw_1.retrieve(Integer(istr_mant.argumento[1]),Long(istr_mant.argumento[37]),Integer(istr_mant.argumento[3]))
end event
...
public subroutine habilitaencab (boolean habilita);IF Habilita THEN
	...
	dw_2.Object.rfpe_horrec.Protect		=	0
	...
	dw_2.Object.rfpe_horrec.Color 	= 0
	...
	dw_2.Object.rfpe_horrec.BackGround.Color 	= Rgb(255,255,255)
...
IF dw_2.RowCount() > 0 THEN
	IF ii_tipoEnt	=	 3 OR ii_tipoEnt	=	 5 THEN	
		IF Isnull(dw_2.Object.plde_codigo[1]) OR dw_2.Object.plde_codigo[1]	=	0	OR &
			...
			IsNull(dw_2.Object.rfpe_ptaori[1]) OR dw_2.Object.rfpe_ptaori[1] = 0 THEN
			lb_Estado	=	False
		END IF		
	ELSE
		IF IsNull(dw_2.Object.plde_codigo[1]) OR dw_2.Object.plde_codigo[1] = 0 OR &
			...
			IsNull(dw_2.Object.rfpe_ptaori[1]) OR dw_2.Object.rfpe_ptaori[1] = 0 OR &		
			IsNull(dw_2.Object.rfpe_fecrec[1]) OR dw_2.Object.rfpe_fecrec[1] = ld_Fecha THEN
...
If ii_tipoEnt = 3 Then	
	This.Title = 'RECEPCION DESDE PACKING'	
Else //OR ii_tipoEnt = 5 
	This.Title = 'RECEPCION DE REEMBALAJE PACKING'
End If
...
Else //OR ii_tipoEnt = 5 
	dw_2.Object.rfpe_tipoen[1] = ii_TipoEnt
End If
...
If ii_tipoEnt = 3 OR ii_tipoEnt = 5 Then		
	dw_ptaori.Setfilter("plde_codigo="+String(gi_Packing))
	dw_ptaori.Filter()
...
Else
	dw_ptaori.Setfilter("plde_tipopl="+String(li_TipoPlanta))
	dw_ptaori.Filter()
End If
...
on w_maed_recfruprocee_particular_caja.create
call super::create
end on

on w_maed_recfruprocee_particular_caja.destroy
call super::destroy
end on
...
IF ii_TipoEnt	=	3	OR ii_TipoEnt	=	5 THEN
	dw_2.Object.rfpe_ptaori[1]	=	gi_Packing
END IF
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_recfruprocee_particular_caja
integer x = 37
integer y = 724
integer width = 3429
integer height = 1140
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_recfruprocee_particular_caja
integer x = 37
integer y = 28
integer width = 2551
integer height = 660
string dataobject = "dw_mant_recfruprocee_particular_caja"
end type
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_recfruprocee_particular_caja
integer x = 3602
integer y = 324
end type
...
type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_recfruprocee_particular_caja
...
type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_recfruprocee_particular_caja
integer x = 3607
integer y = 688
end type
...
type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_recfruprocee_particular_caja
boolean visible = false
integer x = 3602
integer y = 868
end type
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_recfruprocee_particular_caja
integer x = 3616
integer y = 1032
end type
...
type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_recfruprocee_particular_caja
integer x = 3616
integer y = 1284
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_recfruprocee_particular_caja
integer x = 3616
integer y = 1460
end type
...
type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_recfruprocee_particular_caja
integer x = 3598
integer y = 140
end type
