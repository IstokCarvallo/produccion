$PBExportHeader$w_maed_palletencab_recepcion_trans.srw
forward
global type w_maed_palletencab_recepcion_trans from w_maed_palletencab_trans
end type
type dw_3 from datawindow within w_maed_palletencab_recepcion_trans
end type
type dw_4 from datawindow within w_maed_palletencab_recepcion_trans
end type
type dw_6 from datawindow within w_maed_palletencab_recepcion_trans
end type
type dw_5 from datawindow within w_maed_palletencab_recepcion_trans
end type
end forward
...
global w_maed_palletencab_recepcion_trans w_maed_palletencab_recepcion_trans
...
on w_maed_palletencab_recepcion_trans.create
int iCurrent
call super::create
...
on w_maed_palletencab_recepcion_trans.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.dw_4)
destroy(this.dw_6)
...
type dw_1 from w_maed_palletencab_trans`dw_1 within w_maed_palletencab_recepcion_trans
boolean righttoleft = false
end type

type dw_2 from w_maed_palletencab_trans`dw_2 within w_maed_palletencab_recepcion_trans
integer y = 60
end type
...
//			dw_6.SetTransObject(sqlca)
//			ll_fila = dw_6.Retrieve(Integer(istr_mant.argumento[1]), Long(data), &
//									Integer(istr_mant.argumento[6]))
		END IF	
...
type pb_nuevo from w_maed_palletencab_trans`pb_nuevo within w_maed_palletencab_recepcion_trans
end type

type pb_eliminar from w_maed_palletencab_trans`pb_eliminar within w_maed_palletencab_recepcion_trans
end type

type pb_grabar from w_maed_palletencab_trans`pb_grabar within w_maed_palletencab_recepcion_trans
end type
...
type pb_imprimir from w_maed_palletencab_trans`pb_imprimir within w_maed_palletencab_recepcion_trans
end type

type pb_salir from w_maed_palletencab_trans`pb_salir within w_maed_palletencab_recepcion_trans
end type
...
type pb_ins_det from w_maed_palletencab_trans`pb_ins_det within w_maed_palletencab_recepcion_trans
integer y = 1488
end type

type pb_eli_det from w_maed_palletencab_trans`pb_eli_det within w_maed_palletencab_recepcion_trans
end type

type pb_buscar from w_maed_palletencab_trans`pb_buscar within w_maed_palletencab_recepcion_trans
boolean visible = false
end type

type dw_histoencab from w_maed_palletencab_trans`dw_histoencab within w_maed_palletencab_recepcion_trans
end type

type dw_histofruta from w_maed_palletencab_trans`dw_histofruta within w_maed_palletencab_recepcion_trans
integer y = 1444
end type
