$PBExportHeader$w_mant_deta_palletfruta_trans.srw
forward
global type w_mant_deta_palletfruta_trans from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_trans w_mant_deta_palletfruta_trans
...
on w_mant_deta_palletfruta_trans.create
call super::create
end on

on w_mant_deta_palletfruta_trans.destroy
call super::destroy
end on
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_trans
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_trans
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_trans
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_trans
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_trans
integer x = 2725
integer y = 368
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_trans
integer x = 2725
integer y = 156
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_trans
integer x = 2725
integer y = 588
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_trans
integer x = 9
integer y = 12
integer width = 2638
integer height = 1240
string dataobject = "dw_mant_palletfruta_trans"
end type
