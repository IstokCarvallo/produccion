$PBExportHeader$w_busc_aplica_plaguisida_productor.srw
forward
global type w_busc_aplica_plaguisida_productor from w_busqueda
end type
...
integer width = 3045
integer height = 1808
string title = "Búsqueda Plaguicidas Productores"
boolean resizable = false
end type
global w_busc_aplica_plaguisida_productor w_busc_aplica_plaguisida_productor
...
is_ordena = 'Nro. Despacho:defe_numero,Fecha Despacho:defe_fecdes,Tipo Salida:defe_tiposa'
...
on w_busc_aplica_plaguisida_productor.create
int iCurrent
call super::create
end on

on w_busc_aplica_plaguisida_productor.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[3]	= String(dw_1.Object.espe_codigo[dw_1.GetRow()])
istr_busq.argum[4]	= String(dw_1.Object.prod_codigo[dw_1.GetRow()])
istr_busq.argum[5]	= String(dw_1.Object.decl_fecdec[dw_1.GetRow()])
istr_busq.argum[6]	= String(dw_1.Object.decl_predio[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_aplica_plaguisida_productor
...
type dw_1 from w_busqueda`dw_1 within w_busc_aplica_plaguisida_productor
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_busc_aplic_plaguisida_productor"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_aplica_plaguisida_productor
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_aplica_plaguisida_productor
integer y = 96
integer width = 2551
integer height = 620
end type
...
event clicked;call super::clicked;IF dw_1.Retrieve(Integer(istr_busq.argum[1]), Integer(istr_busq.argum[2])) > 0 THEN
	...
	istr_busq.argum[5]	= String(dw_1.GetItemNumber(dw_1.GetROw(), "defe_numero"))
ELSE
	MessageBox("Atención","No hay información para mostrar",Exclamation!,Ok!)
...
idwc_planta.Retrieve(Integer(data),1)
end event
