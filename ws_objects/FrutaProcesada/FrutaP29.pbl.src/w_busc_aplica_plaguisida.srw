$PBExportHeader$w_busc_aplica_plaguisida.srw
forward
global type w_busc_aplica_plaguisida from w_busqueda
end type
...
integer width = 3045
integer height = 1808
string title = "Búsqueda Embarques Patentes"
boolean resizable = false
end type
global w_busc_aplica_plaguisida w_busc_aplica_plaguisida
...
on w_busc_aplica_plaguisida.create
int iCurrent
call super::create
end on

on w_busc_aplica_plaguisida.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[3]	= String(dw_1.Object.espe_codigo[dw_1.GetRow()])
istr_busq.argum[4]	= String(dw_1.Object.embq_codigo[dw_1.GetRow()])
istr_busq.argum[5]	= String(dw_1.Object.decl_patent[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_aplica_plaguisida
...
type dw_1 from w_busqueda`dw_1 within w_busc_aplica_plaguisida
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_busc_aplic_plaguisida"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_aplica_plaguisida
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_aplica_plaguisida
integer y = 96
integer width = 2551
integer height = 620
end type
