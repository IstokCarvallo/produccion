$PBExportHeader$w_maed_reetienc_por_inspeccion.srw
$PBExportComments$Ventana Mantenedor Encabezado de Reetiquetado.
forward
global type w_maed_reetienc_por_inspeccion from w_mant_encab_deta_csd
end type
type dw_3 from datawindow within w_maed_reetienc_por_inspeccion
end type
end forward
...
global w_maed_reetienc_por_inspeccion w_maed_reetienc_por_inspeccion
...
public function boolean existeinspeccion (string as_columna, string as_valor)
end prototypes
...
IF dw_2.RowCount() > 0 THEN
	IF IsNull(dw_2.Object.plde_codigo[1]) OR dw_2.Object.plde_codigo[1] = 0 OR &
		...
		IsNull(dw_2.Object.inpe_numero[1]) OR dw_2.Object.inpe_numero[1] = 0 OR &
...
public subroutine habilitaencab (boolean habilita);IF Habilita THEN
	...
	dw_2.Object.inpe_numero.Protect	=	0
	...
	dw_2.Object.inpe_numero.Color 	= 0
	...
	dw_2.Object.inpe_numero.BackGround.Color 	= RGB(255,255,255)
...
ELSE
	...
	dw_2.Object.inpe_numero.Protect	=	1
	...
	dw_2.Object.inpe_numero.Color 	= RGB(255,255,255)
	...
	dw_2.Object.inpe_numero.BackGround.Color 	= 553648127
...
public function boolean existeinspeccion (string as_columna, string as_valor);Integer	li_Planta, li_Existe, li_Cliente
Long		ll_Numero

ll_Numero 	=	dw_2.Object.inpe_numero[1]
li_Cliente	=	dw_2.Object.clie_codigo[1]
li_Planta	=	dw_2.Object.plde_codigo[1]
...
on w_maed_reetienc_por_inspeccion.create
int iCurrent
call super::create
...
on w_maed_reetienc_por_inspeccion.destroy
call super::destroy
destroy(this.dw_3)
end on
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_reetienc_por_inspeccion
integer x = 41
integer y = 840
integer width = 2478
integer height = 1072
...
string dataobject = "dw_info_inspeccion_palletencab"
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_reetienc_por_inspeccion
integer x = 41
integer y = 68
integer width = 2405
integer height = 672
string dataobject = "dw_mant_reetienc_por_inspeccion"
end type
	...
	CASE "clie_codigo"
		...
		ELSE
         ...
         dw_2.GetChild("plde_codigo", dw_planta)
			...
			idwc_etiquetaant.SetTransObject(sqlca)
			idwc_etiquetaant.Retrieve()			
			IF existeinspeccion(ls_columna, data) THEN
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_reetienc_por_inspeccion
integer x = 2647
integer y = 284
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_reetienc_por_inspeccion
boolean visible = false
integer x = 2647
integer y = 512
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_reetienc_por_inspeccion
integer x = 2647
integer y = 728
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_reetienc_por_inspeccion
boolean visible = false
integer x = 2647
integer y = 960
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_reetienc_por_inspeccion
integer x = 2647
integer y = 1188
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_reetienc_por_inspeccion
boolean visible = false
integer x = 2647
integer y = 1532
integer taborder = 90
...
type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_reetienc_por_inspeccion
boolean visible = false
integer x = 2647
integer y = 1708
...
type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_reetienc_por_inspeccion
boolean visible = false
integer x = 2647
integer y = 104
...
string title = "none"
string dataobject = "dw_mues_reetidet_por_inspeccion"
