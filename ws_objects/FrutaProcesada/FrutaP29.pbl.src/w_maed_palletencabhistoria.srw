$PBExportHeader$w_maed_palletencabhistoria.srw
forward
global type w_maed_palletencabhistoria from w_mant_encab_deta_csd
end type
type dw_3 from datawindow within w_maed_palletencabhistoria
end type
type ids_palletfrutahisto from datawindow within w_maed_palletencabhistoria
end type
type ids_palletencabhisto from datawindow within w_maed_palletencabhistoria
end type
end forward
...
integer width = 3538
integer height = 2064
string title = "Ingreso de Pallet"
string menuname = ""
...
global w_maed_palletencabhistoria w_maed_palletencabhistoria
...
public function boolean existecondicion (integer as_valor); integer	li_condicion
 ...
 SELECT DBA.CONDICION.COND_NOMBRE  
    INTO :ls_descondicion  
    FROM DBA.CONDICION  
   WHERE DBA.CONDICION.COND_CODIGO = : li_condicion   ;
...
public function boolean existeplanta (integer as_valor); integer li_planta, li_cliente
 ...
 SELECT DBA.PLANTADESP.PLDE_NOMBRE  
    INTO : ls_desplanta  
    FROM  DBA.PLANTADESP  
   WHERE ( DBA.PLANTADESP.PLDE_CODIGO = : li_planta )   ;
IF sqlca.SQLCode = 0 THEN
...
dw_2.Object.clie_codigo.BackGround.Color = RGB(166,180,210)
dw_2.Object.plde_codigo.BackGround.Color = RGB(166,180,210)
dw_2.Object.paen_pmixto.BackGround.Color = RGB(166,180,210)
dw_2.Object.emba_codigo.BackGround.Color = RGB(166,180,210)
...
dw_2.Object.paen_estado.BackGround.Color = RGB(166,180,210)
...
dw_2.Object.paen_pmixto.BackGround.Color = RGB(166,180,210)
dw_2.Object.paen_pexpor.BackGround.Color = RGB(166,180,210)
...
IF ll_cantidad = 0 OR IsNull(ll_cantidad) THEN
	...
	INSERT INTO dba.palletencabhisto (clie_codigo,paen_numero,plde_codigo,pahi_tipopa,
...
IF ll_cantidad = 0 OR IsNull(ll_cantidad) THEN
	...
	INSERT INTO dba.palletfrutahisto (clie_codigo,paen_numero,espe_codigo,vari_codigo,
		emba_codigo,prod_codigo,cond_codigo,etiq_codigo,plde_codigo,pafh_calibr,
		pafh_secuen,pafh_ccajas,pafh_nrlote)
...
public function boolean existepallet (string ls_columna);Integer	li_cliente, li_cantid, li_planta
...
ELSEIF li_cantid > 0 THEN
		...
		//	dw_especie.Retrieve(li_cliente)
		//	dw_etiqueta.Retrieve(li_cliente)
...
DO
	...
	ELSE
		...
		dw_2.GetChild("tpem_codigo", dw_emba)
		dw_emba.SetTransObject(sqlca)
		dw_emba.Retrieve(dw_2.Object.clie_codigo[1], dw_2.Object.emba_codigo[1])
...
on w_maed_palletencabhistoria.create
int iCurrent
call super::create
...
this.Control[iCurrent+3]=this.ids_palletencabhisto
end on

on w_maed_palletencabhistoria.destroy
call super::destroy
destroy(this.dw_3)
		...
		IF NOT Duplicado(Integer(istr_mant.Argumento[1]), Integer(istr_mant2.Argumento[1]),dw_2.Object.paen_numero[1]) THEN
			IF dw_3.DataObject = 'dw_mues_repalletdeta' THEN
				...
				FOR li_fila3 = 1 to dw_1.RowCount()
					...
					IF istr_mant.Argumento[46] = '1' OR istr_mant.Argumento[46] = '2' THEN
						...
						dw_3.Object.repd_tipood[ll_fila2]		=	2
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_palletencabhistoria
integer x = 55
integer y = 1148
integer width = 3086
integer height = 752
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_palletencabhistoria
integer x = 78
integer y = 56
integer width = 2985
integer height = 1064
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_palletencabhistoria
integer y = 252
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_palletencabhistoria
boolean visible = false
integer y = 480
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_palletencabhistoria
integer y = 688
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_palletencabhistoria
boolean visible = false
integer y = 896
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_palletencabhistoria
integer y = 1156
end type
...
type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_palletencabhistoria
integer x = 3301
integer y = 1484
integer taborder = 90
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_palletencabhistoria
integer x = 3301
integer y = 1660
integer taborder = 100
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_palletencabhistoria
boolean visible = false
integer y = 76
