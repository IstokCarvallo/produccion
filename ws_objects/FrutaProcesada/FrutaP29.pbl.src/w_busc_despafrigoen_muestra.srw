$PBExportHeader$w_busc_despafrigoen_muestra.srw
forward
global type w_busc_despafrigoen_muestra from w_busqueda
end type
...
global w_busc_despafrigoen_muestra w_busc_despafrigoen_muestra
...
on w_busc_despafrigoen_muestra.create
int iCurrent
call super::create
end on

on w_busc_despafrigoen_muestra.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[5]	= String(dw_1.Object.defe_numero[dw_1.GetRow()])
istr_busq.argum[6]	= String(dw_1.Object.defe_fecdes[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_despafrigoen_muestra
...
type dw_1 from w_busqueda`dw_1 within w_busc_despafrigoen_muestra
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_despafrigoen_muestra_inspe"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_despafrigoen_muestra
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_despafrigoen_muestra
integer y = 96
integer width = 2551
integer height = 620
end type
