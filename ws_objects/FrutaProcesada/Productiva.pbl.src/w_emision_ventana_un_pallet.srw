$PBExportHeader$w_emision_ventana_un_pallet.srw
$PBExportComments$Emisión de Ventana Pallet por un pallet
forward
global type w_emision_ventana_un_pallet from window
end type
type pb_salir from picturebutton within w_emision_ventana_un_pallet
end type
type pb_imprimir from picturebutton within w_emision_ventana_un_pallet
end type
type pb_nuevo from picturebutton within w_emision_ventana_un_pallet
end type
type pb_lectura from picturebutton within w_emision_ventana_un_pallet
end type
type pb_2 from picturebutton within w_emision_ventana_un_pallet
end type
type pb_1 from picturebutton within w_emision_ventana_un_pallet
end type
type sle_movto from singlelineedit within w_emision_ventana_un_pallet
end type
type st_1 from statictext within w_emision_ventana_un_pallet
end type
type dw_2 from datawindow within w_emision_ventana_un_pallet
end type
type iuo_especie from uo_seleccion_especie within w_emision_ventana_un_pallet
end type
type iuo_cliente from uo_seleccion_clientesprod within w_emision_ventana_un_pallet
end type
type iuo_planta from uo_seleccion_plantas within w_emision_ventana_un_pallet
end type
type dw_1 from datawindow within w_emision_ventana_un_pallet
end type
type st_5 from statictext within w_emision_ventana_un_pallet
end type
type st_4 from statictext within w_emision_ventana_un_pallet
end type
type st_3 from statictext within w_emision_ventana_un_pallet
end type
type st_2 from statictext within w_emision_ventana_un_pallet
end type
type st_encabe from statictext within w_emision_ventana_un_pallet
end type
end forward
...
global w_emision_ventana_un_pallet w_emision_ventana_un_pallet
...
event ue_imprimir();Integer	Fila, li_fila, li_pagina
...
on w_emision_ventana_un_pallet.create
...
on w_emision_ventana_un_pallet.destroy
