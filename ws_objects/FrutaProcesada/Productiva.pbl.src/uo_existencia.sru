...
type variables
Integer	Codigo, kildec, bodvirtual, bodzonal, bodcomercial, bodeAdmi
String	Nombre, Nombre_ingles, CodAra, CodSAG, Prod,itgene,prdgen, correozonal, correo
Long		Count, numero, numeroactual
Date		Mesproceso
end variables
...
public function boolean existeregistro (long al_docrel, integer ai_bodvirtual, integer ai_estado, integer ai_tipdoc, boolean ab_mensaje, transaction at_transaccion, date ad_fecha)
...
public function boolean numero_actual (long al_docrel, integer ai_bodvirtual, integer ai_estado, integer ai_tipdoc, boolean ab_mensaje, transaction at_transaccion, date ad_fecha)
public function boolean bodega_zonal (integer ai_bodega, transaction at_transaccion, boolean ab_retorno)
public function boolean bodega_administradora (integer ai_bodega, boolean ab_mensaje, transaction at_transaccion)
public function boolean maximo_porfecha (integer ai_tipdoc, integer ai_bodvirtual, long al_docrel, integer ai_estado, date ad_fecha, boolean ab_mesaje, transaction at_transaccion)
end prototypes

public function boolean paramexistencia (boolean ab_mensaje, transaction at_transaccion);Boolean	lb_Retorno = True

SELECT expa_pacfri, expa_bodega, expa_itgene, expa_prdgen, expa_pakcom, expa_mespro, expa_correo
	INTO :bodvirtual, :bodzonal, :itgene, :prdgen, :bodcomercial, :Mesproceso, :correo
...
public function boolean existeregistro (long al_docrel, integer ai_bodvirtual, integer ai_estado, integer ai_tipdoc, boolean ab_mensaje, transaction at_transaccion, date ad_fecha);Boolean	lb_Retorno = True
...
SELECT count() 
	...
	AND	substring(mden_fecmov,1,7) =substring(:ad_fecha,1,7)
	USING	at_Transaccion;
...
public function boolean numero_actual (long al_docrel, integer ai_bodvirtual, integer ai_estado, integer ai_tipdoc, boolean ab_mensaje, transaction at_transaccion, date ad_fecha);Boolean	lb_Retorno = True
...
public function boolean bodega_administradora (integer ai_bodega, boolean ab_mensaje, transaction at_transaccion);Boolean	lb_Retorno = True
...
public function boolean maximo_porfecha (integer ai_tipdoc, integer ai_bodvirtual, long al_docrel, integer ai_estado, date ad_fecha, boolean ab_mesaje, transaction at_transaccion);Boolean	lb_retorno = True
