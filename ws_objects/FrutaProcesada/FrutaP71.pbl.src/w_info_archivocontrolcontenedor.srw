$PBExportHeader$w_info_archivocontrolcontenedor.srw
$PBExportComments$Informe Consolidado General de Embarques.
forward
global type w_info_archivocontrolcontenedor from w_para_informes
end type
type dw_cliente from datawindow within w_info_archivocontrolcontenedor
end type
type st_2 from statictext within w_info_archivocontrolcontenedor
end type
type em_fdesde from editmask within w_info_archivocontrolcontenedor
end type
type st_8 from statictext within w_info_archivocontrolcontenedor
end type
type dw_planta from datawindow within w_info_archivocontrolcontenedor
end type
type em_fhasta from editmask within w_info_archivocontrolcontenedor
end type
type st_14 from statictext within w_info_archivocontrolcontenedor
end type
type st_12 from statictext within w_info_archivocontrolcontenedor
end type
type cbx_cliente from checkbox within w_info_archivocontrolcontenedor
end type
type cbx_planta from checkbox within w_info_archivocontrolcontenedor
end type
type gb_5 from groupbox within w_info_archivocontrolcontenedor
end type
type cbx_2 from checkbox within w_info_archivocontrolcontenedor
end type
type gb_6 from groupbox within w_info_archivocontrolcontenedor
end type
type st_1 from statictext within w_info_archivocontrolcontenedor
end type
type st_3 from statictext within w_info_archivocontrolcontenedor
end type
type dw_transporte from datawindow within w_info_archivocontrolcontenedor
end type
type sle_mensa from statictext within w_info_archivocontrolcontenedor
end type
type gb_3 from groupbox within w_info_archivocontrolcontenedor
end type
type st_5 from statictext within w_info_archivocontrolcontenedor
end type
type dw_1 from datawindow within w_info_archivocontrolcontenedor
end type
end forward
...
global w_info_archivocontrolcontenedor w_info_archivocontrolcontenedor
...
on w_info_archivocontrolcontenedor.create
int iCurrent
call super::create
...
on w_info_archivocontrolcontenedor.destroy
call super::destroy
...
type st_computador from w_para_informes`st_computador within w_info_archivocontrolcontenedor
end type

type st_usuario from w_para_informes`st_usuario within w_info_archivocontrolcontenedor
end type

type st_temporada from w_para_informes`st_temporada within w_info_archivocontrolcontenedor
end type

type p_logo from w_para_informes`p_logo within w_info_archivocontrolcontenedor
end type

type st_titulo from w_para_informes`st_titulo within w_info_archivocontrolcontenedor
integer width = 2171
integer height = 104
string text = "Control Despachos"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_archivocontrolcontenedor
integer x = 2528
integer y = 568
...
ELSEIF ll_Fila = 0 THEN
	MessageBox("Atención", "No hay información Para Control Despachos o Ya se Generó.", &
					Exclamation!, Ok!)
	sle_mensa.Text = 'No Existe Información o Ya se Generó'
ELSE
	...
	ls_Archivo	= '\ControlDespacho'+string(ii_transporte)+'_'+String(ll_proceso)+'-'+ String(Today()) + '.xls'
	IF dw_1.SaveAs(ls_ruta + ls_archivo, Excel5!	 ,True) = -1 THEN
		...
		Return
	ELSE
		sle_mensa.Text = 'ControlDespacho'+string(ii_transporte)+'_'+String(ll_proceso)+'-'+ String(Today())+' Generado en Mis Documentos'
		dw_1.Reset()
		commit;
	END IF	
END IF
...
type pb_salir from w_para_informes`pb_salir within w_info_archivocontrolcontenedor
integer x = 2528
integer y = 908
...
boolean bringtotop = true
string title = "none"
string dataobject = "dw_excel_controlcontenedor"
boolean border = false
boolean livescroll = true
end type
