$PBExportHeader$w_mant_mues_inspecpaldet_de_aprobado_nuevo.srw
$PBExportComments$Mantención Detalle de Pallets a Inspeccionar accesado directamente desde el Menu.
forward
global type w_mant_mues_inspecpaldet_de_aprobado_nuevo from w_mant_directo
end type
type em_numero from editmask within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type ddlb_tipocond from dropdownlistbox within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_4 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_plantadesp from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_2 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_cliente from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_1 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_3 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_destino from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_5 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_6 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type em_fecha from editmask within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_2 from uo_dw within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_7 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type em_origen from editmask within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_3 from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_4 from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type st_8 from statictext within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type sle_detalle from singlelineedit within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type dw_descripcion from datawindow within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
type cbx_facturable from checkbox within w_mant_mues_inspecpaldet_de_aprobado_nuevo
end type
end forward
...
global w_mant_mues_inspecpaldet_de_aprobado_nuevo w_mant_mues_inspecpaldet_de_aprobado_nuevo
...
on w_mant_mues_inspecpaldet_de_aprobado_nuevo.create
int iCurrent
call super::create
...
this.Control[iCurrent+19]=this.sle_detalle
this.Control[iCurrent+20]=this.dw_descripcion
this.Control[iCurrent+21]=this.cbx_facturable
end on

on w_mant_mues_inspecpaldet_de_aprobado_nuevo.destroy
call super::destroy
...
type st_encabe from w_mant_directo`st_encabe within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer y = 36
integer width = 3017
integer height = 576
...
type pb_nuevo from w_mant_directo`pb_nuevo within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3186
integer y = 552
...
type pb_lectura from w_mant_directo`pb_lectura within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3186
integer taborder = 90
end type
...
type pb_eliminar from w_mant_directo`pb_eliminar within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3186
integer y = 912
integer taborder = 130
end type

type pb_insertar from w_mant_directo`pb_insertar within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3186
integer y = 732
integer taborder = 120
end type

type pb_salir from w_mant_directo`pb_salir within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3186
integer y = 1588
integer taborder = 160
end type

type pb_imprimir from w_mant_directo`pb_imprimir within w_mant_mues_inspecpaldet_de_aprobado_nuevo
...
type pb_grabar from w_mant_directo`pb_grabar within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer x = 3195
integer y = 1092
...
type dw_1 from w_mant_directo`dw_1 within w_mant_mues_inspecpaldet_de_aprobado_nuevo
integer y = 620
integer width = 3017
integer height = 1252
