$PBExportHeader$w_informes2.srw
forward
global type w_informes2 from window
end type
type pb_salir from picturebutton within w_informes2
end type
type pb_imprimir from picturebutton within w_informes2
end type
type dw_herr from datawindow within w_informes2
end type
type dw_barra from datawindow within w_informes2
end type
type dw_1 from datawindow within w_informes2
end type
type gb_1 from groupbox within w_informes2
end type
type gb_2 from groupbox within w_informes2
end type
type gb_3 from groupbox within w_informes2
end type
type gb_4 from groupbox within w_informes2
end type
type gb_5 from groupbox within w_informes2
end type
type gb_6 from groupbox within w_informes2
end type
type wstr_ano_benef from structure within w_informes2
end type
end forward
...
global w_informes2 w_informes2
...
string title = "none"
string dataobject = "dw_menu_imprimir"
boolean maxbox = true
boolean border = false
boolean livescroll = true
end type
