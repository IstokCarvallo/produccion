$PBExportHeader$w_emision_adhesivos_pallets_2.srw
forward
global type w_emision_adhesivos_pallets_2 from window
end type
type sle_movto from singlelineedit within w_emision_adhesivos_pallets_2
end type
type st_1 from statictext within w_emision_adhesivos_pallets_2
end type
type dw_2 from datawindow within w_emision_adhesivos_pallets_2
end type
type cb_2 from commandbutton within w_emision_adhesivos_pallets_2
end type
type cb_1 from commandbutton within w_emision_adhesivos_pallets_2
end type
type pb_lectura from picturebutton within w_emision_adhesivos_pallets_2
end type
type iuo_especie from uo_seleccion_especie within w_emision_adhesivos_pallets_2
end type
type iuo_cliente from uo_seleccion_clientesprod within w_emision_adhesivos_pallets_2
end type
type iuo_planta from uo_seleccion_plantas within w_emision_adhesivos_pallets_2
end type
type dw_1 from datawindow within w_emision_adhesivos_pallets_2
end type
type st_5 from statictext within w_emision_adhesivos_pallets_2
end type
type st_4 from statictext within w_emision_adhesivos_pallets_2
end type
type st_3 from statictext within w_emision_adhesivos_pallets_2
end type
type st_2 from statictext within w_emision_adhesivos_pallets_2
end type
type st_encabe from statictext within w_emision_adhesivos_pallets_2
end type
type pb_nuevo from picturebutton within w_emision_adhesivos_pallets_2
end type
type pb_salir from picturebutton within w_emision_adhesivos_pallets_2
end type
type pb_imprimir from picturebutton within w_emision_adhesivos_pallets_2
end type
type gb_3 from groupbox within w_emision_adhesivos_pallets_2
end type
type gb_2 from groupbox within w_emision_adhesivos_pallets_2
end type
type gb_1 from groupbox within w_emision_adhesivos_pallets_2
end type
end forward
...
global w_emision_adhesivos_pallets_2 w_emision_adhesivos_pallets_2
...
on w_emision_adhesivos_pallets_2.create
...
on w_emision_adhesivos_pallets_2.destroy
