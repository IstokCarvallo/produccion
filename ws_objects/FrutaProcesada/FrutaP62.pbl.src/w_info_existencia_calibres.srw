$PBExportHeader$w_info_existencia_calibres.srw
forward
global type w_info_existencia_calibres from w_para_informes
end type
type dw_cliente from datawindow within w_info_existencia_calibres
end type
type st_6 from statictext within w_info_existencia_calibres
end type
type st_4 from statictext within w_info_existencia_calibres
end type
type st_especie from statictext within w_info_existencia_calibres
end type
type st_nro2 from statictext within w_info_existencia_calibres
end type
type st_variedad from statictext within w_info_existencia_calibres
end type
type st_productor from statictext within w_info_existencia_calibres
end type
type em_productor from editmask within w_info_existencia_calibres
end type
type cb_buscaproductor from commandbutton within w_info_existencia_calibres
end type
type sle_productor from singlelineedit within w_info_existencia_calibres
end type
type cbx_productor from checkbox within w_info_existencia_calibres
end type
type st_planta from statictext within w_info_existencia_calibres
end type
type cbx_planta from checkbox within w_info_existencia_calibres
end type
type dw_planta from datawindow within w_info_existencia_calibres
end type
type gb_5 from groupbox within w_info_existencia_calibres
end type
type st_5 from statictext within w_info_existencia_calibres
end type
type rb_embalaje from radiobutton within w_info_existencia_calibres
end type
type rb_productor from radiobutton within w_info_existencia_calibres
end type
type rb_variedad from radiobutton within w_info_existencia_calibres
end type
type st_7 from statictext within w_info_existencia_calibres
end type
type cbx_consolplan from checkbox within w_info_existencia_calibres
end type
type cbx_consolprod from checkbox within w_info_existencia_calibres
end type
type rb_controltodos from radiobutton within w_info_existencia_calibres
end type
type rb_rechazados from radiobutton within w_info_existencia_calibres
end type
type rb_objetados from radiobutton within w_info_existencia_calibres
end type
type rb_habilitado from radiobutton within w_info_existencia_calibres
end type
type gb_6 from groupbox within w_info_existencia_calibres
end type
type st_1 from statictext within w_info_existencia_calibres
end type
type st_2 from statictext within w_info_existencia_calibres
end type
type uo_selcondicion from uo_seleccion_condicion within w_info_existencia_calibres
end type
type cbx_predio from checkbox within w_info_existencia_calibres
end type
type st_3 from statictext within w_info_existencia_calibres
end type
type dw_stat from datawindow within w_info_existencia_calibres
end type
type cbx_status from checkbox within w_info_existencia_calibres
end type
type uo_selespecie from uo_seleccion_especie within w_info_existencia_calibres
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_existencia_calibres
end type
type cbx_varirotula from checkbox within w_info_existencia_calibres
end type
end forward
...
global w_info_existencia_calibres w_info_existencia_calibres
...
on w_info_existencia_calibres.create
int iCurrent
call super::create
...
on w_info_existencia_calibres.destroy
call super::destroy
...
type pb_excel from w_para_informes`pb_excel within w_info_existencia_calibres
end type

type st_computador from w_para_informes`st_computador within w_info_existencia_calibres
end type

type st_usuario from w_para_informes`st_usuario within w_info_existencia_calibres
end type

type st_temporada from w_para_informes`st_temporada within w_info_existencia_calibres
end type

type p_logo from w_para_informes`p_logo within w_info_existencia_calibres
end type

type st_titulo from w_para_informes`st_titulo within w_info_existencia_calibres
integer width = 1966
string text = "Existencia por Calidad"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_existencia_calibres
...
ELSE
	IF rb_embalaje.checked THEN
		vinf.dw_1.DataObject = "dw_info_existencia_calibres"
		li_Orden = 1
	ELSEIF rb_productor.checked THEN
...
type pb_salir from w_para_informes`pb_salir within w_info_existencia_calibres
