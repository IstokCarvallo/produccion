$PBExportHeader$w_info_estiba_camaras_historico.srw
forward
global type w_info_estiba_camaras_historico from w_para_informes
end type
type st_1 from statictext within w_info_estiba_camaras_historico
end type
type st_6 from statictext within w_info_estiba_camaras_historico
end type
type st_3 from statictext within w_info_estiba_camaras_historico
end type
type st_8 from statictext within w_info_estiba_camaras_historico
end type
type st_variedad from statictext within w_info_estiba_camaras_historico
end type
type st_5 from statictext within w_info_estiba_camaras_historico
end type
type cbx_calibre from checkbox within w_info_estiba_camaras_historico
end type
type em_calidad from editmask within w_info_estiba_camaras_historico
end type
type st_10 from statictext within w_info_estiba_camaras_historico
end type
type st_2 from statictext within w_info_estiba_camaras_historico
end type
type em_embalaje from editmask within w_info_estiba_camaras_historico
end type
type cb_buscaembalaje from commandbutton within w_info_estiba_camaras_historico
end type
type cbx_1 from checkbox within w_info_estiba_camaras_historico
end type
type st_18 from statictext within w_info_estiba_camaras_historico
end type
type rb_todos from radiobutton within w_info_estiba_camaras_historico
end type
type rb_si from radiobutton within w_info_estiba_camaras_historico
end type
type rb_resi from radiobutton within w_info_estiba_camaras_historico
end type
type rb_no from radiobutton within w_info_estiba_camaras_historico
end type
type rb_rechazadossag from radiobutton within w_info_estiba_camaras_historico
end type
type rb_1 from radiobutton within w_info_estiba_camaras_historico
end type
type dw_descripcion from datawindow within w_info_estiba_camaras_historico
end type
type st_22 from statictext within w_info_estiba_camaras_historico
end type
type st_48 from statictext within w_info_estiba_camaras_historico
end type
type cbx_secuencia from checkbox within w_info_estiba_camaras_historico
end type
type uo_selcondicion from uo_seleccion_condicion within w_info_estiba_camaras_historico
end type
type st_4 from statictext within w_info_estiba_camaras_historico
end type
type st_12 from statictext within w_info_estiba_camaras_historico
end type
type st_13 from statictext within w_info_estiba_camaras_historico
end type
type st_14 from statictext within w_info_estiba_camaras_historico
end type
type st_15 from statictext within w_info_estiba_camaras_historico
end type
type uo_selplanta from uo_seleccion_plantas within w_info_estiba_camaras_historico
end type
type uo_selproductor from uo_seleccion_productor within w_info_estiba_camaras_historico
end type
type uo_selpredio from uo_seleccion_prodpredio within w_info_estiba_camaras_historico
end type
type uo_selcuartel from uo_seleccion_prodcuarteles within w_info_estiba_camaras_historico
end type
type uo_selcliente from uo_seleccion_clientesprod within w_info_estiba_camaras_historico
end type
type gb_7 from groupbox within w_info_estiba_camaras_historico
end type
type st_9 from statictext within w_info_estiba_camaras_historico
end type
type uo_selcamara from uo_seleccion_camarasbode within w_info_estiba_camaras_historico
end type
type uo_selespecie from uo_seleccion_especie within w_info_estiba_camaras_historico
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_estiba_camaras_historico
end type
type uo_seldestino from uo_seleccion_destinos within w_info_estiba_camaras_historico
end type
type st_11 from statictext within w_info_estiba_camaras_historico
end type
type st_7 from statictext within w_info_estiba_camaras_historico
end type
type st_16 from statictext within w_info_estiba_camaras_historico
end type
type cbx_proceso from checkbox within w_info_estiba_camaras_historico
end type
type em_proceso from editmask within w_info_estiba_camaras_historico
end type
type em_fecha from editmask within w_info_estiba_camaras_historico
end type
end forward
...
global w_info_estiba_camaras_historico w_info_estiba_camaras_historico
...
on w_info_estiba_camaras_historico.create
int iCurrent
call super::create
...
this.Control[iCurrent+7]=this.cbx_calibre
this.Control[iCurrent+8]=this.em_calidad
this.Control[iCurrent+9]=this.st_10
this.Control[iCurrent+10]=this.st_2
this.Control[iCurrent+11]=this.em_embalaje
this.Control[iCurrent+12]=this.cb_buscaembalaje
this.Control[iCurrent+13]=this.cbx_1
this.Control[iCurrent+14]=this.st_18
this.Control[iCurrent+15]=this.rb_todos
this.Control[iCurrent+16]=this.rb_si
this.Control[iCurrent+17]=this.rb_resi
this.Control[iCurrent+18]=this.rb_no
this.Control[iCurrent+19]=this.rb_rechazadossag
this.Control[iCurrent+20]=this.rb_1
this.Control[iCurrent+21]=this.dw_descripcion
this.Control[iCurrent+22]=this.st_22
this.Control[iCurrent+23]=this.st_48
this.Control[iCurrent+24]=this.cbx_secuencia
this.Control[iCurrent+25]=this.uo_selcondicion
...
this.Control[iCurrent+32]=this.uo_selproductor
this.Control[iCurrent+33]=this.uo_selpredio
this.Control[iCurrent+34]=this.uo_selcuartel
this.Control[iCurrent+35]=this.uo_selcliente
this.Control[iCurrent+36]=this.gb_7
this.Control[iCurrent+37]=this.st_9
this.Control[iCurrent+38]=this.uo_selcamara
this.Control[iCurrent+39]=this.uo_selespecie
this.Control[iCurrent+40]=this.uo_selvariedad
this.Control[iCurrent+41]=this.uo_seldestino
this.Control[iCurrent+42]=this.st_11
this.Control[iCurrent+43]=this.st_7
this.Control[iCurrent+44]=this.st_16
this.Control[iCurrent+45]=this.cbx_proceso
this.Control[iCurrent+46]=this.em_proceso
this.Control[iCurrent+47]=this.em_fecha
end on

on w_info_estiba_camaras_historico.destroy
call super::destroy
destroy(this.st_1)
destroy(this.st_6)
destroy(this.st_3)
...
type pb_excel from w_para_informes`pb_excel within w_info_estiba_camaras_historico
integer x = 3520
integer y = 480
end type

type st_computador from w_para_informes`st_computador within w_info_estiba_camaras_historico
end type

type st_usuario from w_para_informes`st_usuario within w_info_estiba_camaras_historico
end type

type st_temporada from w_para_informes`st_temporada within w_info_estiba_camaras_historico
end type

type p_logo from w_para_informes`p_logo within w_info_estiba_camaras_historico
integer width = 366
integer height = 264
string picturename = "\Desarrollo 17\Imagenes\Logos\RBlanco.jpg"
end type

type st_titulo from w_para_informes`st_titulo within w_info_estiba_camaras_historico
integer x = 283
integer y = 280
integer width = 3131
string text = "Informe Estiba Cámaras Historico"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_estiba_camaras_historico
...
event pb_acepta::clicked;Integer	fila, li_inspeccion, li_Proceso
...
istr_info.titulo	= 'Informe Estiba Cámaras HIstorico'
ls_data_object = "dw_info_estiba_camaras_historico"
...
fila	=	vinf.dw_1.Retrieve(uo_SelCliente.Codigo, uo_SelPlanta.Codigo, uo_SelCamara.Codigo, uo_SelEspecie.Codigo, uo_SelVariedad.Codigo,&
									 ...
									 uo_SelProductor.Codigo,uo_SelPredio.Codigo,uo_SelCuartel.Codigo, Datetime(em_Fecha.Text), li_Proceso)
...
type pb_salir from w_para_informes`pb_salir within w_info_estiba_camaras_historico
