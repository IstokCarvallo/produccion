$PBExportHeader$w_info_guia_despacho_archivo.srw
forward
global type w_info_guia_despacho_archivo from w_para_informes
end type
type st_1 from statictext within w_info_guia_despacho_archivo
end type
type st_2 from statictext within w_info_guia_despacho_archivo
end type
type dw_2 from datawindow within w_info_guia_despacho_archivo
end type
type st_6 from statictext within w_info_guia_despacho_archivo
end type
type dw_1 from datawindow within w_info_guia_despacho_archivo
end type
type em_nroguia from editmask within w_info_guia_despacho_archivo
end type
type gb_3 from groupbox within w_info_guia_despacho_archivo
end type
type cbx_1 from checkbox within w_info_guia_despacho_archivo
end type
type cbx_2 from checkbox within w_info_guia_despacho_archivo
end type
type cbx_3 from checkbox within w_info_guia_despacho_archivo
end type
type cbx_4 from checkbox within w_info_guia_despacho_archivo
end type
type st_3 from statictext within w_info_guia_despacho_archivo
end type
type st_5 from statictext within w_info_guia_despacho_archivo
end type
type st_7 from statictext within w_info_guia_despacho_archivo
end type
type st_8 from statictext within w_info_guia_despacho_archivo
end type
type em_recibidor from editmask within w_info_guia_despacho_archivo
end type
type em_rut from editmask within w_info_guia_despacho_archivo
end type
type em_direccion from editmask within w_info_guia_despacho_archivo
end type
type cbx_5 from checkbox within w_info_guia_despacho_archivo
end type
type st_9 from statictext within w_info_guia_despacho_archivo
end type
type em_observa from editmask within w_info_guia_despacho_archivo
end type
type dw_guia from datawindow within w_info_guia_despacho_archivo
end type
type cbx_6 from checkbox within w_info_guia_despacho_archivo
end type
type cbx_7 from checkbox within w_info_guia_despacho_archivo
end type
type cbx_8 from checkbox within w_info_guia_despacho_archivo
end type
type st_13 from statictext within w_info_guia_despacho_archivo
end type
type em_nomdespachador from editmask within w_info_guia_despacho_archivo
end type
type st_10 from statictext within w_info_guia_despacho_archivo
end type
type em_tipomv from editmask within w_info_guia_despacho_archivo
end type
type em_puerto from editmask within w_info_guia_despacho_archivo
end type
type em_destino from editmask within w_info_guia_despacho_archivo
end type
type st_11 from statictext within w_info_guia_despacho_archivo
end type
type st_12 from statictext within w_info_guia_despacho_archivo
end type
type st_14 from statictext within w_info_guia_despacho_archivo
end type
type em_nominspector from editmask within w_info_guia_despacho_archivo
end type
type gb_frio from groupbox within w_info_guia_despacho_archivo
end type
type cbx_frio from checkbox within w_info_guia_despacho_archivo
end type
type gb_4 from groupbox within w_info_guia_despacho_archivo
end type
type st_4 from statictext within w_info_guia_despacho_archivo
end type
type cbx_id from checkbox within w_info_guia_despacho_archivo
end type
type em_glosaespecial from editmask within w_info_guia_despacho_archivo
end type
type st_15 from statictext within w_info_guia_despacho_archivo
end type
type cbx_sdp from checkbox within w_info_guia_despacho_archivo
end type
type mle_condicion from multilineedit within w_info_guia_despacho_archivo
end type
type st_22 from statictext within w_info_guia_despacho_archivo
end type
type st_16 from statictext within w_info_guia_despacho_archivo
end type
type cbx_archivo from checkbox within w_info_guia_despacho_archivo
end type
type cbx_9 from checkbox within w_info_guia_despacho_archivo
end type
type st_17 from statictext within w_info_guia_despacho_archivo
end type
type em_numsellos from editmask within w_info_guia_despacho_archivo
end type
type st_18 from statictext within w_info_guia_despacho_archivo
end type
type em_ubisellos from editmask within w_info_guia_despacho_archivo
end type
type dw_3 from datawindow within w_info_guia_despacho_archivo
end type
type em_cansellos from editmask within w_info_guia_despacho_archivo
end type
type cbx_valores from checkbox within w_info_guia_despacho_archivo
end type
type st_19 from statictext within w_info_guia_despacho_archivo
end type
type em_ciudad from editmask within w_info_guia_despacho_archivo
end type
type cbx_csg from checkbox within w_info_guia_despacho_archivo
end type
type dw_4 from datawindow within w_info_guia_despacho_archivo
end type
type dw_5 from datawindow within w_info_guia_despacho_archivo
end type
type dw_6 from datawindow within w_info_guia_despacho_archivo
end type
type dw_7 from datawindow within w_info_guia_despacho_archivo
end type
type dw_8 from datawindow within w_info_guia_despacho_archivo
end type
type dw_tipopallet from datawindow within w_info_guia_despacho_archivo
end type
type dw_etiqueta from datawindow within w_info_guia_despacho_archivo
end type
type pb_imprime from picturebutton within w_info_guia_despacho_archivo
end type
end forward
...
global w_info_guia_despacho_archivo w_info_guia_despacho_archivo
...
str_mant istr_mant
Integer	ii_tipo, ii_condicion, ii_tipoemb, ii_especie, ii_controlcorreo, ii_controlws
String	is_report, is_Recibidor, is_Direccion, is_Rut, is_archivo, is_asunto, is_tipopla,&
			is_ciudad, is_embarque, is_correosaampuerto, is_parteemb, is_archivoguias, is_nave
integer  ii_var, ii_prod, ii_cal, ii_cli, ii_pakrot, ii_controlstembex
...
public function boolean carga_ws_guia ()
public function boolean busca_parametro ()
public subroutine enviaguiatembex ()
end prototypes

public function boolean existeguia (long al_guia);Integer	li_codexp, li_planta, li_Tipova, li_tipoembq, li_embc_codigo, li_tecnic, li_cansel, li_consol, li_plades
Date		ld_fecha
String	ls_Embarque, ls_puerto, ls_destino, ls_contraparte, ls_numsel, ls_ubisel, is_codagente
...
IF al_guia <> 0 OR li_planta = 0 THEN
	...
	ELSEIF li_tipoembq = 7 OR li_tipoembq = 8 OR li_tipoembq = 9 THEN		
		...
		FROM	dba.EMBARQUEPROD as em, dba.destinos as de, dba.puertos as pu
...
//				RETURN False
		ELSE					
			SELECT embc_nombre, embc_direcc, embc_nrorut, embc_ciudad, isnull(embc_codage,'')
			INTO	:is_Recibidor, :is_Direccion, :is_Rut, :is_ciudad, :is_codagente
			FROM	dba.EMBARCADORES 
            ...
            END IF
				...
				em_recibidor.Text			=	is_Recibidor+'      ' +is_codagente
				em_rut.Text					=	is_Rut
...
Date ld_fecha
  ...
  SELECT max(fumi_fecfum)  
    INTO :ld_fecha
    FROM dba.fumigadet as det,dba.fumigaenc as enc 
...
//IF ls_planta = '0002' OR ls_planta = '0004' THEN
//	IF Upper(ls_tipodespa) = 'P' OR Upper(ls_tipodespa) = 'N' THEN
//		ll_result = send_mail("smtp.bbtrading.cl","<archivostembex"+ls_planta+"@RioKing.cl>",ls_correoplanta,"","",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg) 
//	ELSE
//		ll_result = send_mail("smtp.bbtrading.cl","<archivostembex"+ls_planta+"@RioKing.cl>",ls_correostembex,ls_correoplanta,"",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg)
//	END IF	
//ELSEIF ls_planta = '0003' THEN
//	IF Upper(ls_tipodespa) = 'P' OR Upper(ls_tipodespa) = 'N' THEN
//		ll_result = send_mail("smtp.RioKing.cl","<archivostembex"+ls_planta+"@RioKing.cl>",ls_correoplanta,"","",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg) 
//	ELSE
//		//ll_result = send_mail("www.cabrini.cl","<archivostembex"+ls_planta+"@rioblanco.cl>",ls_correostembex,ls_correoplanta,"",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg)
//		ll_result = send_mail("smtp.RioKing.cl","<archivostembex"+ls_planta+"@RioKing.cl>",ls_correostembex,ls_correoplanta,"",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg)
//	END IF	
//ELSE	
//	IF Upper(ls_tipodespa) = 'P' OR Upper(ls_tipodespa) = 'N' THEN
//		ll_result = send_mail("smtp.RioKing.cl","<archivostembex"+ls_planta+"@RioKing.cl>",ls_correoplanta,"","",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg)
...
ELSE
   ...
   dw_6.Sort()
	...
	FOR ll_fila = 1 TO ll_filas
		...
		ls_Registro	+=	String(dw_6.Object.cond_codigo[ll_fila],'0')//String(ii_condicion,'0')
		ls_Registro	+=	ls_Cliente
		ls_Registro	+=	String(dw_6.Object.paen_numero[ll_fila], '0000000')
...
////	END IF
	...
	ELSE	
		...
		IF Upper(ls_tipodespa) = 'M' OR Upper(ls_tipodespa) = 'A' OR Upper(ls_tipodespa) = 'T' THEN
			Open(w_mensaje)
			w_mensaje.st_1.text = " Copiando Archivo A FTP Stembex"
			w_mensaje.st_2.Text = 'Copiando......'			
			string ls_parm
			uint ll_ret
			Integer	li_FileNum
			ls_parm = ""
   	...
   	dw_7.Reset()
		...
		IF Upper(ls_tipodespa) = 'M' OR Upper(ls_tipodespa) = 'A' OR Upper(ls_tipodespa) = 'T' THEN
			//		IF ii_controlws = 1 THEN
			IF dw_1.Object.plde_codigo[1] = 1 THEN //control provisorio control real empr_wsguia en parempresa
				Open(w_mensaje)
				w_mensaje.st_1.text = "Transmisión Automática Datos Stembex"
				w_mensaje.st_2.Text = 'Transmitiendo Datos Guía'			
				carga_ws_guia()
				Close(w_mensaje)	
			END IF	
	//		END IF	
...
IF ii_controlcorreo = 0 THEN
	MESSAGEBOX("ATENCION","ARCHIVO STEMBEX ENVIADO A OFICINA CENTRAL")
ELSEIF ii_controlcorreo = 1 THEN
	MESSAGEBOX("ATENCION","ENVIE ARCHIVO DE FORMA MANUAL")
END IF	
end subroutine

protected function integer despacho (integer li_cliente, integer li_planta, long ll_guia);Long ll_numero
Integer li_contador
Datetime    ldt_hora, ld_fecha, ld_hora
...
public function boolean carga_ws_guia ();String	ls_Patente, ls_termog
Long		ll_filas, ll_Error=0, ll_rc, ll_fila, li_returnValue
Integer	li_copallet

funcionesguiasservice 	lnv_wsguias
...
istr_cabeceraguia = Create cabeceraguia

ll_rc = conn.CreateInstance(lnv_wsguias,"funcionesguiasservice","http://190.2.248.51/ws-stephens/Guias")
...
TRY
	FOR ll_fila = 1 TO dw_6.RowCount()
		...
		istr_cabeceraguia.instEmbarque 			= String(dw_6.Object.embq_codigo[ll_fila])
		istr_cabeceraguia.numGuia					= Long(dw_6.Object.defe_guides[ll_fila])
		istr_cabeceraguia.codRecibidor			= dw_6.Object.reci_codigo[ll_fila]
		istr_cabeceraguia.codPlanta				= dw_6.Object.plde_codigo[ll_fila]
		istr_cabeceraguia.patTransporte			= ls_Patente
		istr_cabeceraguia.codEspecie				= dw_6.Object.espe_codigo[ll_fila]
		istr_cabeceraguia.condFumi				   = String(ii_condicion,'0')
		istr_cabeceraguia.numPallet				= String(dw_6.Object.paen_numero[ll_fila])
		istr_cabeceraguia.codEtiq					= dw_6.Object.etiq_codigo[ll_fila]
		istr_cabeceraguia.fhEmbalaje				= String(dw_6.Object.paen_fecemb[ll_fila], 'ddmmyy')
		istr_cabeceraguia.codProductor			= dw_6.Object.prod_codigo[ll_fila]
		istr_cabeceraguia.codEmbalaje          = String(dw_6.Object.emba_codigo[ll_fila])
		istr_cabeceraguia.codVariedad			   = dw_6.Object.vari_codigo[ll_fila]
		istr_cabeceraguia.calibre					= String(dw_6.Object.pafr_calibr[ll_fila])
		istr_cabeceraguia.cantCajas				= Long(dw_6.Object.pafr_ccajas[ll_fila])
		istr_cabeceraguia.categoria				= String(dw_6.Object.cate_codigo[ll_fila])
		istr_cabeceraguia.tipoCamion				= String(dw_6.Object.tica_codigo[ll_fila])
		istr_cabeceraguia.codPuertoEmbarque    = dw_6.Object.embq_ptoori[ll_fila]
		istr_cabeceraguia.codPack					= dw_6.Object.packing[ll_fila]
		istr_cabeceraguia.numTermografo			= ls_termog
		istr_cabeceraguia.codPallet				= li_copallet
		istr_cabeceraguia.codInsp					= String(dw_6.Object.paen_inspec[ll_fila])
		istr_cabeceraguia.actPallet				= 'A'
		istr_cabeceraguia.numContenedor  		= String(dw_6.Object.defe_nrcont[ll_fila])
		istr_cabeceraguia.sellos					= '1212'//String(dw_6.Object.listasellos[ll_fila])
		istr_cabeceraguia.chofer					= dw_6.Object.defe_chofer[ll_fila]
		istr_cabeceraguia.celular					= '1212'//dw_6.Object.defe_celcho[ll_fila]
		istr_cabeceraguia.acoplado				   = dw_6.Object.defe_pataco[ll_fila]
		istr_cabeceraguia.hsPartida				= Integer(dw_6.Object.hora[ll_fila])
		istr_cabeceraguia.minPartida				= Integer(dw_6.Object.minutos[ll_fila])
		istr_cabeceraguia.codPuertoDestino		= dw_6.Object.puer_codigo[ll_fila]
		istr_cabeceraguia.idUsuario				= gstr_us.Nombre
		istr_cabeceraguia.nomEquipo				= gstr_us.Computador
		istr_cabeceraguia.hsFecha					= String(string(today(),'yymmdd') +'-'+ String(now(),'hhmm'))
		
		response = lnv_wsguias.insertarcabeceraguia(istr_cabeceraguia)
//		IF IsNull(response) THEN
//			MessageBox("No hay respuesta", "")
//		ELSEIF UpperBound(response) = 0 then
//			MessageBox("No hay respuesta", "")
//		END IF 
...
public function boolean busca_parametro ();SELECT isnull(empr_wsguia,0) 
INTO :ii_controlws
FROM dba.parempresa;

IF sqlca.SQLCode = -1 THEN
	F_ErrorBaseDatos(sqlca,"Lectura de la Tabla parempresa")
	RETURN True
END IF
...
public subroutine enviaguiatembex ();String		ls_Nombre, ls_NomReporte, ls_Archivo, ls_DirectorioAct, ls_correostembex, ls_asunto, ls_texto, ls_ErrorMsg 
Long			ll_Fila, ll_consignatario, ll_Archivo, ll_result, ll_nroguia
Boolean		lb_Existe
Integer		li_imprimio, li_planta, li_cliente
String		ls_planta, ls_correoplanta, ls_tipodespa,ls_correoaereo,ls_correoterrestre,ls_correomaritimo
str_parms	lstr_parms
...
ls_asunto	 = "Envío Guia Despacho "+String(ll_nroguia)+', Embarque '+is_embarque+', Nave '+is_nave

ls_texto		 =	 'Guía Despacho '+String(ll_nroguia)+' con fecha ' + String(Today(),'dd/mm/yyyy')+' Planta ' +String(li_planta)+'.' 

//IF ls_planta = '0002' OR ls_planta = '0004' THEN
//	IF Upper(ls_tipodespa) = 'P' OR Upper(ls_tipodespa) = 'N' THEN
//		ll_result = send_mail("smtp.bbtrading.cl","<Guiastembex"+ls_planta+"@RioKing.cl>",ls_correoplanta,"","",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg) 
//	ELSE
//		ll_result = send_mail("smtp.bbtrading.cl","<Guiastembex"+ls_planta+"@RioKing.cl>",ls_correostembex,ls_correoplanta,"",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg)
//	END IF	
//ELSEIF ls_planta = '0003' THEN
//	IF Upper(ls_tipodespa) = 'P' OR Upper(ls_tipodespa) = 'N' THEN
//		ll_result = send_mail("smtp.bbtrading.cl","<Guiastembex"+ls_planta+"@RioKing.cl>",ls_correoplanta,"","",ls_asunto,ls_texto,lstr_parms.string_arg[ll_Archivo+3],ls_ErrorMsg) 
...
on w_info_guia_despacho_archivo.create
int iCurrent
call super::create
...
this.Control[iCurrent+66]=this.pb_imprime
end on

on w_info_guia_despacho_archivo.destroy
call super::destroy
destroy(this.st_1)
destroy(this.st_2)
destroy(this.dw_2)
...
type pb_excel from w_para_informes`pb_excel within w_info_guia_despacho_archivo
end type

type st_computador from w_para_informes`st_computador within w_info_guia_despacho_archivo
integer x = 1705
integer width = 1088
end type

type st_usuario from w_para_informes`st_usuario within w_info_guia_despacho_archivo
integer x = 1705
integer width = 1088
end type

type st_temporada from w_para_informes`st_temporada within w_info_guia_despacho_archivo
integer x = 1705
integer width = 1088
end type

type p_logo from w_para_informes`p_logo within w_info_guia_despacho_archivo
end type

type st_titulo from w_para_informes`st_titulo within w_info_guia_despacho_archivo
integer y = 248
integer width = 2107
string text = "Emisión Guia de Despacho"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_guia_despacho_archivo
event ue_imprimir ( )
integer x = 2501
integer y = 1832
...
IF ii_tipo	=	1 THEN
	...
	IF validadespacho(Integer(istr_mant.argumento[1]),Integer(istr_mant.argumento[2]),Long(em_nroguia.Text)) THEN
		Return
	END IF
		...
		IF ii_tipo = 1 THEN
			...
			ELSEIF fila > 0 THEN
				...
				IF gs_Ambiente <> 'Windows' THEN
					F_ImprimeInformePdf(vinf1.dw_1, istr_info.titulo)
				END IF
	...
	IF ii_tipo = 1 THEN
		IF li_cliente <> 590  THEN
			...
			ELSE
				vinf2.dw_1.DataObject	= ls_FtoGuiaDespa
				dw_guia.DataObject	= ls_FtoGuiaDespa		
			END IF
		ELSE	
			IF ls_FtoGuiaDespa = '' THEN
				vinf2.dw_1.DataObject = 'dw_info_guia_despacho_lirios'
	...
	fila = vinf2.dw_1.Retrieve(li_cliente, li_planta, ll_nroguia,Integer(istr_mant.argumento[25]),ii_var, ii_prod, ii_cal,li_vari,li_emba,li_calib,li_control)
	...
	IF cbx_9.Checked THEN
		vinf2.dw_1.Modify("DataWindow.Summary.Height.AutoSize")
	ELSE	
		vinf2.dw_1.Modify("DataWindow.Summary.Height = 72")
	END IF	
	 
	/*
  Estado de impresion de guia
  */
  UPDATE dba.despafrigoguias SET
    degd_estado = 1
    WHERE clie_codigo = :li_cliente
    AND plde_codigo   = :li_planta
    AND defe_numero   = :il_despacho
...
//		IF Upper(ls_parteemb) <> Upper('M')   THEN
//			generaarchivo()
		IF (ii_tipoemb = 7 OR ii_tipoemb = 8 OR ii_tipoemb = 9) and li_cliente = gi_Cliebase THEN	
			IF ii_controlstembex = 0 THEN	
				generaarchivostembex()
			END IF	
		END IF	
//		END IF	
	...
	IF ii_tipo	=	1 THEN
		...
		vinf2.dw_1.SaveAs(gs_disco+":\GeneradosSAAM\"+'GD' +String(li_cliente)+''+String(li_planta)+''+String(ll_nroguia)+'.PDF', PDF!, TRUE)
		is_archivoguias = gs_disco+":\GeneradosSAAM\"+'GD' +String(li_cliente)+''+String(li_planta)+''+String(ll_nroguia)
		IF 1 = 1 THEN
			enviaguiatembex()
		END IF
		...
		IF li_planta = 81 THEN
			vinf2.dw_1.Modify("t_glosa.text = '" + em_glosaespecial.Text + "'")
		END IF	
		
		IF li_cliente = 590 THEN
			vinf2.dw_1.Modify("t_tipomv.text = '" + em_tipomv.Text + "'")
			vinf2.dw_1.Modify("t_nomrespon.text = '" + em_nomdespachador.Text + "'")
			vinf2.dw_1.Modify("t_puerto.text = '" + em_puerto.Text + "'")
			vinf2.dw_1.Modify("t_destino.text = '" + em_destino.Text + "'")
		END IF	
	END IF
...
type pb_salir from w_para_informes`pb_salir within w_info_guia_despacho_archivo
integer x = 2505
integer y = 2104
...
IF ii_tipo	=	1 THEN
	...
	fila = vinf1.dw_1.Retrieve(li_cliente, li_planta, ll_nroguia,Integer(istr_mant.argumento[25]),ii_var, ii_prod, ii_cal,li_vari,li_emba,li_calib,li_control)
