$PBExportHeader$w_mant_selecdestinos.srw
forward
global type w_mant_selecdestinos from w_mant_encab_deta
end type
type cb_2 from uo_cbstandard within w_mant_selecdestinos
end type
type cb_3 from uo_cbstandard within w_mant_selecdestinos
end type
type cb_4 from uo_cbstandard within w_mant_selecdestinos
end type
type dw_enca from uo_dw within w_mant_selecdestinos
end type
type dw_pallets from uo_dw within w_mant_selecdestinos
end type
type cb_agrega from uo_cbstandard within w_mant_selecdestinos
end type
type cb_elimina from uo_cbstandard within w_mant_selecdestinos
end type
type dw_5 from datawindow within w_mant_selecdestinos
end type
type dw_6 from uo_dw within w_mant_selecdestinos
end type
type dw_4 from uo_dw within w_mant_selecdestinos
end type
type dw_3 from uo_dw within w_mant_selecdestinos
end type
end forward
...
integer width = 4494
integer height = 2292
string title = "SELECCION DE PALLETS A DESPACHAR"
...
global w_mant_selecdestinos w_mant_selecdestinos
...
public function boolean existerecibidor (long ai_recibidor)
end prototypes
...
FOR ll_fila = 1 TO dw_pallets.RowCount() 
	...
	DELETE FROM dbo.despadestisele
...
public function boolean existerecibidor (long ai_recibidor);Integer li_cont
String	ls_nombre
...
on w_mant_selecdestinos.create
int iCurrent
call super::create
...
on w_mant_selecdestinos.destroy
call super::destroy
...
dw_4.y			= dw_pallets.y
dw_4.Width		= dw_1.Width - dw_4.x + 20
...
cb_2.y	= pb_salir.y + pb_Salir.Height + 20
cb_3.y	= cb_2.y + cb_2.Height + 10
cb_4.y	= cb_3.y + cb_3.Height + 10
end event
...
event ue_seleccion;call super::ue_seleccion;istr_busq.argum[1]	=	String(dw_enca.Object.clie_codigo[1]) 
...
IF istr_busq.argum[5] <> "" THEN	
	...
	dw_enca.Object.Clie_codigo[1] = Long(istr_busq.argum[6])
	dw_enca.Object.plde_codigo[1] = Long(istr_busq.argum[7])
	
	IF ExisteDespa(ii_dese_numero, Long(istr_busq.argum[6]), Long(istr_busq.argum[7])) THEN
...
If ii_tipo = 2 Then
	dw_enca.Object.embq_codigo.Protect	= 1
	dw_enca.Object.embq_codigo.Color		= RGB(255,255,255)
	dw_enca.Object.embq_codigo.BackGround.Color = 553648127
...
dw_enca.Object.dese_numero.Protect = 0

If ii_tipo = 1 Then
	dw_enca.Object.embq_codigo.Protect = 0
	dw_enca.Object.b_embq.Enabled = True
End If	

dw_enca.Object.clie_codigo.Protect = 0
dw_enca.Object.plde_codigo.Protect = 0
dw_enca.Object.dese_fecsel.Protect = 0
dw_enca.Object.dese_respon.Protect = 0
dw_enca.Object.dest_codig1.Protect = 0
//dw_enca.Object.dest_recibi.Protect = 0
dw_enca.Object.recibidor.Protect = 0
dw_enca.Object.todos.Protect = 0

dw_enca.Object.dese_numero.Color = 0
dw_enca.Object.dese_numero.BackGround.Color = RGB(255,255,255)

If ii_tipo = 1 Then
	dw_enca.Object.embq_codigo.Color = 0
	dw_enca.Object.embq_codigo.BackGround.Color = RGB(255,255,255)
	dw_enca.Object.b_embq.Enabled = True
End If	

dw_enca.Object.clie_codigo.BackGround.Color = 0
dw_enca.Object.plde_codigo.BackGround.Color = 0
dw_enca.Object.dese_fecsel.BackGround.Color = 0
dw_enca.Object.recibidor.BackGround.Color = RGB(255,255,255)
dw_enca.Object.dest_codig1.BackGround.Color = 0
dw_enca.Object.dese_respon.BackGround.Color = 0

dw_enca.Object.clie_codigo.BackGround.Color = RGB(255,255,255)
dw_enca.Object.plde_codigo.BackGround.Color = RGB(255,255,255)
dw_enca.Object.dese_fecsel.BackGround.Color = RGB(255,255,255)
dw_enca.Object.recibidor.BackGround.Color = 553648127
dw_enca.Object.dest_codig1.BackGround.Color = RGB(255,255,255)
dw_enca.Object.dese_respon.BackGround.Color = RGB(255,255,255)


dw_enca.Object.recibidor.Protect = 1
dw_enca.Object.recibidor.Color = RGB(255,255,255)
dw_enca.Object.recibidor.BackGround.Color = 553648127
...
//		dw_enca.Object.dest_recibi.Protect = 1
		dw_enca.Object.dest_codig1.Protect = 1
		dw_enca.Object.todos.Protect = 1
...
//		dw_enca.Object.dest_recibi.Color 		= RGB(255,255,255)
		dw_enca.Object.dest_codig1.Color 	= RGB(255,255,255)
...
//		dw_enca.Object.dest_recibi.BackGround.Color 		= 553648127
		dw_enca.Object.dest_codig1.BackGround.Color		= 553648127
...
type dw_1 from w_mant_encab_deta`dw_1 within w_mant_selecdestinos
integer x = 50
integer y = 644
integer width = 3205
integer height = 484
...
string dataobject = "dw_mant_despadestideta"
...
type dw_2 from w_mant_encab_deta`dw_2 within w_mant_selecdestinos
integer x = 160
integer y = 516
integer width = 3205
integer height = 120
...
type pb_nuevo from w_mant_encab_deta`pb_nuevo within w_mant_selecdestinos
integer x = 4037
integer y = 280
integer taborder = 120
end type

type pb_eliminar from w_mant_encab_deta`pb_eliminar within w_mant_selecdestinos
integer x = 4037
integer y = 460
...
ll_dese_numero = dw_enca.Object.dese_numero[1]
DECLARE limpia PROCEDURE FOR dbo.sp_limpia_tabla_despadesti
...
type pb_grabar from w_mant_encab_deta`pb_grabar within w_mant_selecdestinos
integer x = 4037
integer y = 648
...
type pb_imprimir from w_mant_encab_deta`pb_imprimir within w_mant_selecdestinos
integer x = 4037
integer y = 820
integer taborder = 150
end type

type pb_salir from w_mant_encab_deta`pb_salir within w_mant_selecdestinos
integer x = 4037
integer y = 1000
integer taborder = 160
end type

type pb_ins_det from w_mant_encab_deta`pb_ins_det within w_mant_selecdestinos
integer x = 4041
...
type pb_eli_det from w_mant_encab_deta`pb_eli_det within w_mant_selecdestinos
integer x = 4041
integer y = 1452
...
type pb_buscar from w_mant_encab_deta`pb_buscar within w_mant_selecdestinos
integer x = 4037
integer y = 96
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "dw_mant_despadesticenca"
	...
	Case "b_embq"
		...
		Else	
			If dw_4.RowCount() = 0 Then
				istr_busq.argum[5] =  String(BuscaNuevoFolio(This.Object.plde_codigo[1]))
				...
				This.Object.dese_numero[row] = Long(istr_busq.argum[5])
...
//				pb_eli_det.Enabled = False
	...
	Case "todos"	
		...
		ElseIf data = '0'Then
			dw_enca.Object.recibidor.Protect =	0
			dw_enca.Object.recibidor.Color 	= 0
			dw_enca.Object.recibidor.BackGround.Color = Rgb(255,255,255)
...
string title = "Pallets Seleccion"
