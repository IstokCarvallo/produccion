$PBExportHeader$w_informes_guia_archivo.srw
forward
global type w_informes_guia_archivo from window
end type
type pb_salir from picturebutton within w_informes_guia_archivo
end type
type pb_imprimir from picturebutton within w_informes_guia_archivo
end type
type dw_herr from datawindow within w_informes_guia_archivo
end type
type dw_barra from datawindow within w_informes_guia_archivo
end type
type dw_1 from datawindow within w_informes_guia_archivo
end type
type gb_1  from groupbox  within w_informes_guia_archivo
end type
type gb_2 from groupbox within w_informes_guia_archivo
end type
type gb_3 from groupbox within w_informes_guia_archivo
end type
type gb_4 from groupbox within w_informes_guia_archivo
end type
type gb_5 from groupbox within w_informes_guia_archivo
end type
type gb_6 from groupbox within w_informes_guia_archivo
end type
type wstr_ano_benef from structure within w_informes_guia_archivo
end type
end forward
...
global w_informes_guia_archivo w_informes_guia_archivo
...
on w_informes_guia_archivo.create
...
on w_informes_guia_archivo.destroy
...
CHOOSE CASE  ls_columna
	CASE "p_imprime"
		...
		OpenWithParm (w_imprimir, lstr_mant)
		
		li_retorno 	= 	message.DoubleParm
		
		IF IsNull ( li_retorno )  OR li_retorno = 1 THEN
			li_retorno = 0  
			Close(Parent)
		END IF
		
		IF li_retorno < 0 THEN
			MessageBox ( "ATENCION", "Problemas con su Impresora",StopSign! )
			Close(Parent)
		END IF
