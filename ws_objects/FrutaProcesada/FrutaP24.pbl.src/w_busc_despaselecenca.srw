$PBExportHeader$w_busc_despaselecenca.srw
forward
global type w_busc_despaselecenca from w_busqueda
end type
...
global w_busc_despaselecenca w_busc_despaselecenca
...
on w_busc_despaselecenca.create
int iCurrent
call super::create
end on

on w_busc_despaselecenca.destroy
call super::destroy
end on
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_despaselecenca
...
type dw_1 from w_busqueda`dw_1 within w_busc_despaselecenca
integer x = 37
integer y = 768
integer width = 2811
integer taborder = 60
string dataobject = "dw_busca_despaselecenca"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_despaselecenca
integer x = 2994
integer y = 904
...
type tab_1 from w_busqueda`tab_1 within w_busc_despaselecenca
integer x = 37
integer y = 92
end type
