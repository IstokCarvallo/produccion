$PBExportHeader$w_busc_secuencia_destino.srw
forward
global type w_busc_secuencia_destino from w_busqueda
end type
...
integer width = 2766
integer height = 1808
string title = "Búsqueda Secuencia Destino"
end type
global w_busc_secuencia_destino w_busc_secuencia_destino
...
on w_busc_secuencia_destino.create
int iCurrent
call super::create
end on

on w_busc_secuencia_destino.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[10] = '1'
istr_busq.argum[13]	= String(dw_1.GetItemNumber(dw_1.GetRow(),"dsag_secuen"))
istr_busq.argum[14]	= dw_1.GetItemString(dw_1.GetRow(),"compute_1")
...
IF dw_1.Retrieve(Integer(istr_busq.argum[11]),Integer(istr_busq.argum[12])) > 0 THEN
END IF	
end event
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_secuencia_destino
...
type dw_1 from w_busqueda`dw_1 within w_busc_secuencia_destino
integer x = 37
integer y = 656
integer width = 2309
integer height = 952
integer taborder = 60
string dataobject = "dw_mues_destinosag_nuevo"
end type
...
type pb_salir from w_busqueda`pb_salir within w_busc_secuencia_destino
integer x = 2400
integer y = 968
alignment htextalign = center!
end type

event pb_salir::clicked;istr_busq.argum[10] = ""
CloseWithReturn(Parent,istr_busq)
end event

type tab_1 from w_busqueda`tab_1 within w_busc_secuencia_destino
integer x = 37
integer y = 32
integer width = 2304
integer height = 640
