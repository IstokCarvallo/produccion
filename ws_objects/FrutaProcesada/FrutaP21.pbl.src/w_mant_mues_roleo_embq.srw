$PBExportHeader$w_mant_mues_roleo_embq.srw
$PBExportComments$Mantenedor de Técnicos
forward
global type w_mant_mues_roleo_embq from w_mant_tabla
end type
type uo_selplanta from uo_seleccion_plantas within w_mant_mues_roleo_embq
end type
type uo_selcliente from uo_seleccion_clientesprod within w_mant_mues_roleo_embq
end type
type st_3 from statictext within w_mant_mues_roleo_embq
end type
type st_7 from statictext within w_mant_mues_roleo_embq
end type
type st_8 from statictext within w_mant_mues_roleo_embq
end type
type em_guia from editmask within w_mant_mues_roleo_embq
end type
type cbx_guia from checkbox within w_mant_mues_roleo_embq
end type
type st_2 from statictext within w_mant_mues_roleo_embq
end type
type em_desde from editmask within w_mant_mues_roleo_embq
end type
type cbx_fecha from checkbox within w_mant_mues_roleo_embq
end type
type st_1 from statictext within w_mant_mues_roleo_embq
end type
type em_numero from editmask within w_mant_mues_roleo_embq
end type
type cbx_numero from checkbox within w_mant_mues_roleo_embq
end type
type cb_numero from commandbutton within w_mant_mues_roleo_embq
end type
end forward
...
global w_mant_mues_roleo_embq w_mant_mues_roleo_embq
...
on w_mant_mues_roleo_embq.create
int iCurrent
call super::create
...
on w_mant_mues_roleo_embq.destroy
call super::destroy
...
DO	
	ll_fila	=	dw_1.Retrieve(uo_SelPlanta.Codigo, uo_SelCliente.Codigo, ll_Folio, ld_Fecha, ll_Guia)
...
type dw_1 from w_mant_tabla`dw_1 within w_mant_mues_roleo_embq
integer x = 73
integer y = 604
integer width = 2190
integer height = 1116
integer taborder = 40
string dataobject = "dw_mant_mues_roleo_embq"
...
Choose Case ls_Columna
	Case "embq_codigo"
		If Not iuo_Embarques.Existe(Data, True, SQLCA) Then
...
event dw_1::buttonclicked;call super::buttonclicked;String				ls_Boton, ls_Null
...
Choose Case ls_Boton
	Case "b_embarque"
		...
		IF istr_busq.argum[2] <> "" THEN
			This.SetItem(il_fila, "embq_codigo", istr_busq.argum[1])
		ELSE
			This.SetColumn("embq_codigo")
			This.SetFocus()
		END IF
...
type st_encabe from w_mant_tabla`st_encabe within w_mant_mues_roleo_embq
integer x = 73
integer width = 2190
integer height = 516
end type

type pb_lectura from w_mant_tabla`pb_lectura within w_mant_mues_roleo_embq
integer x = 2450
integer taborder = 20
end type

type pb_nuevo from w_mant_tabla`pb_nuevo within w_mant_mues_roleo_embq
integer x = 2446
integer taborder = 70
end type
...
type pb_insertar from w_mant_tabla`pb_insertar within w_mant_mues_roleo_embq
boolean visible = false
integer x = 2446
integer taborder = 30
end type

type pb_eliminar from w_mant_tabla`pb_eliminar within w_mant_mues_roleo_embq
boolean visible = false
integer x = 2446
integer taborder = 80
end type

type pb_grabar from w_mant_tabla`pb_grabar within w_mant_mues_roleo_embq
integer x = 2446
integer taborder = 50
end type

type pb_imprimir from w_mant_tabla`pb_imprimir within w_mant_mues_roleo_embq
boolean visible = false
integer x = 2446
integer taborder = 60
end type

type pb_salir from w_mant_tabla`pb_salir within w_mant_mues_roleo_embq
integer x = 2437
integer taborder = 90
end type
...
OpenWithParm(w_busc_despafrigoen, istr_busq)

istr_busq	       = Message.PowerObjectParm

If UpperBound(istr_busq.Argum) > 7 Then
