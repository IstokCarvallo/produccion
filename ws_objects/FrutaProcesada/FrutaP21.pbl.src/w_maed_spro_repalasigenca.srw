...
type dw_7 from datawindow within w_maed_spro_repalasigenca
end type
type dw_8 from datawindow within w_maed_spro_repalasigenca
end type
type dw_9 from uo_dw within w_maed_spro_repalasigenca
end type
type dw_10 from uo_dw within w_maed_spro_repalasigenca
end type
type ids_cuadracajas from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletencabhisto from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletfrutahisto from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletfrutanuevo from datawindow within w_maed_spro_repalasigenca
end type
type dw_5 from uo_dw within w_maed_spro_repalasigenca
end type
type ids_palletencabupdate from datawindow within w_maed_spro_repalasigenca
end type
type ids_alpalletfruta from datawindow within w_maed_spro_repalasigenca
end type
type ids_alpalletencab from datawindow within w_maed_spro_repalasigenca
end type
type ids_inspecpaldet from datawindow within w_maed_spro_repalasigenca
end type
type ids_despafrigoen from datawindow within w_maed_spro_repalasigenca
end type
type ids_despafrigodet from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletencabhisto_des from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletfrutahisto_des from datawindow within w_maed_spro_repalasigenca
end type
type ids_recepcionenca from datawindow within w_maed_spro_repalasigenca
end type
type ids_recepciondeta from datawindow within w_maed_spro_repalasigenca
end type
type ids_palletencabnuevo from datawindow within w_maed_spro_repalasigenca
end type
type pb_recupera from picturebutton within w_maed_spro_repalasigenca
end type
type dw_compacto from datawindow within w_maed_spro_repalasigenca
end type
type dw_3 from uo_dw within w_maed_spro_repalasigenca
end type
type dw_6 from uo_dw within w_maed_spro_repalasigenca
end type
type dw_spro_cajasprod from datawindow within w_maed_spro_repalasigenca
end type
type dw_11 from datawindow within w_maed_spro_repalasigenca
end type
type dw_12 from datawindow within w_maed_spro_repalasigenca
end type
end forward
...
Long							il_numero, il_count, il_existe, il_pallet, ii_nuinpe, il_NroCaja, &
								il_cambiafila, il_palcompac, il_caja
Date							id_fechai			

//DataStore ids_palletencabhisto
//DataStore ids_palletfrutahisto
//DataStore ids_alpalletfruta
//DataStore ids_alpalletencab
//DataStore ids_palletencabupdate

//DataStore ids_cuadracajas
//DataStore ids_palletencabnuevo
//DataStore ids_palletfrutanuevo

//DataStore ids_inspecpaldet
//DataStore ids_despafrigoen
//DataStore ids_despafrigodet
//DataStore ids_recepcionenca
//DataStore ids_recepciondeta
//DataStore ids_palletencabhisto_des
//DataStore ids_palletfrutahisto_des
end variables
	...
	ELSE
		DO
			...
			IF dw_4.Retrieve(Integer(istr_Mant.Argumento[1]), &
						  Integer(istr_Mant.Argumento[2]), &
						  Long(istr_Mant.Argumento[4]),li_tipopal) = -1 THEN
				respuesta = MessageBox(	"Error en Base de Datos", "No es posible conectar la Base de Datos.", &
												Information!, RetryCancel!)
			ELSE
...
ELSE
	...
	dw_2.Object.repe_fecrep.BackGround.Color = RGB(166,180,210)
	dw_2.Object.repe_respon.Protect	=	1
	dw_2.Object.repe_respon.BackGround.Color = RGB(166,180,210)
	dw_2.Object.repe_tipopa.Protect	=	1
	dw_2.Object.repe_tipopa.BackGround.Color = RGB(166,180,210)
	dw_2.Object.repe_lugarp.Protect	=	1
	dw_2.Object.repe_lugarp.BackGround.Color = RGB(166,180,210)
	dw_2.Object.repe_observ.Protect	=	1
	dw_2.Object.repe_observ.BackGround.Color = RGB(166,180,210)
...
Integer li_Secuen, li_cliente, li_planta, li_repe_tipopa, li_fumigacion, li_condicion,li_respuesta,&
		li_condicion_ori, li_condicion_des
	...
	//ELSE
		...
		IF ll_caja_traspa	> 0 THEN
         ...
         dw_4.Object.pafr_cuart1[ll_Nuevo]	=	dw_6.Object.pafr_cuart1[ll_Fila]
			...
			IF li_repe_tipopa = 1 OR li_repe_tipopa = 2  THEN
...
Integer	li_especie, li_variedad, li_espe_codigo, li_paen_pmixto, li_repe_tipopa
String	ls_embalaje
...
Integer li_Secuen, li_cliente, li_planta
...
public subroutine traspasa_cajas_altura (integer tipo);Long	ll_Fila, ll_BFilaRep, ll_BFilaPD, ll_Nuevo, ll_NuevoDet, ll_fila1, ll_nuevo1, ll_find, ll_fila10,&
	ll_pallet, ll_fil, ll_caja_traspa, ll_nuevo1act, ll_prodrot, ll_predrot, ll_cuarrot, ll_rotpak
Integer li_Secuen, fila_find, li_cliente, li_planta, li_inspeccion, li_inspecnuevo, li_tipopa, li_tiporepa
...
FOR ll_fila = 1 TO dw_6.Rowcount() 
	...
	IF ll_caja_traspa > 0 THEN
		...
		ELSE	
			IF li_cliente = gi_Cliebase THEN
...
FOR ll_fila1 = 1 TO dw_3.RowCount()
	...
	IF fila_find = 0 THEN
		IF il_cantidad = 0 THEN
			...
			ids_palletencabnuevo.Object.paen_ccajas[ll_nuevo1] =   dw_6.Object.total_traspa[1]
		...
		ELSE
			...
			ids_palletencabupdate.Object.paen_ccajas[ll_nuevo1] =   dw_3.Object.paen_ccajas[ll_fila1] + dw_6.Object.total_traspa[1]
...
IF li_count = 0 THEN
	INSERT INTO dba.camarasbode(plde_codigo,cama_codigo,cama_nombre,cama_cancal,cama_canbas,cama_canpos)
...
SELECT count()
	...
	WHERE clie_codigo = :li_cliente 
	AND prpr_codigo 	= :al_codigo;
		
IF sqlca.SQLCode = -1 THEN
	F_ErrorBaseDatos(sqlca, "Lectura de Tabla productoresprod")
	Return True
END IF	

IF li_count = 0 THEN
	MessageBox('Atención', 'El Productor Rotulado no Existe en tabla ProductoresProd.')
	Return True	
END IF
...
this.Control[iCurrent+5]=this.pb_acepta
this.Control[iCurrent+7]=this.dw_4
this.Control[iCurrent+8]=this.pb_cancela
...
this.Control[iCurrent+13]=this.ids_cuadracajas
this.Control[iCurrent+14]=this.ids_palletencabhisto
this.Control[iCurrent+15]=this.ids_palletfrutahisto
this.Control[iCurrent+16]=this.ids_palletfrutanuevo
this.Control[iCurrent+17]=this.dw_5
this.Control[iCurrent+18]=this.ids_palletencabupdate
this.Control[iCurrent+19]=this.ids_alpalletfruta
this.Control[iCurrent+20]=this.ids_alpalletencab
this.Control[iCurrent+21]=this.ids_inspecpaldet
this.Control[iCurrent+22]=this.ids_despafrigoen
this.Control[iCurrent+23]=this.ids_despafrigodet
this.Control[iCurrent+24]=this.ids_palletencabhisto_des
this.Control[iCurrent+25]=this.ids_palletfrutahisto_des
this.Control[iCurrent+26]=this.ids_recepcionenca
this.Control[iCurrent+27]=this.ids_recepciondeta
this.Control[iCurrent+29]=this.ids_palletencabnuevo
this.Control[iCurrent+30]=this.pb_recupera
this.Control[iCurrent+31]=this.dw_compacto
this.Control[iCurrent+33]=this.dw_3
this.Control[iCurrent+34]=this.dw_6
this.Control[iCurrent+35]=this.dw_spro_cajasprod
this.Control[iCurrent+36]=this.dw_11
this.Control[iCurrent+37]=this.dw_12
end on
...
dw_3.Object.paen_tipopa.BackGround.Color = RGB(166,180,210)
dw_3.Object.tpem_codigo.Protect	=	1
dw_3.Object.tpem_codigo.BackGround.Color = RGB(166,180,210)

dw_3.Object.fumi_numero[1] = 0

dw_5.Object.paen_numero.Protect	=	1
dw_5.Object.paen_numero.BackGround.Color = RGB(166,180,210)
dw_5.Object.paen_tipopa.Protect	=	1
dw_5.Object.paen_tipopa.BackGround.Color = RGB(166,180,210)
dw_5.Object.tpem_codigo.Protect	=	1
dw_5.Object.tpem_codigo.BackGround.Color = RGB(166,180,210)
...
IF maximo > 4000 THEN
	ids_palletencabnuevo.Visible = True
ELSE
	ids_palletencabnuevo.Visible = False
END IF
...
boolean enabled = false
string picturename = "\Desarrollo 12\Imagenes\Botones\ReglaEnab.png"
string disabledname = "\Desarrollo 12\Imagenes\Botones\ReglaDisab.png"
...
event clicked;Integer	li_Certifica, li_cliente, li_planta, li_repe_tipopa, li_paen_tipopa, li_inspecnuevo,&
			...
			li_fumigacion, li_condicion, li_respuesta, li_condicion_ori, li_condicion_des
String	ls_Tipopa, ls_tpem_codigo, ls_alturaori
Long		ll_Cajas, ll_NumeroRepal, ll_pallet, ll_paen_numero,ll_total_traspa, ll_total_cajas, &
			ll_numpro,ll_fila1, ll_nuevo1, fila_find, ll_numeroPall, contador, ll_coninpe, ll_numimpe
...
IF li_condicion_ori <> li_condicion_des THEN
	li_respuesta = MessageBox("Advertencia", "Esta Mezclando Condiciones, Desea Continuar",&
	Exclamation!, YesNo!, 2)
...
//		SELECT max(inpe_numero) INTO ll_numimpe
//			INTO :contador
		...
		IF Contador = 0 THEN
			...
			IF fila_find = 0 THEN
				...
				IF ll_coninpe = 0 OR isnull(ll_coninpe) THEN
					INSERT INTO dba.inspecpalenc(inpe_tipoin,inpe_numero,clie_codigo,plde_codigo,inpe_secuen,   
						dest_codigo,inpe_fechai,espe_codigo,vari_codigo,emba_codigo,   
						tpem_codigo,inpe_todpal,inpe_calibr,inpe_solnom,inpe_fecini,   
						inpe_fecter,inpe_proces,inpe_estado,tran_fechat)
...
IF li_repe_tipopa = 7 THEN  
	...
	dw_4.Object.vari_codigo.Protect	=	0
ELSE
	dw_4.Object.pafr_calibr.Protect	=	1
	dw_4.Object.emba_codigo.Protect	=	1	
	dw_4.Object.pafr_ccajas.Protect	=	1
	dw_4.Object.vari_codigo.Protect	=	1
END IF
...
event itemchanged;String	ls_Columna, ls_Null, ls_Fecha, ls_Estado[3] = {'Existencia','Despachado','Repalletizado'},&
			ls_embalaje
Boolean  lb_detalle
integer 	li_cliente, li_planta, li_paen_tipopa, li_tiporepa
Long		ll_NumeroRepal, ll_paen_numero, ll_repe_nrosag
	...
	CASE "paen_numero"
		...
		ELSE
			...
			IF ExistePallet(Long(istr_Mant.Argumento[5]),TRUE) THEN
				...
				IF il_caja > 999 THEN
					MessageBox("Atención", "Pallet Pertenece a Ingreso Caja a Caja")
					This.SetItem(Row, ls_Columna, Long(ls_Null))
					Return 1
				END IF	
				...
				ELSEIF Atributos_Pallet() THEN
					...
					This.Object.paen_numero.BackGround.Color = RGB(166,180,210)
...
event clicked;call super::clicked;Long	ll_null
...
CHOOSE CASE dwo.name
	...
	CASE "buscapallet"
		...
		existedetallepallet(Long(istr_Mant.Argumento[5]))
...
IF ll_cont = 0 THEN
	...
	IF li_Reimprime = 1 THEN
		...
		FOR ll_fill = 1 TO ll_Fila1
			...
			dw_compacto.Object.Ole_1.Object.BarCode	=	Integer(dw_11.Object.clie_codbar[1])
...
long		ll_NumeroRepal, ll_paen_numero, ll_repe_nrosag, ll_numero
...
CHOOSE CASE ls_Columna
	...
	CASE "paen_numero"
		...
		ELSE
			...
			IF ExistePallet(Long(istr_Mant.Argumento[4]),False) THEN
				...
				IF sqlca.SQLCode = -1 THEN
					F_ErrorBaseDatos(sqlca, "Lectura de Tabla inspecpaldet")
				END IF
				
				IF sqlca.SQLCode <> -1 AND sqlca.SQLCode <> 100 THEN
					dw_3.Object.nuro_inpecc[1] = ii_nuinpe
				END IF	
	...
	CASE "nuro_inpecc"
		IF datosinpeccion(Long(data)) THEN
		END IF	
...
CHOOSE CASE dwo.name
	...
	CASE "buscapallet"
		...
		existedetallepallet(Long(istr_Mant.Argumento[4]))
