$PBExportHeader$w_maed_cambiocondicion.srw
forward
global type w_maed_cambiocondicion from w_mant_encab_deta_csd
end type
type pb_caracteristicas from picturebutton within w_maed_cambiocondicion
end type
type dw_3 from datawindow within w_maed_cambiocondicion
end type
type dw_4 from datawindow within w_maed_cambiocondicion
end type
type dw_5 from datawindow within w_maed_cambiocondicion
end type
end forward
...
global w_maed_cambiocondicion w_maed_cambiocondicion

type variables
Integer	ii_nuevacond
...
ELSE
	...
	ELSE
		...
		istr_mant.argumento[9]	=	String(li_condicion)
		MessageBox("Atención","Número de Condición se encuentra en estado vigente o no existe.", Exclamation!, Ok!)
		RETURN True
	END IF
	RETURN False
END IF
...
DO
	...
	dw_4.Retrieve(Integer(istr_mant.argumento[1]), Long(istr_mant.argumento[2]),Integer(istr_mant.argumento[3]),Integer(istr_mant.argumento[9]))
	...
	ELSE
		DO
			...
			dw_5.Retrieve(Integer(istr_mant.argumento[1]), Long(istr_mant.argumento[2]), Integer(istr_mant.argumento[3]),Integer(istr_mant.argumento[9]))
			IF ll_fila_d = -1 THEN
				respuesta = MessageBox(	"Error en Base de Datos", "No es posible conectar la Base de Datos.", &
												Information!, RetryCancel!)
			ELSE
...
on w_maed_cambiocondicion.create
int iCurrent
call super::create
...
on w_maed_cambiocondicion.destroy
call super::destroy
...
IF dw_2.DeleteRow(0) = 1 THEN
		ib_borrar = False
		w_main.SetMicroHelp("Actualizando Registro...")
		IF wf_actualiza_db(True) THEN
			w_main.SetMicroHelp("Registro Actualizado...")
			This.TriggerEvent("ue_nuevo")
			
			dw_2.Object.fumi_numero[1] = dw_4.Object.fumi_numero[1]  
			dw_2.Object.clie_codigo[1] = dw_4.Object.clie_codigo[1]   
			dw_2.Object.plde_codigo[1] = dw_4.Object.plde_codigo[1]   
			dw_2.Object.fumi_fecfum[1] = dw_4.Object.fumi_fecfum[1]   
			dw_2.Object.fumi_cantar[1] = dw_4.Object.fumi_cantar[1]   
			dw_2.Object.fumi_cantcaj[1] = dw_4.Object.fumi_cantcaj[1]   
			dw_2.Object.fumi_horain[1] = dw_4.Object.fumi_horain[1]   
			dw_2.Object.cama_codigo[1] = dw_4.Object.cama_codigo[1]   
			dw_2.Object.fumi_observ[1] = dw_4.Object.fumi_observ[1]   
			dw_2.Object.merc_codigo[1] = dw_4.Object.merc_codigo[1]   
			dw_2.Object.fumi_solnom[1] = dw_4.Object.fumi_solnom[1]   
			dw_2.Object.fumi_numsag[1] = dw_4.Object.fumi_numsag[1]   
			dw_2.Object.cond_codigo[1] = Integer(ii_nuevacond)   
			dw_2.Object.dest_codigo[1] = dw_4.Object.dest_codigo[1]   
			dw_2.Object.fumi_estado[1] = 0
			
			FOR ll_fila = 1 TO dw_5.RowCount()
				ll_new = dw_1.insertRow(0)
				dw_1.Object.fumi_numero[ll_fila] = dw_5.Object.fumi_numero[ll_fila] 
				dw_1.Object.clie_codigo[ll_fila] = dw_5.Object.clie_codigo[ll_fila]   
				dw_1.Object.plde_codigo[ll_fila] = dw_5.Object.plde_codigo[ll_fila]   
				dw_1.Object.paen_numero[ll_fila] = dw_5.Object.paen_numero[ll_fila]   
				dw_1.Object.fude_certif[ll_fila] = dw_5.Object.fude_certif[ll_fila]   
				dw_1.Object.cond_codigo[ll_fila] = Integer(ii_nuevacond)   
				dw_1.Object.fumi_premue[ll_fila] = dw_5.Object.fumi_premue[ll_fila]   
				dw_1.Object.fumi_precaj[ll_fila] = dw_5.Object.fumi_precaj[ll_fila]   
				dw_1.Object.fumi_cercaj[ll_fila] = dw_5.Object.fumi_cercaj[ll_fila]  
			NEXT	
						
			SetPointer(Arrow!)
		ELSE
			w_main.SetMicroHelp("Registro no Actualizado...")
		END IF			
ELSE
	ib_borrar = False
	MessageBox(This.Title,"No se puede Actualizar actual registro.")
END IF
end event

event ue_antesguardar;call super::ue_antesguardar;dw_2.Object.fumi_Estado[1] = 0
end event

type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_cambiocondicion
integer x = 41
integer y = 948
integer width = 2962
integer height = 932
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_cambiocondicion
integer x = 32
integer y = 36
integer width = 2962
integer height = 880
string dataobject = "dw_mant_cambiocondicion"
end type
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_cambiocondicion
integer x = 3150
integer y = 284
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_cambiocondicion
boolean visible = false
integer x = 3159
integer y = 516
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_cambiocondicion
integer x = 3154
integer y = 728
end type

event pb_grabar::clicked;Long	ll_fila1, ll_fila2

Parent.TriggerEvent("ue_borrar")
Parent.TriggerEvent("ue_guardar")

ll_fila1 = dw_2.Retrieve(Integer(istr_mant.argumento[1]), Long(istr_mant.argumento[2]),Integer(istr_mant.argumento[3]),ii_nuevacond)

IF ll_fila1 > 0 THEN
	dw_1.Retrieve(Integer(istr_mant.argumento[1]), Long(istr_mant.argumento[2]), Integer(istr_mant.argumento[3]),ii_nuevacond)
END IF	

end event

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_cambiocondicion
boolean visible = false
integer x = 3150
integer y = 960
...
type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_cambiocondicion
integer x = 3150
integer y = 1188
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_cambiocondicion
boolean visible = false
integer x = 3150
integer y = 1516
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_cambiocondicion
boolean visible = false
integer x = 3150
integer y = 1692
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_cambiocondicion
integer x = 3145
integer y = 104
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "dw_mant_rechazocondicion_2"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
