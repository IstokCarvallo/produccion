$PBExportHeader$w_mant_modificafruta_prediocuartel.srw
$PBExportComments$Mantención Detalle de Pallets a Inspeccionar accesado directamente desde el Menu.
forward
global type w_mant_modificafruta_prediocuartel from w_mant_directo
end type
type st_2 from statictext within w_mant_modificafruta_prediocuartel
end type
type st_1 from statictext within w_mant_modificafruta_prediocuartel
end type
type em_numero from editmask within w_mant_modificafruta_prediocuartel
end type
type st_3 from statictext within w_mant_modificafruta_prediocuartel
end type
type dw_3 from datawindow within w_mant_modificafruta_prediocuartel
end type
type dw_4 from datawindow within w_mant_modificafruta_prediocuartel
end type
end forward
...
integer width = 4238
integer height = 2100
string title = "MANTENEDOR DETALLE PALLET PREDIOS CUARTELES"
...
global w_mant_modificafruta_prediocuartel w_mant_modificafruta_prediocuartel
...
public function boolean noexistecalibre (string as_valor, integer ai_especie, integer ai_variedad)
...
//IF Upper(gstr_us.Nombre) <> Upper('EOrdenes') OR Upper(gstr_us.Nombre) <> Upper('PValdes') THEN 
...
public function boolean noexistecalibre (string as_valor, integer ai_especie, integer ai_variedad);String	ls_codigo, ls_calibr
...
on w_mant_modificafruta_prediocuartel.create
int iCurrent
call super::create
...
on w_mant_modificafruta_prediocuartel.destroy
call super::destroy
destroy(this.st_2)
destroy(this.st_1)
...
type st_encabe from w_mant_directo`st_encabe within w_mant_modificafruta_prediocuartel
integer x = 87
integer y = 60
integer width = 3671
integer height = 416
...
type pb_nuevo from w_mant_directo`pb_nuevo within w_mant_modificafruta_prediocuartel
integer x = 3886
integer y = 516
integer taborder = 70
end type
...
type pb_lectura from w_mant_directo`pb_lectura within w_mant_modificafruta_prediocuartel
integer x = 3886
integer y = 220
integer taborder = 50
end type
...
type pb_eliminar from w_mant_directo`pb_eliminar within w_mant_modificafruta_prediocuartel
...
type pb_insertar from w_mant_directo`pb_insertar within w_mant_modificafruta_prediocuartel
boolean visible = false
integer x = 3886
integer y = 696
integer taborder = 80
...
type pb_salir from w_mant_directo`pb_salir within w_mant_modificafruta_prediocuartel
integer x = 3886
integer y = 1620
integer taborder = 120
end type

type pb_imprimir from w_mant_directo`pb_imprimir within w_mant_modificafruta_prediocuartel
integer x = 3886
integer y = 1236
integer taborder = 110
end type

type pb_grabar from w_mant_directo`pb_grabar within w_mant_modificafruta_prediocuartel
integer x = 3886
integer y = 1056
integer taborder = 100
end type

type dw_1 from w_mant_directo`dw_1 within w_mant_modificafruta_prediocuartel
integer x = 87
integer y = 496
integer width = 3671
integer height = 1440
integer taborder = 60
string dataobject = "dw_mues_modificapalletfruta_prediocuartel"
...
Long	ll_productor, ll_cuartelrot, ll_cuartel
...
CHOOSE CASE ls_Columna	
	...
	CASE "pafr_cuart1"
		...
		ll_productor = dw_1.Object.prod_codigo[row] 
		ll_cuartel	 = dw_1.Object.pafr_huert1[row] 
		
		IF existe_cuartel(ll_productor,ll_cuartel,Integer(data)) THEN
			dw_1.SetItem(row, ls_columna, Integer(ls_null))
			RETURN 1
		END IF	
	...
	CASE "pafr_cuart4"
		...
		ll_productor = dw_1.Object.pafr_prdrot[row] 
		ll_cuartelrot= dw_1.Object.pafr_huert4[row] 
		
		IF existe_cuartel(ll_productor,ll_cuartelrot,Integer(data)) THEN
			dw_1.SetItem(row, ls_columna, Integer(ls_null))
			RETURN 1
		END IF			
