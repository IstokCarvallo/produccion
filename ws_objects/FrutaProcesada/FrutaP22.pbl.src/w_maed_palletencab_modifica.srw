$PBExportHeader$w_maed_palletencab_modifica.srw
forward
global type w_maed_palletencab_modifica from w_mant_encab_deta_csd
end type
type dw_histoencab from datawindow within w_maed_palletencab_modifica
end type
type dw_histofruta from datawindow within w_maed_palletencab_modifica
end type
end forward
...
global w_maed_palletencab_modifica w_maed_palletencab_modifica
...
w_mant_deta_palletfruta_modifica iw_mantencion
...
DECLARE TraspasaHistoriadesdeProceso PROCEDURE FOR dba.Fproc_TraspasaHistoriadesdeProceso
			@Cliente 	=	:li_cliente, 
			@Planta 		=	:li_planta,
			@Pallet 		=	:ll_Nropal, 
			@Fecha		=	:ld_Fecha,
...
public subroutine bloqueaencabezado ();IF ii_bloquea = 0 THEN
	...
	dw_2.Object.cond_codigo.BackGround.Color = RGB(166,180,210) 	//dw_2.Object.cond_codigo.BackGround.Color = RGB(255,255,255) 
	dw_2.Object.paen_concal.BackGround.Color = RGB(166,180,210)    //dw_2.Object.paen_concal.BackGround.Color = RGB(255,255,255)
	dw_2.Object.plde_codigo.BackGround.Color = RGB(255,255,255) 
	...
	dw_2.Object.paen_inspec.BackGround.Color = RGB(166,180,210)		//dw_2.Object.paen_inspec.BackGround.Color = RGB(255,255,255)
...
ELSE
	...
	dw_2.Object.clie_codigo.BackGround.Color = RGB(166,180,210)
	dw_2.Object.paen_numero.BackGround.Color = RGB(166,180,210)
	dw_2.Object.paen_tipopa.BackGround.Color = RGB(166,180,210)
...
DO
	...
	ELSE
		...
		DO
			...
			IF ii_ancestro = 1 THEN
				ll_fila_fh	= ids_Palletfrutahisto.Retrieve(Integer(istr_mant.argumento[1]), &
																		  Long(istr_mant.argumento[2]), &
																		  Integer(istr_mant.argumento[6]),ii_Proceso)	 //1								 
				IF ll_fila_fh > 0 THEN
					il_NumProce	=	ids_Palletfrutahisto.Object.pafh_proces[1]
					ll_fila_eh	=	ids_Palletencabhisto.Retrieve(Integer(istr_mant.argumento[1]), &
																		  Long(istr_mant.argumento[2]), &
...
on w_maed_palletencab_modifica.create
int iCurrent
call super::create
this.dw_histoencab=create dw_histoencab
this.dw_histofruta=create dw_histofruta
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.dw_histoencab
this.Control[iCurrent+2]=this.dw_histofruta
end on

on w_maed_palletencab_modifica.destroy
call super::destroy
...
FOR ll_fila = 1 TO dw_1.RowCount()
		...
		dw_1.Object.pafr_prdrot[ll_fila]	=	dw_1.Object.prod_codigo[ll_fila]
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_palletencab_modifica
integer x = 91
integer y = 1140
integer width = 2953
integer height = 752
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_palletencab_modifica
integer x = 73
integer y = 56
integer width = 2985
integer height = 1060
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_palletencab_modifica
integer y = 252
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_palletencab_modifica
integer y = 480
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_palletencab_modifica
integer y = 688
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_palletencab_modifica
integer y = 896
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_palletencab_modifica
integer y = 1156
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_palletencab_modifica
integer x = 3296
integer y = 1488
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_palletencab_modifica
integer x = 3301
integer y = 1660
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_palletencab_modifica
integer y = 76
end type
