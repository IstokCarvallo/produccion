$PBExportHeader$w_maed_modificapallet_trans.srw
forward
global type w_maed_modificapallet_trans from w_mant_encab_deta_csd
end type
type pb_recupera from picturebutton within w_maed_modificapallet_trans
end type
type dw_3 from datawindow within w_maed_modificapallet_trans
end type
end forward
...
global w_maed_modificapallet_trans w_maed_modificapallet_trans
...
w_mant_deta_palletfruta_modifica_trans iw_mantencion
...
//	 SELECT	spcr_estado
//		INTO 	:li_estado
//		FROM 	dba.spro_controlrecepciones
//		WHERE plde_codigo = :li_Planta
...
on w_maed_modificapallet_trans.create
int iCurrent
call super::create
...
on w_maed_modificapallet_trans.destroy
call super::destroy
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_modificapallet_trans
integer x = 82
integer y = 1140
integer width = 2953
integer height = 752
...
string dataobject = "dw_mues_palletfruta_modificatrans"
end type
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_modificapallet_trans
integer x = 73
integer y = 56
integer width = 2985
integer height = 1060
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_modificapallet_trans
integer x = 3241
integer y = 276
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_modificapallet_trans
integer x = 3241
integer y = 500
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_modificapallet_trans
integer x = 3241
integer y = 708
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_modificapallet_trans
integer x = 3241
integer y = 916
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_modificapallet_trans
integer x = 3241
integer y = 1176
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_modificapallet_trans
boolean visible = false
integer x = 3241
integer y = 1504
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_modificapallet_trans
integer x = 3241
integer y = 1680
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_modificapallet_trans
integer x = 3241
integer y = 96
end type
...
IF ll_fila_d > 0 THEN
	MessageBox("Atención", "Los Cambios Surtiran Efecto Solo Cuando Haya Grabado.", &
					Exclamation!, OK!)
