$PBExportHeader$w_gene_archivo_despacho_fumigado.srw
forward
global type w_gene_archivo_despacho_fumigado from window
end type
type uo_selplantas from uo_seleccion_plantas within w_gene_archivo_despacho_fumigado
end type
type uo_selcliente from uo_seleccion_clientesprod within w_gene_archivo_despacho_fumigado
end type
type ddlb_1 from dropdownlistbox within w_gene_archivo_despacho_fumigado
end type
type st_7 from statictext within w_gene_archivo_despacho_fumigado
end type
type cbx_validadestino from checkbox within w_gene_archivo_despacho_fumigado
end type
type cbx_var from checkbox within w_gene_archivo_despacho_fumigado
end type
type em_fecha from editmask within w_gene_archivo_despacho_fumigado
end type
type st_4 from statictext within w_gene_archivo_despacho_fumigado
end type
type st_3 from statictext within w_gene_archivo_despacho_fumigado
end type
type sle_mensa from singlelineedit within w_gene_archivo_despacho_fumigado
end type
type em_planilla from editmask within w_gene_archivo_despacho_fumigado
end type
type st_5 from statictext within w_gene_archivo_despacho_fumigado
end type
type st_2 from statictext within w_gene_archivo_despacho_fumigado
end type
type st_1 from statictext within w_gene_archivo_despacho_fumigado
end type
type pb_salir from picturebutton within w_gene_archivo_despacho_fumigado
end type
type pb_grabar from picturebutton within w_gene_archivo_despacho_fumigado
end type
type st_6 from statictext within w_gene_archivo_despacho_fumigado
end type
type dw_1 from datawindow within w_gene_archivo_despacho_fumigado
end type
type dw_2 from datawindow within w_gene_archivo_despacho_fumigado
end type
end forward
...
global w_gene_archivo_despacho_fumigado w_gene_archivo_despacho_fumigado
...
on w_gene_archivo_despacho_fumigado.create
...
on w_gene_archivo_despacho_fumigado.destroy
...
boolean enabled = false
string text = "Genera Archivo Plano Anexo Despacho Fumigado"
alignment alignment = center!
boolean border = true
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
...
integer taborder = 90
boolean bringtotop = true
string dataobject = "dw_gene_archivo_embarque_fumigado"
boolean maxbox = true
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
