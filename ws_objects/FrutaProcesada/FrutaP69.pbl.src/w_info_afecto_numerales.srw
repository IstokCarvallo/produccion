$PBExportHeader$w_info_afecto_numerales.srw
forward
global type w_info_afecto_numerales from w_para_informes
end type
type st_1 from statictext within w_info_afecto_numerales
end type
type dw_cliente from datawindow within w_info_afecto_numerales
end type
type st_6 from statictext within w_info_afecto_numerales
end type
type dw_planta from datawindow within w_info_afecto_numerales
end type
type st_3 from statictext within w_info_afecto_numerales
end type
type st_8 from statictext within w_info_afecto_numerales
end type
type dw_productor from datawindow within w_info_afecto_numerales
end type
type cbx_productor from checkbox within w_info_afecto_numerales
end type
type st_5 from statictext within w_info_afecto_numerales
end type
type st_variedad from statictext within w_info_afecto_numerales
end type
type st_14 from statictext within w_info_afecto_numerales
end type
type em_dias from editmask within w_info_afecto_numerales
end type
type st_15 from statictext within w_info_afecto_numerales
end type
type st_fechaembarque from statictext within w_info_afecto_numerales
end type
type em_hasta from editmask within w_info_afecto_numerales
end type
type em_desde from editmask within w_info_afecto_numerales
end type
type st_2 from statictext within w_info_afecto_numerales
end type
type uo_selespecie from uo_seleccion_especie within w_info_afecto_numerales
end type
type cbx_varirotula from checkbox within w_info_afecto_numerales
end type
end forward
...
global w_info_afecto_numerales w_info_afecto_numerales
...
on w_info_afecto_numerales.create
int iCurrent
call super::create
...
on w_info_afecto_numerales.destroy
call super::destroy
destroy(this.st_1)
...
type st_computador from w_para_informes`st_computador within w_info_afecto_numerales
end type

type st_usuario from w_para_informes`st_usuario within w_info_afecto_numerales
end type

type st_temporada from w_para_informes`st_temporada within w_info_afecto_numerales
end type

type p_logo from w_para_informes`p_logo within w_info_afecto_numerales
end type

type st_titulo from w_para_informes`st_titulo within w_info_afecto_numerales
integer width = 2203
string text = "Listado Pallets Afectos a Cobro Numerales"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_afecto_numerales
integer x = 2578
integer y = 1324
integer taborder = 80
end type
...
vinf.dw_1.DataObject = "dw_info_afectonumerales"
...
fila	=	vinf.dw_1.Retrieve(li_cliente, li_planta, uo_selespecie.Codigo, &
									 Integer(ls_dias), ll_productor, ld_hasta, &
									 ld_desde, li_varirotula)
...
type pb_salir from w_para_informes`pb_salir within w_info_afecto_numerales
integer x = 2574
integer y = 1612
integer taborder = 90
end type
...
string facename = "Arial"
long backcolor = 553648127
string text = "Hasta Fecha Embarque"
boolean focusrectangle = false
end type
...
string facename = "Arial"
long backcolor = 553648127
string text = "Desde Fecha Embarque"
boolean focusrectangle = false
end type
