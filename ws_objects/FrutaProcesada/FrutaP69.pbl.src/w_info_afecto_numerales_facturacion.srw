$PBExportHeader$w_info_afecto_numerales_facturacion.srw
forward
global type w_info_afecto_numerales_facturacion from w_para_informes
end type
type st_1 from statictext within w_info_afecto_numerales_facturacion
end type
type dw_cliente from datawindow within w_info_afecto_numerales_facturacion
end type
type st_6 from statictext within w_info_afecto_numerales_facturacion
end type
type dw_planta from datawindow within w_info_afecto_numerales_facturacion
end type
type st_3 from statictext within w_info_afecto_numerales_facturacion
end type
type st_8 from statictext within w_info_afecto_numerales_facturacion
end type
type dw_productor from datawindow within w_info_afecto_numerales_facturacion
end type
type cbx_productor from checkbox within w_info_afecto_numerales_facturacion
end type
type st_5 from statictext within w_info_afecto_numerales_facturacion
end type
type st_variedad from statictext within w_info_afecto_numerales_facturacion
end type
type st_14 from statictext within w_info_afecto_numerales_facturacion
end type
type em_dias from editmask within w_info_afecto_numerales_facturacion
end type
type st_15 from statictext within w_info_afecto_numerales_facturacion
end type
type st_fechaembarque from statictext within w_info_afecto_numerales_facturacion
end type
type em_hasta from editmask within w_info_afecto_numerales_facturacion
end type
type em_desde from editmask within w_info_afecto_numerales_facturacion
end type
type st_2 from statictext within w_info_afecto_numerales_facturacion
end type
type cbx_planta from checkbox within w_info_afecto_numerales_facturacion
end type
type st_4 from statictext within w_info_afecto_numerales_facturacion
end type
type cbx_consopallet from checkbox within w_info_afecto_numerales_facturacion
end type
type uo_selespecie from uo_seleccion_especie within w_info_afecto_numerales_facturacion
end type
type cbx_varirotula from checkbox within w_info_afecto_numerales_facturacion
end type
end forward
...
integer width = 2944
integer height = 2172
string title = "Pallets Afectos Cobro Numerales para Facturación"
...
st_4 st_4
cbx_consopallet cbx_consopallet
uo_selespecie uo_selespecie
cbx_varirotula cbx_varirotula
end type
global w_info_afecto_numerales_facturacion w_info_afecto_numerales_facturacion
...
on w_info_afecto_numerales_facturacion.create
int iCurrent
call super::create
...
this.cbx_consopallet=create cbx_consopallet
...
this.Control[iCurrent+20]=this.cbx_consopallet
this.Control[iCurrent+21]=this.uo_selespecie
this.Control[iCurrent+22]=this.cbx_varirotula
end on

on w_info_afecto_numerales_facturacion.destroy
call super::destroy
destroy(this.st_1)
...
istr_mant.argumento[2]	= 	'-1' //String(gi_CodPlanta)		//	planta
istr_mant.argumento[6]  =  '-1' //"0"							//	productor
end event

event resize;//
end event

type st_computador from w_para_informes`st_computador within w_info_afecto_numerales_facturacion
end type

type st_usuario from w_para_informes`st_usuario within w_info_afecto_numerales_facturacion
end type

type st_temporada from w_para_informes`st_temporada within w_info_afecto_numerales_facturacion
end type

type p_logo from w_para_informes`p_logo within w_info_afecto_numerales_facturacion
end type

type st_titulo from w_para_informes`st_titulo within w_info_afecto_numerales_facturacion
integer width = 2203
string text = "Pallets Afectos Cobro Numerales para Facturación"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_afecto_numerales_facturacion
integer x = 2565
integer y = 1300
...
Integer	fila, li_cliente, li_planta, li_consopallet, li_varirotula
String	ls_dias, ls_fechas
Date		ld_hasta,ld_desde
Long		ll_productor

istr_info.titulo	= 'PALLETS AFECTOS A NUMERALES PARA FACTURAR'

OpenWithParm(vinf, istr_info)

vinf.dw_1.DataObject = "dw_info_afectonumerales_facturacion"
...
IF cbx_consopallet.Checked	THEN
	li_consopallet	= 1
ELSE
	li_consopallet	= 0
END IF
...
fila	=	vinf.dw_1.Retrieve(li_cliente, li_planta, uo_selespecie.Codigo, &
									 Integer(ls_dias), ll_productor, ld_hasta, ld_desde,&
									 li_consopallet,li_varirotula)
...
type pb_salir from w_para_informes`pb_salir within w_info_afecto_numerales_facturacion
integer x = 2569
integer y = 1588
...
event clicked;IF cbx_productor.Checked THEN
...
event clicked;IF cbx_planta.Checked THEN
