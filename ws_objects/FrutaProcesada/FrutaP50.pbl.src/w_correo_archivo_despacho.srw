$PBExportHeader$w_correo_archivo_despacho.srw
$PBExportComments$Ventana para envío de informes vía correo electrónico
forward
global type w_correo_archivo_despacho from window
end type
type cb_4 from commandbutton within w_correo_archivo_despacho
end type
type mle_copiasocultas from multilineedit within w_correo_archivo_despacho
end type
type cb_3 from commandbutton within w_correo_archivo_despacho
end type
type mle_copias from multilineedit within w_correo_archivo_despacho
end type
type cb_2 from commandbutton within w_correo_archivo_despacho
end type
type cb_1 from commandbutton within w_correo_archivo_despacho
end type
type cb_ninguno from commandbutton within w_correo_archivo_despacho
end type
type mle_archivo from multilineedit within w_correo_archivo_despacho
end type
type mle_recipientes from multilineedit within w_correo_archivo_despacho
end type
type pb_salir from picturebutton within w_correo_archivo_despacho
end type
type st_estado from statictext within w_correo_archivo_despacho
end type
type st_2 from statictext within w_correo_archivo_despacho
end type
type mle_texto from multilineedit within w_correo_archivo_despacho
end type
type cb_para from commandbutton within w_correo_archivo_despacho
end type
type sle_asunto from singlelineedit within w_correo_archivo_despacho
end type
type st_1 from statictext within w_correo_archivo_despacho
end type
type st_encabezado from statictext within w_correo_archivo_despacho
end type
type gb_2 from groupbox within w_correo_archivo_despacho
end type
type pb_correo from picturebutton within w_correo_archivo_despacho
end type
type gb_1 from groupbox within w_correo_archivo_despacho
end type
end forward
...
global w_correo_archivo_despacho w_correo_archivo_despacho
...
on w_correo_archivo_despacho.create
...
on w_correo_archivo_despacho.destroy
destroy(this.cb_4)
...
String			ls_ret
String         ls_asunto,ls_texto,ls_destin, ls_destin2
...
ls_destin 	= 	istr_parms.string_arg[1]
ls_asunto 	= 	istr_parms.string_arg[2]
ls_texto		=	istr_parms.string_arg[3]
...
sle_asunto.Text		 =	 ls_asunto
mle_texto.Text			 =	 ls_texto

pb_correo.PostEvent(Clicked!)
...
long textcolor = 33554432
long backcolor = 33543637
string text = "Envío de Aviso Recepción Interplanta por Correo Electrónico"
alignment alignment = center!
boolean border = true
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string picturename = "\Desarrollo 12\Imagenes\Botones\outlook.png"
string disabledname = "\Desarrollo 12\Imagenes\Botones\outlook_bn.png"
alignment htextalign = left!
end type
...
//	mAttach.FileName 		=  Trim(istr_parms.string_arg[4])
