$PBExportHeader$w_correo_archivo_saam.srw
$PBExportComments$Ventana para envío de informes vía correo electrónico
forward
global type w_correo_archivo_saam from window
end type
type cb_4 from commandbutton within w_correo_archivo_saam
end type
type mle_copiasocultas from multilineedit within w_correo_archivo_saam
end type
type cb_3 from commandbutton within w_correo_archivo_saam
end type
type mle_copias from multilineedit within w_correo_archivo_saam
end type
type cb_2 from commandbutton within w_correo_archivo_saam
end type
type cb_1 from commandbutton within w_correo_archivo_saam
end type
type cb_ninguno from commandbutton within w_correo_archivo_saam
end type
type mle_archivo from multilineedit within w_correo_archivo_saam
end type
type mle_recipientes from multilineedit within w_correo_archivo_saam
end type
type pb_salir from picturebutton within w_correo_archivo_saam
end type
type st_estado from statictext within w_correo_archivo_saam
end type
type st_2 from statictext within w_correo_archivo_saam
end type
type mle_texto from multilineedit within w_correo_archivo_saam
end type
type cb_para from commandbutton within w_correo_archivo_saam
end type
type sle_asunto from singlelineedit within w_correo_archivo_saam
end type
type st_1 from statictext within w_correo_archivo_saam
end type
type st_encabezado from statictext within w_correo_archivo_saam
end type
type pb_correo from picturebutton within w_correo_archivo_saam
end type
end forward
...
global w_correo_archivo_saam w_correo_archivo_saam
...
on w_correo_archivo_saam.create
...
on w_correo_archivo_saam.destroy
destroy(this.cb_4)
...
/*	
carga las direcciones de correo que se encuentran en la tabla parempresa 
*/
	
SELECT empr_emsaam,empr_emcomext
  INTO :ls_destin,:ls_destin2
  FROM dbo.parempresa;

IF sqlca.SQLCode = -1 THEN
	F_ErrorBaseDatos(sqlca, "Lectura de Tabla de parempresa")	
	RETURN
...
IF IsNull(ls_destin2) OR ls_destin2 = ""	THEN ls_destin2 = ""
...
mle_recipientes.text  =  ls_destin+'; '+ls_destin2
