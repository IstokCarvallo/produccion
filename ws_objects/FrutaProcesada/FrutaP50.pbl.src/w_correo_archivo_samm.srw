$PBExportHeader$w_correo_archivo_samm.srw
$PBExportComments$Ventana para envío de informes vía correo electrónico
forward
global type w_correo_archivo_samm from window
end type
type cb_4 from commandbutton within w_correo_archivo_samm
end type
type mle_copiasocultas from multilineedit within w_correo_archivo_samm
end type
type cb_3 from commandbutton within w_correo_archivo_samm
end type
type mle_copias from multilineedit within w_correo_archivo_samm
end type
type cb_2 from commandbutton within w_correo_archivo_samm
end type
type cb_1 from commandbutton within w_correo_archivo_samm
end type
type cb_ninguno from commandbutton within w_correo_archivo_samm
end type
type mle_archivo from multilineedit within w_correo_archivo_samm
end type
type mle_recipientes from multilineedit within w_correo_archivo_samm
end type
type pb_salir from picturebutton within w_correo_archivo_samm
end type
type st_estado from statictext within w_correo_archivo_samm
end type
type st_2 from statictext within w_correo_archivo_samm
end type
type mle_texto from multilineedit within w_correo_archivo_samm
end type
type cb_para from commandbutton within w_correo_archivo_samm
end type
type sle_asunto from singlelineedit within w_correo_archivo_samm
end type
type st_1 from statictext within w_correo_archivo_samm
end type
type st_encabezado from statictext within w_correo_archivo_samm
end type
type gb_2 from groupbox within w_correo_archivo_samm
end type
type pb_correo from picturebutton within w_correo_archivo_samm
end type
type gb_1 from groupbox within w_correo_archivo_samm
end type
end forward
...
global w_correo_archivo_samm w_correo_archivo_samm
...
on w_correo_archivo_samm.create
...
on w_correo_archivo_samm.destroy
destroy(this.cb_4)
