$PBExportHeader$w_mant_deta_palletfruta_cambioprodcal.srw
forward
global type w_mant_deta_palletfruta_cambioprodcal from w_mant_detalle_csd
end type
end forward
...
global w_mant_deta_palletfruta_cambioprodcal w_mant_deta_palletfruta_cambioprodcal
...
ELSE
	...
	dw_1.SetItem(il_fila, "pafr_calrot", ls_codigo)	
	RETURN False
END IF
...
ELSE
	...
	dw_1.SetItem(il_fila, "pafr_prdrot", Long(istr_busq.Argum[4]))
...
on w_mant_deta_palletfruta_cambioprodcal.create
call super::create
end on

on w_mant_deta_palletfruta_cambioprodcal.destroy
call super::destroy
end on
...
//dw_1.Object.pafr_ccajas.Protect	=	1
//dw_1.Object.pafr_ccajas.BackGround.Color = RGB(166,180,210)

dw_1.Object.prod_codigo.Protect	=	1
dw_1.Object.prod_codigo.BackGround.Color = RGB(192,220,192)
...
idwc_predio.Retrieve(long(istr_mant.argumento[17]))

dw_calibres.Retrieve(Integer(istr_mant.Argumento[3]), &
							Integer(istr_mant.Argumento[4]))
							
idwc_cuartel.Retrieve(long(istr_mant.argumento[17]),integer(istr_mant.argumento[16]),&
...
ELSE
	...
	dw_1.Object.vari_codigo.BackGround.Color	=	RGB(166,180,210)
	dw_1.Object.emba_codigo.BackGround.Color	=	RGB(166,180,210)
END IF
end event

type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_palletfruta_cambioprodcal
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_palletfruta_cambioprodcal
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_palletfruta_cambioprodcal
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_palletfruta_cambioprodcal
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_palletfruta_cambioprodcal
integer x = 2725
integer y = 368
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_palletfruta_cambioprodcal
integer x = 2725
integer y = 160
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_palletfruta_cambioprodcal
integer x = 2725
integer y = 588
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_palletfruta_cambioprodcal
integer x = 9
integer y = 12
integer width = 2592
integer height = 1188
string dataobject = "dw_mant_palletfruta_cambioprodcal"
end type
...
CHOOSE CASE ls_columna
	...
	CASE "pafr_huert1"
		...
		IF Not noexistepredio(dw_1.Object.Prod_codigo[row],integer(data)) THEN
			...
			Return 1
		ELSE
			dw_1.SetItem(row, "pafr_huert4", integer(data))

			dw_1.GetChild("pafr_cuart1", idwc_cuartel)
			idwc_cuartel.SetTransObject(SQLCA)
			idwc_cuartel.Retrieve(dw_1.Object.Prod_codigo[row],integer(data),Integer(istr_mant.argumento[3]),Integer(istr_mant.argumento[4]))
