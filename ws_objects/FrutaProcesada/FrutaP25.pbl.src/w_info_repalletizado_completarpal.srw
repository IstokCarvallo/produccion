$PBExportHeader$w_info_repalletizado_completarpal.srw
$PBExportComments$Informe de Repalletizajes.
forward
global type w_info_repalletizado_completarpal from w_para_informes
end type
type st_4 from statictext within w_info_repalletizado_completarpal
end type
type st_1 from statictext within w_info_repalletizado_completarpal
end type
type st_5 from statictext within w_info_repalletizado_completarpal
end type
type st_2 from statictext within w_info_repalletizado_completarpal
end type
type em_numero from editmask within w_info_repalletizado_completarpal
end type
type st_6 from statictext within w_info_repalletizado_completarpal
end type
type cb_buscarepa from commandbutton within w_info_repalletizado_completarpal
end type
type uo_selcliente from uo_seleccion_clientesprod within w_info_repalletizado_completarpal
end type
type uo_selplantas from uo_seleccion_plantas within w_info_repalletizado_completarpal
end type
end forward
...
global w_info_repalletizado_completarpal w_info_repalletizado_completarpal
...
on w_info_repalletizado_completarpal.create
int iCurrent
call super::create
...
this.Control[iCurrent+9]=this.uo_selplantas
end on

on w_info_repalletizado_completarpal.destroy
call super::destroy
destroy(this.st_4)
destroy(this.st_1)
destroy(this.st_5)
...
type pb_excel from w_para_informes`pb_excel within w_info_repalletizado_completarpal
end type

type st_computador from w_para_informes`st_computador within w_info_repalletizado_completarpal
end type

type st_usuario from w_para_informes`st_usuario within w_info_repalletizado_completarpal
end type

type st_temporada from w_para_informes`st_temporada within w_info_repalletizado_completarpal
end type

type p_logo from w_para_informes`p_logo within w_info_repalletizado_completarpal
end type

type st_titulo from w_para_informes`st_titulo within w_info_repalletizado_completarpal
integer y = 288
integer width = 1902
string text = "Informe de Cuadratura Repalletizado Completar Pallet"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_repalletizado_completarpal
...
vinf.dw_1.DataObject = "dw_info_repaletizado_pallet"
...
type pb_salir from w_para_informes`pb_salir within w_info_repalletizado_completarpal
