$PBExportHeader$w_busc_cambioaltura.srw
forward
global type w_busc_cambioaltura from w_busqueda
end type
...
global w_busc_cambioaltura w_busc_cambioaltura
...
is_ordena = 'Número:altu_numero,Fecha Mvto.:altu_fecmov,Observación:altu_observ'
...
on w_busc_cambioaltura.create
int iCurrent
call super::create
end on

on w_busc_cambioaltura.destroy
call super::destroy
end on

event ue_asignacion();istr_busq.argum[5]	= String(dw_1.Object.altu_numero[dw_1.GetRow()])
istr_busq.argum[6]	= String(dw_1.Object.altu_fecmov[dw_1.GetRow()])
istr_busq.argum[7]	= dw_1.Object.altu_observ[dw_1.GetRow()]

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_cambioaltura
...
type dw_1 from w_busqueda`dw_1 within w_busc_cambioaltura
integer y = 760
integer width = 2651
integer taborder = 60
string dataobject = "dw_mues_alpalletencab_filtro"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_cambioaltura
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_cambioaltura
integer x = 137
integer y = 100
integer width = 2615
integer height = 668
...
event pb_filtrar::clicked;call super::clicked;IF dw_1.Retrieve(Integer(istr_busq.argum[1]), Integer(istr_busq.argum[2]) , Integer(istr_busq.argum[3]) ) > 0 THEN
	dw_1.SetFocus()
	dw_1.SelectRow(1,True)

	istr_busq.argum[5]	= String(dw_1.GetItemNumber(dw_1.GetRow(), "altu_numero"))
