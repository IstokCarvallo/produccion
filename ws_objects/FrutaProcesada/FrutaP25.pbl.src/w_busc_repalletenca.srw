$PBExportHeader$w_busc_repalletenca.srw
forward
global type w_busc_repalletenca from w_busqueda
end type
...
global w_busc_repalletenca w_busc_repalletenca
...
on w_busc_repalletenca.create
int iCurrent
call super::create
end on

on w_busc_repalletenca.destroy
call super::destroy
end on
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_repalletenca
...
type dw_1 from w_busqueda`dw_1 within w_busc_repalletenca
integer y = 748
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_repalletenca"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_repalletenca
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_repalletenca
integer x = 82
integer width = 2651
integer height = 620
end type
