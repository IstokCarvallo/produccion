$PBExportHeader$w_info_produccion_historica.srw
forward
global type w_info_produccion_historica from w_para_informes
end type
type st_4 from statictext within w_info_produccion_historica
end type
type st_1 from statictext within w_info_produccion_historica
end type
type st_2 from statictext within w_info_produccion_historica
end type
type em_desde from editmask within w_info_produccion_historica
end type
type dw_cliente from datawindow within w_info_produccion_historica
end type
type st_6 from statictext within w_info_produccion_historica
end type
type dw_planta from datawindow within w_info_produccion_historica
end type
type st_3 from statictext within w_info_produccion_historica
end type
type cbx_planta from checkbox within w_info_produccion_historica
end type
type st_7 from statictext within w_info_produccion_historica
end type
type em_hasta from editmask within w_info_produccion_historica
end type
type st_8 from statictext within w_info_produccion_historica
end type
type dw_productor from datawindow within w_info_produccion_historica
end type
type cbx_productor from checkbox within w_info_produccion_historica
end type
type st_9 from statictext within w_info_produccion_historica
end type
type cbx_packing from checkbox within w_info_produccion_historica
end type
type dw_packing from datawindow within w_info_produccion_historica
end type
type gb_3 from groupbox within w_info_produccion_historica
end type
type st_5 from statictext within w_info_produccion_historica
end type
type cbx_peso from checkbox within w_info_produccion_historica
end type
type dw_pesoneto from datawindow within w_info_produccion_historica
end type
type tit_peso from statictext within w_info_produccion_historica
end type
type st_variedad from statictext within w_info_produccion_historica
end type
type rb_embalaje from radiobutton within w_info_produccion_historica
end type
type rb_productor from radiobutton within w_info_produccion_historica
end type
type rb_variedad from radiobutton within w_info_produccion_historica
end type
type gb_5 from groupbox within w_info_produccion_historica
end type
type gb_15 from groupbox within w_info_produccion_historica
end type
type st_10 from statictext within w_info_produccion_historica
end type
type cbx_variedadrelacionada from checkbox within w_info_produccion_historica
end type
type cbx_predio from checkbox within w_info_produccion_historica
end type
type uo_selespecie from uo_seleccion_especie within w_info_produccion_historica
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_produccion_historica
end type
type rb_status from radiobutton within w_info_produccion_historica
end type
type cbx_status from checkbox within w_info_produccion_historica
end type
type st_11 from statictext within w_info_produccion_historica
end type
end forward
...
global w_info_produccion_historica w_info_produccion_historica
...
on w_info_produccion_historica.create
int iCurrent
call super::create
...
this.Control[iCurrent+34]=this.rb_status
this.Control[iCurrent+35]=this.cbx_status
this.Control[iCurrent+36]=this.st_11
end on

on w_info_produccion_historica.destroy
call super::destroy
destroy(this.st_4)
destroy(this.st_1)
destroy(this.st_2)
...
type st_computador from w_para_informes`st_computador within w_info_produccion_historica
end type

type st_usuario from w_para_informes`st_usuario within w_info_produccion_historica
end type

type st_temporada from w_para_informes`st_temporada within w_info_produccion_historica
end type

type p_logo from w_para_informes`p_logo within w_info_produccion_historica
end type

type st_titulo from w_para_informes`st_titulo within w_info_produccion_historica
integer width = 3159
string text = "Informe Histórico de Producción"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_produccion_historica
...
Integer	fila, li_cliente, li_planta, li_varirotula, li_status
Date		ld_desde, ld_hasta
String	texto_desde, texto_hasta, texto_fecha, ls_nroguia, ls_cajas, ls_packing

istr_info.titulo	= 'INFORME DE PRODUCCION HISTORICA'
...
IF rb_status.Checked THEN
	...
	vinf.dw_1.DataObject = "dw_info_produccionhistorica_status"
	
ELSE	
	IF cbx_variedadrelacionada.Checked THEN
		IF cbx_predio.Checked = True THEN
			IF rb_embalaje.checked THEN
				vinf.dw_1.DataObject = "dw_info_prod_hist_varela_predio_c"
			ELSEIF rb_productor.checked THEN
				vinf.dw_1.DataObject = "dw_info_prod_hist_varela_prod_predio"
			ELSE
				vinf.dw_1.DataObject = "dw_info_prod_hist_varela_var_predio"
			END IF
		ELSE
			IF rb_embalaje.checked THEN
				vinf.dw_1.DataObject = "dw_info_produccion_historica_varela"
			ELSEIF rb_productor.checked THEN
				vinf.dw_1.DataObject = "dw_info_prod_historica_varela_prod"
			ELSE
				vinf.dw_1.DataObject = "dw_info_prod_historica_varela_var"
			END IF
		END IF	
	ELSE 
		IF cbx_predio.Checked = True THEN
			IF rb_embalaje.checked THEN
				vinf.dw_1.DataObject = "dw_info_prod_hist_pedio"
			ELSEIF rb_productor.checked THEN
				vinf.dw_1.DataObject = "dw_info_prod_hist_prd_predio"
			ELSE
				vinf.dw_1.DataObject = "dw_info_prod_hist_var_predio"
			END IF
		ELSE 
			IF rb_embalaje.checked THEN
				vinf.dw_1.DataObject = "dw_info_produccion_historica"
			ELSEIF rb_productor.checked THEN
				vinf.dw_1.DataObject = "dw_info_produccion_historica_prd"
			ELSE
				vinf.dw_1.DataObject = "dw_info_produccion_historica_var"
			END IF
		END IF
	END IF
END IF
...
IF rb_status.Checked THEN
	fila	=	vinf.dw_1.Retrieve(li_cliente, li_planta, ld_desde, ld_hasta, uo_selespecie.Codigo,&
									 ...
									 Dec(istr_mant.argumento[8]),uo_selvariedad.Codigo,li_status,li_varirotula)
ELSE
	fila	=	vinf.dw_1.Retrieve(li_cliente, li_planta, ld_desde, ld_hasta, uo_selespecie.Codigo,&
	 								0, Long(istr_mant.argumento[6]),Integer(istr_mant.argumento[7]),&
...
ELSE
	...
	IF cbx_variedadrelacionada.Checked=False THEN vinf.dw_1.Object.titulo_informe.text = 'Producción Historica'
...
type pb_salir from w_para_informes`pb_salir within w_info_produccion_historica
