$PBExportHeader$w_info_resuprod.srw
forward
global type w_info_resuprod from w_para_informes
end type
type st_4 from statictext within w_info_resuprod
end type
type dw_tipoprodu from datawindow within w_info_resuprod
end type
type cbx_productor from checkbox within w_info_resuprod
end type
type st_1 from statictext within w_info_resuprod
end type
type st_5 from statictext within w_info_resuprod
end type
type st_2 from statictext within w_info_resuprod
end type
type st_3 from statictext within w_info_resuprod
end type
type em_fech_ini from editmask within w_info_resuprod
end type
type em_fech_fin from editmask within w_info_resuprod
end type
type dw_2 from datawindow within w_info_resuprod
end type
type st_6 from statictext within w_info_resuprod
end type
end forward
...
integer width = 2711
integer height = 1832
string title = "Resumen de Productores"
...
global w_info_resuprod w_info_resuprod
...
type st_computador from w_para_informes`st_computador within w_info_resuprod
end type

type st_usuario from w_para_informes`st_usuario within w_info_resuprod
end type

type st_temporada from w_para_informes`st_temporada within w_info_resuprod
end type

type p_logo from w_para_informes`p_logo within w_info_resuprod
end type

type st_titulo from w_para_informes`st_titulo within w_info_resuprod
integer width = 1934
string text = "Informe Resumen de Productores"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_resuprod
...
Integer	fila,li_cbx_productor,li_produ,li_cliente
String	l_s_titulo,ls_descri,ls_desde,ls_hasta,texto_fecha
...
vinf.dw_1.DataObject = "dw_info_resuprod"
vinf.dw_1.SetTransObject(sqlca)

ld_fech_ini =	Date(istr_mant.argumento[2])
ld_fech_fin =	Date(istr_mant.argumento[3])
ls_desde		=	F_Fecha_Texto(String(ld_fech_ini), 1)
ls_hasta		=	F_Fecha_Texto(String(ld_fech_fin), 1)
texto_fecha	=	"Desde El:  " + ls_desde + "    Hasta El:  " + ls_hasta
...
type pb_salir from w_para_informes`pb_salir within w_info_resuprod
