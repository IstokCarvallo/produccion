$PBExportHeader$w_info_existencia_frigorifico_sin_prefrio.srw
$PBExportComments$Informe Existencia Sitio Revisión
forward
global type w_info_existencia_frigorifico_sin_prefrio from w_para_informes
end type
type st_1 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_2 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type em_desde from editmask within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_cliente from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type st_6 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_planta from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type st_3 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_7 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type em_hasta from editmask within w_info_existencia_frigorifico_sin_prefrio
end type
type st_8 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_productor from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type st_variedad from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_embalaje from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_embalaje from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_consembalaje from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type st_calidad from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type em_calidad from editmask within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_calidad from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_conscalidad from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_productor from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_productorcons from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_planta from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_envase from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type st_envase from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_envase from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_embalaje from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type dw_packing from datawindow within w_info_existencia_frigorifico_sin_prefrio
end type
type st_5 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_cajas from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type gb_4 from groupbox within w_info_existencia_frigorifico_sin_prefrio
end type
type gb_3 from groupbox within w_info_existencia_frigorifico_sin_prefrio
end type
type st_4 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_9 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_10 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type uo_selespecie from uo_seleccion_especie within w_info_existencia_frigorifico_sin_prefrio
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_varirotula from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
type st_11 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type st_12 from statictext within w_info_existencia_frigorifico_sin_prefrio
end type
type em_numero from editmask within w_info_existencia_frigorifico_sin_prefrio
end type
type cb_buscarepa from commandbutton within w_info_existencia_frigorifico_sin_prefrio
end type
type cbx_todpal from checkbox within w_info_existencia_frigorifico_sin_prefrio
end type
end forward
...
integer width = 3845
integer height = 1832
string title = "EXISTENCIA FRIGORIFICO SIN PROCESO PREFRÍO"
...
global w_info_existencia_frigorifico_sin_prefrio w_info_existencia_frigorifico_sin_prefrio
...
on w_info_existencia_frigorifico_sin_prefrio.create
int iCurrent
call super::create
...
this.Control[iCurrent+41]=this.cb_buscarepa
this.Control[iCurrent+42]=this.cbx_todpal
end on

on w_info_existencia_frigorifico_sin_prefrio.destroy
call super::destroy
destroy(this.st_1)
destroy(this.st_2)
...
istr_mant.argumento[7] = String(ii_Packing)
...
type st_computador from w_para_informes`st_computador within w_info_existencia_frigorifico_sin_prefrio
end type

type st_usuario from w_para_informes`st_usuario within w_info_existencia_frigorifico_sin_prefrio
end type

type st_temporada from w_para_informes`st_temporada within w_info_existencia_frigorifico_sin_prefrio
end type

type p_logo from w_para_informes`p_logo within w_info_existencia_frigorifico_sin_prefrio
end type

type st_titulo from w_para_informes`st_titulo within w_info_existencia_frigorifico_sin_prefrio
integer width = 3131
string text = "Existencia Frigorífico SIN Proceso de PreFrío"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_existencia_frigorifico_sin_prefrio
integer x = 3497
integer y = 1140
...
istr_info.titulo	= 'EXISTENCIA EN FRIGORIFICO SIN PROCESO PREFRIO'	
...
vinf.dw_1.DataObject = "dw_info_existencia_frigorifico_prefrio"
...
fila	=	vinf.dw_1.Retrieve(ii_cliente, ii_planta, ii_productor, uo_selespecie.Codigo,&
									 ...
									 is_calibre, id_fecini, id_fecter, ii_Packing,li_caja, li_varirotula,ll_pallet)
...
type pb_salir from w_para_informes`pb_salir within w_info_existencia_frigorifico_sin_prefrio
integer x = 3502
integer y = 1404
