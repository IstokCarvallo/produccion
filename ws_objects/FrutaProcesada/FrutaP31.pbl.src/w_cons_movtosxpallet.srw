$PBExportHeader$w_cons_movtosxpallet.srw
forward
global type w_cons_movtosxpallet from window
end type
type dw_1 from uo_dw within w_cons_movtosxpallet
end type
type pb_salir from picturebutton within w_cons_movtosxpallet
end type
end forward
...
global w_cons_movtosxpallet w_cons_movtosxpallet
...
on w_cons_movtosxpallet.create
...
on w_cons_movtosxpallet.destroy
destroy(this.dw_1)
...
dw_1.Retrieve(Long(lstr_Busq.Argum[1]), Long(lstr_Busq.Argum[2]), Long(lstr_Busq.Argum[3]), -1)
...
string dataobject = "dw_cons_movtosxpallet"
