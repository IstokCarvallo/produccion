$PBExportHeader$w_cons_estacionesxpallet.srw
forward
global type w_cons_estacionesxpallet from window
end type
type dw_1 from uo_dw within w_cons_estacionesxpallet
end type
type pb_salir from picturebutton within w_cons_estacionesxpallet
end type
end forward
...
global w_cons_estacionesxpallet w_cons_estacionesxpallet
...
on w_cons_estacionesxpallet.create
...
on w_cons_estacionesxpallet.destroy
destroy(this.dw_1)
...
string dataobject = "dw_cons_estacionesxpallet"
