$PBExportHeader$w_cons_estacionesxpallet_pf.srw
forward
global type w_cons_estacionesxpallet_pf from window
end type
type dw_1 from uo_dw within w_cons_estacionesxpallet_pf
end type
type pb_salir from picturebutton within w_cons_estacionesxpallet_pf
end type
end forward
...
global w_cons_estacionesxpallet_pf w_cons_estacionesxpallet_pf
...
on w_cons_estacionesxpallet_pf.create
...
on w_cons_estacionesxpallet_pf.destroy
destroy(this.dw_1)
...
dw_1.Retrieve(Long(lstr_Busq.Argum[1]), Long(lstr_Busq.Argum[2]), Long(lstr_Busq.Argum[3]), Long(lstr_Busq.Argum[4]))
...
string dataobject = "dw_cons_estacionesxpallet_pf"
