$PBExportHeader$w_busc_inspecpaldet_anula.srw
forward
global type w_busc_inspecpaldet_anula from w_busqueda
end type
...
global w_busc_inspecpaldet_anula w_busc_inspecpaldet_anula
...
on w_busc_inspecpaldet_anula.create
int iCurrent
call super::create
end on

on w_busc_inspecpaldet_anula.destroy
call super::destroy
end on

event ue_asignacion();istr_busq.argum[5]	= String(dw_1.Object.inpd_nroanu[dw_1.GetRow()])
istr_busq.argum[10]	= String(dw_1.Object.inpd_fechaa[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_inspecpaldet_anula
...
type dw_1 from w_busqueda`dw_1 within w_busc_inspecpaldet_anula
integer y = 760
integer width = 2048
integer taborder = 60
string dataobject = "dw_mues_inspecciones_anuladas"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_inspecpaldet_anula
integer x = 2254
integer y = 1400
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_inspecpaldet_anula
integer x = 82
integer width = 2048
integer height = 620
end type
