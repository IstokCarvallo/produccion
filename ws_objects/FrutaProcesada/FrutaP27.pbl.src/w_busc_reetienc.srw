$PBExportHeader$w_busc_reetienc.srw
forward
global type w_busc_reetienc from w_busqueda
end type
...
integer width = 3045
integer height = 1808
string title = "Búsqueda de Reetiquetado"
boolean resizable = false
end type
global w_busc_reetienc w_busc_reetienc
...
is_ordena = 'Número:reet_numero,Fecha:reet_ferret'
...
on w_busc_reetienc.create
int iCurrent
call super::create
end on

on w_busc_reetienc.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[5]	= String(dw_1.Object.reet_numero[dw_1.GetRow()])

CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_reetienc
...
type dw_1 from w_busqueda`dw_1 within w_busc_reetienc
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_mues_reetienc"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_reetienc
integer x = 2738
integer y = 1324
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_reetienc
integer x = 82
integer width = 2551
integer height = 620
end type
...
event pb_filtrar::clicked;call super::clicked;IF dw_1.Retrieve(Integer(istr_busq.argum[1]), Integer(istr_busq.argum[2])) > 0 THEN
	...
	istr_busq.argum[5]	= String(dw_1.GetItemNumber(dw_1.GetRow(), "reet_numero"))
