$PBExportHeader$w_busc_anulacondicion.srw
forward
global type w_busc_anulacondicion from w_busqueda
end type
...
global w_busc_anulacondicion w_busc_anulacondicion
...
on w_busc_anulacondicion.create
int iCurrent
call super::create
end on

on w_busc_anulacondicion.destroy
call super::destroy
end on

event ue_asignacion;istr_busq.argum[5]	= String(dw_1.Object.sage_numero[dw_1.GetRow()])


CloseWithReturn(This,istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_anulacondicion
...
type dw_1 from w_busqueda`dw_1 within w_busc_anulacondicion
integer y = 760
integer width = 2551
integer taborder = 60
string dataobject = "dw_busc_anulacondicion"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_anulacondicion
integer x = 2720
integer y = 1100
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_anulacondicion
integer x = 82
integer width = 2551
integer height = 620
end type
