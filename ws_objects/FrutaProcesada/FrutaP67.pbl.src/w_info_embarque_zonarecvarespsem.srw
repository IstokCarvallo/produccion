$PBExportHeader$w_info_embarque_zonarecvarespsem.srw
forward
global type w_info_embarque_zonarecvarespsem from w_para_informes
end type
type st_4 from statictext within w_info_embarque_zonarecvarespsem
end type
type dw_cliente from datawindow within w_info_embarque_zonarecvarespsem
end type
type st_6 from statictext within w_info_embarque_zonarecvarespsem
end type
type st_3 from statictext within w_info_embarque_zonarecvarespsem
end type
type st_13 from statictext within w_info_embarque_zonarecvarespsem
end type
type em_semana from editmask within w_info_embarque_zonarecvarespsem
end type
type st_14 from statictext within w_info_embarque_zonarecvarespsem
end type
type em_ano from editmask within w_info_embarque_zonarecvarespsem
end type
type st_10 from statictext within w_info_embarque_zonarecvarespsem
end type
type dw_recibidor from datawindow within w_info_embarque_zonarecvarespsem
end type
type cbx_recibidor from checkbox within w_info_embarque_zonarecvarespsem
end type
type cbx_recibidorcons from checkbox within w_info_embarque_zonarecvarespsem
end type
type st_1 from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_planta from checkbox within w_info_embarque_zonarecvarespsem
end type
type cbx_plantascons from checkbox within w_info_embarque_zonarecvarespsem
end type
type dw_planta from datawindow within w_info_embarque_zonarecvarespsem
end type
type st_8 from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_peso from checkbox within w_info_embarque_zonarecvarespsem
end type
type tit_peso from statictext within w_info_embarque_zonarecvarespsem
end type
type dw_pesoneto from datawindow within w_info_embarque_zonarecvarespsem
end type
type gb_3 from groupbox within w_info_embarque_zonarecvarespsem
end type
type st_5 from statictext within w_info_embarque_zonarecvarespsem
end type
type st_7 from statictext within w_info_embarque_zonarecvarespsem
end type
type st_11 from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_mercado from checkbox within w_info_embarque_zonarecvarespsem
end type
type dw_mercado from datawindow within w_info_embarque_zonarecvarespsem
end type
type st_12 from statictext within w_info_embarque_zonarecvarespsem
end type
type dw_zonas from datawindow within w_info_embarque_zonarecvarespsem
end type
type cbx_zonas from checkbox within w_info_embarque_zonarecvarespsem
end type
type st_16 from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_zonascons from checkbox within w_info_embarque_zonarecvarespsem
end type
type st_variedad from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_merccons from checkbox within w_info_embarque_zonarecvarespsem
end type
type st_envase from statictext within w_info_embarque_zonarecvarespsem
end type
type cbx_envase from checkbox within w_info_embarque_zonarecvarespsem
end type
type uo_selespecie from uo_seleccion_especie within w_info_embarque_zonarecvarespsem
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_embarque_zonarecvarespsem
end type
type cbx_varirotula from checkbox within w_info_embarque_zonarecvarespsem
end type
type uo_selproductor from uo_seleccion_varios_productores_clientes within w_info_embarque_zonarecvarespsem
end type
end forward
...
global w_info_embarque_zonarecvarespsem w_info_embarque_zonarecvarespsem
...
on w_info_embarque_zonarecvarespsem.create
int iCurrent
call super::create
...
this.Control[iCurrent+31]=this.cbx_zonascons
this.Control[iCurrent+32]=this.st_variedad
this.Control[iCurrent+33]=this.cbx_merccons
this.Control[iCurrent+34]=this.st_envase
this.Control[iCurrent+35]=this.cbx_envase
this.Control[iCurrent+36]=this.uo_selespecie
this.Control[iCurrent+37]=this.uo_selvariedad
this.Control[iCurrent+38]=this.cbx_varirotula
this.Control[iCurrent+39]=this.uo_selproductor
end on

on w_info_embarque_zonarecvarespsem.destroy
call super::destroy
destroy(this.st_4)
...
type st_computador from w_para_informes`st_computador within w_info_embarque_zonarecvarespsem
end type

type st_usuario from w_para_informes`st_usuario within w_info_embarque_zonarecvarespsem
end type

type st_temporada from w_para_informes`st_temporada within w_info_embarque_zonarecvarespsem
end type

type p_logo from w_para_informes`p_logo within w_info_embarque_zonarecvarespsem
end type

type st_titulo from w_para_informes`st_titulo within w_info_embarque_zonarecvarespsem
integer width = 3122
string text = "Embarques Especie / Recibidor / Variedad / Zonas / Semanas"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_embarque_zonarecvarespsem
integer x = 3493
integer y = 1320
...
String	ls_cajas, ls_especie, ls_planta, ls_productor, ls_encabezado,&
			ls_variedad, ls_zonas, ls_recibidor, ls_lista

istr_info.titulo	= 'EMBARQUES POR ESPECIE/CONSIGNATARIO/VARIEDAD/ZONAS/SEMANAS'

OpenWithParm(vinf, istr_info)
vinf.dw_1.DataObject = "dw_info_embarque_semanal_04"
...
type pb_salir from w_para_informes`pb_salir within w_info_embarque_zonarecvarespsem
integer x = 3493
integer y = 1596
...
event cbx_merccons::clicked;call super::clicked;IF This.Checked = TRUE THEN
