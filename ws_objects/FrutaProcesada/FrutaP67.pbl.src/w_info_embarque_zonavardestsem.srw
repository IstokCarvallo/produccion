$PBExportHeader$w_info_embarque_zonavardestsem.srw
forward
global type w_info_embarque_zonavardestsem from w_para_informes
end type
type st_4 from statictext within w_info_embarque_zonavardestsem
end type
type dw_cliente from datawindow within w_info_embarque_zonavardestsem
end type
type st_6 from statictext within w_info_embarque_zonavardestsem
end type
type st_3 from statictext within w_info_embarque_zonavardestsem
end type
type st_13 from statictext within w_info_embarque_zonavardestsem
end type
type em_semana from editmask within w_info_embarque_zonavardestsem
end type
type st_14 from statictext within w_info_embarque_zonavardestsem
end type
type em_ano from editmask within w_info_embarque_zonavardestsem
end type
type st_10 from statictext within w_info_embarque_zonavardestsem
end type
type dw_recibidor from datawindow within w_info_embarque_zonavardestsem
end type
type cbx_recibidor from checkbox within w_info_embarque_zonavardestsem
end type
type cbx_recibidorcons from checkbox within w_info_embarque_zonavardestsem
end type
type st_1 from statictext within w_info_embarque_zonavardestsem
end type
type cbx_planta from checkbox within w_info_embarque_zonavardestsem
end type
type cbx_plantascons from checkbox within w_info_embarque_zonavardestsem
end type
type dw_planta from datawindow within w_info_embarque_zonavardestsem
end type
type st_8 from statictext within w_info_embarque_zonavardestsem
end type
type cbx_peso from checkbox within w_info_embarque_zonavardestsem
end type
type tit_peso from statictext within w_info_embarque_zonavardestsem
end type
type dw_pesoneto from datawindow within w_info_embarque_zonavardestsem
end type
type gb_3 from groupbox within w_info_embarque_zonavardestsem
end type
type st_5 from statictext within w_info_embarque_zonavardestsem
end type
type st_7 from statictext within w_info_embarque_zonavardestsem
end type
type st_11 from statictext within w_info_embarque_zonavardestsem
end type
type cbx_mercado from checkbox within w_info_embarque_zonavardestsem
end type
type dw_mercado from datawindow within w_info_embarque_zonavardestsem
end type
type st_12 from statictext within w_info_embarque_zonavardestsem
end type
type dw_zonas from datawindow within w_info_embarque_zonavardestsem
end type
type cbx_zonas from checkbox within w_info_embarque_zonavardestsem
end type
type st_16 from statictext within w_info_embarque_zonavardestsem
end type
type cbx_zonascons from checkbox within w_info_embarque_zonavardestsem
end type
type st_variedad from statictext within w_info_embarque_zonavardestsem
end type
type cbx_merccons from checkbox within w_info_embarque_zonavardestsem
end type
type st_envase from statictext within w_info_embarque_zonavardestsem
end type
type cbx_envase from checkbox within w_info_embarque_zonavardestsem
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_embarque_zonavardestsem
end type
type uo_selespecie from uo_seleccion_especie within w_info_embarque_zonavardestsem
end type
type cbx_varirotula from checkbox within w_info_embarque_zonavardestsem
end type
type uo_selproductor from uo_seleccion_varios_productores_clientes within w_info_embarque_zonavardestsem
end type
end forward
...
global w_info_embarque_zonavardestsem w_info_embarque_zonavardestsem
...
on w_info_embarque_zonavardestsem.create
int iCurrent
call super::create
...
on w_info_embarque_zonavardestsem.destroy
call super::destroy
destroy(this.st_4)
...
type st_computador from w_para_informes`st_computador within w_info_embarque_zonavardestsem
end type

type st_usuario from w_para_informes`st_usuario within w_info_embarque_zonavardestsem
end type

type st_temporada from w_para_informes`st_temporada within w_info_embarque_zonavardestsem
end type

type p_logo from w_para_informes`p_logo within w_info_embarque_zonavardestsem
end type

type st_titulo from w_para_informes`st_titulo within w_info_embarque_zonavardestsem
integer width = 3122
string text = "Embarque Zonas/Variedad/Destinos/Semanas"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_embarque_zonavardestsem
integer x = 3497
integer y = 1232
...
istr_info.titulo	= 'EMBARQUES POR ZONAS/VARIEDAD/DESTINO/SEMANAS'

OpenWithParm(vinf, istr_info)
vinf.dw_1.DataObject = "dw_info_embarque_semanal_02"
...
type pb_salir from w_para_informes`pb_salir within w_info_embarque_zonavardestsem
integer x = 3493
integer y = 1520
integer height = 140
