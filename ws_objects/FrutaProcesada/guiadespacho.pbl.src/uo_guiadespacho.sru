...
Else
	...
	of_InsertaRegistro('xObservaciones1', Mid(ids_Source_Frut.Object.defe_glosas[1], 1, 120))
	...
	For ll_Fila = 1 To ids_Source_Frut.RowCount()
		...
		ls_Referencia += '' + _SeparadorDTE
		ls_Referencia += '' + _SeparadorDTE
		ls_Referencia += Mid('Cajas de ' + Trim(ids_Source_Frut.Object.espe_nombre[ll_Fila]) + ' Exportación ' + Trim(ids_Source_Frut.Object.emba_codigo[ll_Fila]) + ' ' + Trim(ids_Source_Frut.Object.vari_nombre[ll_Fila]) + ' Cal.' +Trim(ids_Source_Frut.Object.pafr_calibr[ll_Fila])  + ' - ' + String(ids_Source_Frut.Object.enva_pesone[ll_Fila], '#,##0.00') + ' Kn. ' + String(ids_Source_Frut.Object.enva_pesobr[ll_Fila], '#,##0.00') + ' Kb. ' + ' CSG:' + ids_Source_Frut.Object.CSG[ll_Fila] + ' CSP:' + ids_Source_Frut.Object.CSP[ll_Fila],1,80)+ _SeparadorDTE
		ls_Referencia += 'Cajas de ' + Trim(ids_Source_Frut.Object.espe_nombre[ll_Fila]) + ' Exportación ' + Trim(ids_Source_Frut.Object.emba_codigo[ll_Fila]) + ' ' + Trim(ids_Source_Frut.Object.vari_nombre[ll_Fila]) + ' Cal.' +Trim(ids_Source_Frut.Object.pafr_calibr[ll_Fila])  + ' - ' + String(ids_Source_Frut.Object.enva_pesone[ll_Fila], '#,##0.00') + ' Kn. ' + String(ids_Source_Frut.Object.enva_pesobr[ll_Fila], '#,##0.00') + ' Kb. '+ ' CSG:' + ids_Source_Frut.Object.CSG[ll_Fila] + ' CSP:' + ids_Source_Frut.Object.CSP[ll_Fila] + _SeparadorDTE
