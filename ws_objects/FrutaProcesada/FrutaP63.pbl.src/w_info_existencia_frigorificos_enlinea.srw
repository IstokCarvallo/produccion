$PBExportHeader$w_info_existencia_frigorificos_enlinea.srw
forward
global type w_info_existencia_frigorificos_enlinea from w_para_informes
end type
type dw_cliente from datawindow within w_info_existencia_frigorificos_enlinea
end type
type st_6 from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_4 from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_especie from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_nro2 from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_variedad from statictext within w_info_existencia_frigorificos_enlinea
end type
type rb_variedad from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_embalaje from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_pallet from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type st_productor from statictext within w_info_existencia_frigorificos_enlinea
end type
type rb_palletcal from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_1 from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_inspeccion from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type cbx_status from checkbox within w_info_existencia_frigorificos_enlinea
end type
type dw_stat from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_1 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_2 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_3 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_4 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_5 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type dw_6 from datawindow within w_info_existencia_frigorificos_enlinea
end type
type rb_controltodos from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_rechazados from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_objetados from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type rb_habilitado from radiobutton within w_info_existencia_frigorificos_enlinea
end type
type gb_6 from groupbox within w_info_existencia_frigorificos_enlinea
end type
type st_2 from statictext within w_info_existencia_frigorificos_enlinea
end type
type rb_predio from checkbox within w_info_existencia_frigorificos_enlinea
end type
type st_3 from statictext within w_info_existencia_frigorificos_enlinea
end type
type dw_categoria from datawindow within w_info_existencia_frigorificos_enlinea
end type
type st_5 from statictext within w_info_existencia_frigorificos_enlinea
end type
type cbx_categoria from checkbox within w_info_existencia_frigorificos_enlinea
end type
type uo_selespecie from uo_seleccion_especie within w_info_existencia_frigorificos_enlinea
end type
type uo_selvariedad from uo_seleccion_variedad within w_info_existencia_frigorificos_enlinea
end type
type cbx_varirotula from checkbox within w_info_existencia_frigorificos_enlinea
end type
type cbx_tipofrio from checkbox within w_info_existencia_frigorificos_enlinea
end type
type st_7 from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_9 from statictext within w_info_existencia_frigorificos_enlinea
end type
type cbx_archivo from checkbox within w_info_existencia_frigorificos_enlinea
end type
type dw_excel from datawindow within w_info_existencia_frigorificos_enlinea
end type
type cbx_packing from checkbox within w_info_existencia_frigorificos_enlinea
end type
type cbx_calibre from checkbox within w_info_existencia_frigorificos_enlinea
end type
type uo_selproductor from uo_seleccion_varios_productores within w_info_existencia_frigorificos_enlinea
end type
type st_1 from statictext within w_info_existencia_frigorificos_enlinea
end type
type st_8 from statictext within w_info_existencia_frigorificos_enlinea
end type
type ddlb_calificacion from dropdownlistbox within w_info_existencia_frigorificos_enlinea
end type
type cbx_consolcalifi from checkbox within w_info_existencia_frigorificos_enlinea
end type
type cbx_todcalifi from checkbox within w_info_existencia_frigorificos_enlinea
end type
type st_embalaje from statictext within w_info_existencia_frigorificos_enlinea
end type
type em_embalaje from singlelineedit within w_info_existencia_frigorificos_enlinea
end type
type cb_buscaembalaje from commandbutton within w_info_existencia_frigorificos_enlinea
end type
type cbx_embalaje from checkbox within w_info_existencia_frigorificos_enlinea
end type
type gb_3 from groupbox within w_info_existencia_frigorificos_enlinea
end type
type st_nro3 from statictext within w_info_existencia_frigorificos_enlinea
end type
end forward
...
global w_info_existencia_frigorificos_enlinea w_info_existencia_frigorificos_enlinea
...
on w_info_existencia_frigorificos_enlinea.create
int iCurrent
call super::create
...
this.Control[iCurrent+7]=this.rb_variedad
this.Control[iCurrent+8]=this.rb_embalaje
this.Control[iCurrent+9]=this.rb_pallet
this.Control[iCurrent+10]=this.st_productor
this.Control[iCurrent+11]=this.rb_palletcal
this.Control[iCurrent+12]=this.rb_1
this.Control[iCurrent+13]=this.rb_inspeccion
this.Control[iCurrent+14]=this.cbx_status
...
this.Control[iCurrent+22]=this.rb_controltodos
this.Control[iCurrent+23]=this.rb_rechazados
this.Control[iCurrent+24]=this.rb_objetados
this.Control[iCurrent+25]=this.rb_habilitado
this.Control[iCurrent+26]=this.gb_6
this.Control[iCurrent+27]=this.st_2
this.Control[iCurrent+28]=this.rb_predio
this.Control[iCurrent+29]=this.st_3
this.Control[iCurrent+30]=this.dw_categoria
this.Control[iCurrent+31]=this.st_5
this.Control[iCurrent+32]=this.cbx_categoria
...
this.Control[iCurrent+36]=this.cbx_tipofrio
this.Control[iCurrent+37]=this.st_7
this.Control[iCurrent+38]=this.st_9
this.Control[iCurrent+39]=this.cbx_archivo
this.Control[iCurrent+40]=this.dw_excel
this.Control[iCurrent+41]=this.cbx_packing
this.Control[iCurrent+42]=this.cbx_calibre
this.Control[iCurrent+43]=this.uo_selproductor
this.Control[iCurrent+44]=this.st_1
this.Control[iCurrent+45]=this.st_8
this.Control[iCurrent+46]=this.ddlb_calificacion
this.Control[iCurrent+47]=this.cbx_consolcalifi
this.Control[iCurrent+48]=this.cbx_todcalifi
this.Control[iCurrent+49]=this.st_embalaje
this.Control[iCurrent+50]=this.em_embalaje
this.Control[iCurrent+51]=this.cb_buscaembalaje
this.Control[iCurrent+52]=this.cbx_embalaje
this.Control[iCurrent+53]=this.gb_3
this.Control[iCurrent+54]=this.st_nro3
end on

on w_info_existencia_frigorificos_enlinea.destroy
call super::destroy
...
dw_stat.Object.stat_codigo.BackGround.Color	=	RGB(192, 192, 192)
...
type st_computador from w_para_informes`st_computador within w_info_existencia_frigorificos_enlinea
end type

type st_usuario from w_para_informes`st_usuario within w_info_existencia_frigorificos_enlinea
end type

type st_temporada from w_para_informes`st_temporada within w_info_existencia_frigorificos_enlinea
end type

type p_logo from w_para_informes`p_logo within w_info_existencia_frigorificos_enlinea
end type

type st_titulo from w_para_informes`st_titulo within w_info_existencia_frigorificos_enlinea
integer width = 2990
string text = "Existencia Almacenada en Frigorificos"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_existencia_frigorificos_enlinea
...
IF cbx_archivo.Checked THEN
	IF rb_variedad.checked  THEN
		IF rb_predio.Checked  THEN
			dw_excel.DataObject = "dw_info_excel_frigorificopredios_enlinea"
			lb_flag_retrieve		= true
			//1
		ELSE	
			dw_excel.DataObject = "dw_info_excel_frigorificos_enlinea"
			lb_flag_retrieve		= true
			//1
		END IF	
	END IF
	...
	ELSEIF rb_pallet.checked THEN
		dw_excel.DataObject = "dw_info_excel_frigorificos_palletpucho_enlinea"
	...
	ELSEIF rb_inspeccion.Checked THEN
		dw_excel.DataObject = "dw_info_excel_frigorificos_pallet_inspec_enlinea"
		lb_flag_retrieve		= true
		//6
	ELSEIF rb_1.Checked	THEN
		dw_excel.DataObject = "dw_info_excel_frigorificos_pallet_condi_enlinea"
		lb_flag_retrieve		= true
		//3
	END IF
...
ELSE
	IF rb_variedad.checked  THEN
		IF rb_predio.Checked  THEN
			vinf.dw_1.DataObject = "dw_existencia_frigovariedad_predio_enlinea"
			lb_flag_retrieve		= true
			//1
		ELSE	
			vinf.dw_1.DataObject = "dw_existencia_frigovariedad_enlinea"
			lb_flag_retrieve		= true
	...
	IF rb_embalaje.checked THEN
		vinf.dw_1.DataObject = "dw_existencia_frigoembalaje_enlinea"
		lb_flag_retrieve		= true
		//4
	ELSEIF rb_pallet.checked THEN
		vinf.dw_1.DataObject = "dw_existencia_frigopalletpucho_enlinea"
		lb_flag_retrieve		= false
		//2
	ELSEIF rb_palletcal.Checked THEN
		vinf.dw_1.DataObject = "dw_existencia_frigopalletpucho_ecal_enlinea"
		lb_flag_retrieve		= false
		//5
	ELSEIF rb_inspeccion.Checked THEN
		vinf.dw_1.DataObject = "dw_existencia_frigopalletinspeccion_enlinea"
		lb_flag_retrieve		= true
		//6
	ELSEIF rb_1.Checked	THEN
		vinf.dw_1.DataObject = "dw_existencia_frigopalletcondicion_enlinea"
		lb_flag_retrieve		= true
		//3
	END IF
END IF
...
type pb_salir from w_para_informes`pb_salir within w_info_existencia_frigorificos_enlinea
