$PBExportHeader$w_info_estadistica_plantacion.srw
$PBExportComments$Ventana de Informe de Resumen de palnillas de evaluación de descarte de fruta de packing
forward
global type w_info_estadistica_plantacion from w_para_informes
end type
type st_zona from statictext within w_info_estadistica_plantacion
end type
type st_33 from statictext within w_info_estadistica_plantacion
end type
type st_14 from statictext within w_info_estadistica_plantacion
end type
type st_2 from statictext within w_info_estadistica_plantacion
end type
type uo_muestrazona from uo_seleccion_zonas_mod within w_info_estadistica_plantacion
end type
type uo_muestraespecies from uo_seleccion_especie_mod within w_info_estadistica_plantacion
end type
type st_1 from statictext within w_info_estadistica_plantacion
end type
type uo_muestravariedad from uo_seleccion_variedad_mod within w_info_estadistica_plantacion
end type
type st_3 from statictext within w_info_estadistica_plantacion
end type
type uo_muestraproductor from uo_seleccion_productor_mod within w_info_estadistica_plantacion
end type
type st_5 from statictext within w_info_estadistica_plantacion
end type
type st_6 from statictext within w_info_estadistica_plantacion
end type
type uo_muestraagronomo from uo_seleccion_agronomo_mod within w_info_estadistica_plantacion
end type
type uo_muestratipoprod from uo_seleccion_tipoproductor_mod within w_info_estadistica_plantacion
end type
type st_44 from statictext within w_info_estadistica_plantacion
end type
end forward

global type w_info_estadistica_plantacion from w_para_informes
string tag = "Consulta Estadisticas de Plantación - Predios/Cuarteles"
integer x = 14
integer y = 32
integer width = 2629
integer height = 1652
string title = "INFORME - ESTADISTICAS DE PLANTACION PREDIOS CUARTELES"
...
global w_info_estadistica_plantacion w_info_estadistica_plantacion
...
on w_info_estadistica_plantacion.create
int iCurrent
call super::create
...
this.Control[iCurrent+13]=this.uo_muestraagronomo
this.Control[iCurrent+14]=this.uo_muestratipoprod
this.Control[iCurrent+15]=this.st_44
end on

on w_info_estadistica_plantacion.destroy
call super::destroy
...
type pb_excel from w_para_informes`pb_excel within w_info_estadistica_plantacion
end type

type st_computador from w_para_informes`st_computador within w_info_estadistica_plantacion
integer x = 1536
end type

type st_usuario from w_para_informes`st_usuario within w_info_estadistica_plantacion
integer x = 1536
end type

type st_temporada from w_para_informes`st_temporada within w_info_estadistica_plantacion
integer x = 1536
end type

type p_logo from w_para_informes`p_logo within w_info_estadistica_plantacion
end type

type st_titulo from w_para_informes`st_titulo within w_info_estadistica_plantacion
boolean visible = false
integer y = 336
integer width = 1833
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_estadistica_plantacion
...
istr_info.titulo	= 'INFORME - ESTADISTICA DE PLANTACION'
...
ll_Fila = vinf.dw_1.Retrieve(uo_MuestraZona.Codigo, uo_MuestraProductor.Codigo, uo_MuestraTipoProd.Codigo, &
									uo_MuestraEspecies.Codigo, uo_MuestraVariedad.Codigo, uo_MuestraAgronomo.Codigo, -1)
...
Else
	...
	vinf.dw_1.Modify("t_numero.text = '" + '1' + "'")
	vinf.dw_1.Object.DataWindow.Zoom = 50
...
type pb_salir from w_para_informes`pb_salir within w_info_estadistica_plantacion
...
string text = "Estadistica de Plantación"
