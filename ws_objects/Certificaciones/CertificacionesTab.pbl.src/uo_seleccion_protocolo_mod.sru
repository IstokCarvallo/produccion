$PBExportHeader$uo_seleccion_protocolo_mod.sru
$PBExportComments$Objeto público para selección de Protocolo, Todos o Consolidado
forward
global type uo_seleccion_protocolo_mod from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_protocolo_mod
end type
type cbx_todos from checkbox within uo_seleccion_protocolo_mod
end type
type dw_seleccion from datawindow within uo_seleccion_protocolo_mod
end type
end forward
...
global uo_seleccion_protocolo_mod uo_seleccion_protocolo_mod
...
on uo_seleccion_protocolo_mod.create
...
on uo_seleccion_protocolo_mod.destroy
