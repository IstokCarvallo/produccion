...
SELECT   empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,
		   ...
		   empr_codgen,empr_codtra,empr_packing,empr_stusda,empr_fecsem
	INTO  :empr_razsoc,:empr_nombre,:empr_rutemp,:empr_direcc,:empr_comuna,:empr_ciudad,&
			...
			:gi_codgen,:gi_codtra,:gi_packing,:gi_stusda,:gd_fecultsemana
	FROM dba.parempresa;
...
INTO :gd_TempoInicio,:gd_TempoTermin
...
string picturename = "\Desarrollo 17\Imagenes\Sistemas\certificaciones.jpg"
end type
