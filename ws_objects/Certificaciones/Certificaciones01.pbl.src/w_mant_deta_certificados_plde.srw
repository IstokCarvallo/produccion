$PBExportHeader$w_mant_deta_certificados_plde.srw
forward
global type w_mant_deta_certificados_plde from w_mant_detalle_csd
end type
type plb_1 from picturelistbox within w_mant_deta_certificados_plde
end type
type plb_documentos from picturelistbox within w_mant_deta_certificados_plde
end type
type st_1 from statictext within w_mant_deta_certificados_plde
end type
type pb_folder from picturebutton within w_mant_deta_certificados_plde
end type
type ddlb_filtro from dropdownlistbox within w_mant_deta_certificados_plde
end type
end forward
...
global w_mant_deta_certificados_plde w_mant_deta_certificados_plde

type variables
DatawindowChild	idwc_Predio
...
on w_mant_deta_certificados_plde.create
int iCurrent
call super::create
...
on w_mant_deta_certificados_plde.destroy
call super::destroy
destroy(this.plb_1)
...
iuo_Planta.Existe(Long(istr_mant.Argumento[1]), True, SQLCA)

dw_1.Object.plde_codigo[il_Fila] = Long(istr_mant.Argumento[1])
dw_1.Object.plde_chasag[il_Fila] = iuo_Planta.CodigoCSP
dw_1.Object.plde_insfda[il_Fila] = iuo_Planta.FDA
...
event ue_nuevo;call super::ue_nuevo;iuo_Planta.Existe(Long(istr_mant.Argumento[1]), True, SQLCA)
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_certificados_plde
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_certificados_plde
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_certificados_plde
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_certificados_plde
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_certificados_plde
integer x = 3575
integer y = 268
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_certificados_plde
integer x = 3575
integer y = 108
integer taborder = 10
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_certificados_plde
integer x = 3575
integer y = 588
boolean cancel = false
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_certificados_plde
integer x = 73
integer y = 108
integer width = 2222
integer height = 1764
integer taborder = 20
string dataobject = "dw_mant_certificacion_plde"
string icon = "AppIcon!"
end type
