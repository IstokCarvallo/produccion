...
is_ordena = 'Especie:espe_codigo,Variedad:vari_codigo,Embalaje:emba_codigo,Tipo Vida:emba_tipvid,Calibre:vaca_calibr'
...
dw_1.Retrieve(Tab_1.TabPage_1.uo_SelCliente.Codigo, Tab_1.TabPage_1.uo_SelZonas.Codigo)
...
event pb_filtrar::clicked;call super::clicked;dw_1.Retrieve(Tab_1.TabPage_1.uo_SelCliente.Codigo, Tab_1.TabPage_1.uo_SelZonas.Codigo)
end event
