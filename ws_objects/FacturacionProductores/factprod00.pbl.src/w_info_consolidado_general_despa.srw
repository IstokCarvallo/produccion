...
type uo_selproductor from uo_seleccion_varios_productores within w_info_consolidado_general_despa
end type
...
event pb_acepta::clicked;Long	  	ll_Fila, li_varirotula
...
ll_Fila	=	vinf.dw_1.Retrieve(ii_Cliente, ii_Operacion, uo_selespecie.Codigo, &
										 ii_Planta, ii_PlantaDestino, &
...
istr_mant.argumento[13]	=	This.Text
end event
...
istr_mant.argumento[14]	=	This.Text
end event
