...
type variables
DataWindowChild	idwc_especie, idwc_variedad, idwc_calibre, idwc_cliente, idwc_zona
...
ls_calibre	= dw_1.Object.vaca_calibr[il_fila]
...
IF istr_mant.Agrega = False THEN
	idwc_variedad.Retrieve(Integer(istr_mant.argumento[10]))
	idwc_calibre.Retrieve(Integer(istr_mant.argumento[10]), Integer(istr_mant.argumento[11]))
