...
event ue_datosempresa;call super::ue_datosempresa;String	empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,empr_nrotel, &
			empr_nrofax,empr_repleg,empr_rutrle,empr_oficin,empr_clibas

SELECT empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,empr_nrotel,empr_nrofax,empr_repleg,empr_rutrle,empr_codexp,empr_codplt,empr_oficin,empr_clibas
INTO :empr_razsoc,:empr_nombre,:empr_rutemp,:empr_direcc,:empr_comuna,:empr_ciudad,:empr_giroem,:empr_nrotel,:empr_nrofax,:empr_repleg,:empr_rutrle,:gi_codexport,:gi_codplanta,:empr_oficin,:gi_cliebase
	FROM dbo.parempresa;
...
string picturename = "\Desarrollo 17\Imagenes\Sistemas\facturacion_productores.jpg"
end type
