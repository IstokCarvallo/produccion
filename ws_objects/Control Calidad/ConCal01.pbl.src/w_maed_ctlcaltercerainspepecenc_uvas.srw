$PBExportHeader$w_maed_ctlcaltercerainspepecenc_uvas.srw
$PBExportComments$Encabezado de Ingreso de Inspección de Lotes Objetados
forward
global type w_maed_ctlcaltercerainspepecenc_uvas from w_mant_encab_deta_csd
end type
type dw_3 from uo_dw within w_maed_ctlcaltercerainspepecenc_uvas
end type
end forward
...
integer width = 4306
integer height = 2016
string title = "PALLET  RECHAZADOS"
string menuname = ""
boolean minbox = false
dw_3 dw_3
end type
global w_maed_ctlcaltercerainspepecenc_uvas w_maed_ctlcaltercerainspepecenc_uvas
...
SELECT	Count(*)
	...
	WHERE	( cctd_embal1 < ai_valor) 
	OR ( cctd_embal2 < ai_valor) 
	OR ( cctd_embal3 < ai_valor);
...
on w_maed_ctlcaltercerainspepecenc_uvas.create
int iCurrent
call super::create
...
on w_maed_ctlcaltercerainspepecenc_uvas.destroy
call super::destroy
destroy(this.dw_3)
end on
...
Else
	...
	Else
		...
		If dw_2.GetItemStatus(1,0,Primary!) = New! OR &
			...
			UPDATE 	dbo.ctlcalotesobjetadosenc
				SET 	ccte_numero = 1
				WHERE	ccte_numero = 1
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_ctlcaltercerainspepecenc_uvas
...
string dataobject = "dw_mues_ctlcaltercerainspe_uvas"
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 398
integer y = 36
integer width = 3063
integer height = 412
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 408
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 588
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 772
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 948
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 1128
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3954
integer y = 1420
integer taborder = 90
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3945
integer y = 1592
integer taborder = 100
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_ctlcaltercerainspepecenc_uvas
integer x = 3941
integer y = 228
end type
