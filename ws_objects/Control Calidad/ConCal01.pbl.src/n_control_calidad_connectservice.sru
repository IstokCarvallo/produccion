$PBExportHeader$n_control_calidad_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_control_calidad_connectservice from nonvisualobject
end type
end forward

global type n_control_calidad_connectservice from nonvisualobject
end type
global n_control_calidad_connectservice n_control_calidad_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm",		"ConnectString='DSN=Local Produccion_2000;UID=RSanhueza;PWD=prag'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=Local Produccion_2000;UID=RSanhueza;PWD=prag'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		as_dbparm		= "ConnectString='DSN=Local Produccion_2000;UID=RSanhueza;PWD=prag'"
		as_lock			= ""
		as_autocommit	= "false"
...
on n_control_calidad_connectservice.create
TriggerEvent( this, "constructor" )
end on

on n_control_calidad_connectservice.destroy
