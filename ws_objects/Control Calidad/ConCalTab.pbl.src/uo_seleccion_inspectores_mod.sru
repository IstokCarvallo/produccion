$PBExportHeader$uo_seleccion_inspectores_mod.sru
$PBExportComments$Objeto público para selección de Productor, Todos o Consolidado
forward
global type uo_seleccion_inspectores_mod from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_inspectores_mod
end type
type cbx_todos from checkbox within uo_seleccion_inspectores_mod
end type
type dw_seleccion from datawindow within uo_seleccion_inspectores_mod
end type
end forward
...
global uo_seleccion_inspectores_mod uo_seleccion_inspectores_mod
...
IF idwc_Seleccion.Retrieve(ai_zona) = 0 THEN
	MessageBox("Atención", "No existen Agrónomos para Zona seleccionada.")
...
on uo_seleccion_inspectores_mod.create
...
on uo_seleccion_inspectores_mod.destroy
