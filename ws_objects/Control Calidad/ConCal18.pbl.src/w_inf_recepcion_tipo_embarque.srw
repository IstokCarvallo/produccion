...
type dw_1 from uo_dw within w_inf_recepcion_tipo_embarque
end type
...
this.Control[iCurrent+17]=this.rb_planta
this.Control[iCurrent+18]=this.rb_prod
this.Control[iCurrent+19]=this.rb_existencia
this.Control[iCurrent+20]=this.st_44
this.Control[iCurrent+21]=this.st_8
this.Control[iCurrent+22]=this.uo_selcamara
...
event clicked;Integer	li_fila, li_brix, li_firmeza, li_exporta, li_embarque
Date		ld_FechaEmbaini, ld_FechaEmbafin
...
ls_Archivo = '\RecepcionResumen_' + iuo_Especie.Nombre + '.xls'
...
If iuo_Especie.Codigo = 21  Then
	dw_1.DataObject = "dw_info_rececpcion_tipo_embarque_excel"
Else
...
li_fila = dw_1.Retrieve(uo_SelVariedad.Codigo, uo_SelZona.Codigo, uo_SelPlanta.Codigo, uo_Selproductor.Codigo, -1,&
		 Integer(istr_Mant.Argumento[3]),ld_FechaEmbaini,ld_FechaEmbafin,&
		 Integer(istr_Mant.Argumento[1]),Integer(istr_Mant.Argumento[2]),li_embarque, iuo_Especie.Codigo)
