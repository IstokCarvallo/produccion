$PBExportHeader$w_mant_deta_ctlcalplanillanaranjas.srw
forward
global type w_mant_deta_ctlcalplanillanaranjas from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillanaranjas
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillanaranjas
end type
end forward
...
global w_mant_deta_ctlcalplanillanaranjas w_mant_deta_ctlcalplanillanaranjas
...
on w_mant_deta_ctlcalplanillanaranjas.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillanaranjas.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
ELSEIF li_especie = 36 THEN
	dw_1.Object.t_titulo.text = "Digitación Planilla Verificación de Mandarinas"
ELSE
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillanaranjas
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillanaranjas
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillanaranjas
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillanaranjas
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillanaranjas
integer x = 3008
integer y = 344
integer taborder = 40
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillanaranjas
integer x = 3003
integer y = 156
integer taborder = 30
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillanaranjas
integer x = 3003
integer y = 532
integer taborder = 50
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillanaranjas
integer y = 116
integer width = 2779
integer height = 604
