$PBExportHeader$w_mant_deta_ctlcalplanillapaltas.srw
forward
global type w_mant_deta_ctlcalplanillapaltas from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillapaltas
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillapaltas
end type
end forward
...
global w_mant_deta_ctlcalplanillapaltas w_mant_deta_ctlcalplanillapaltas
...
public subroutine sumadefectos ()
end prototypes
...
public subroutine sumadefectos ();Decimal	ld_Total = 0

dw_3.accepttext()
dw_4.accepttext()

IF Not IsNull(dw_3.Object.cpvd_calmen[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_calmen[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_calmay[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_calmay[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_color3[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_color3[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_colvir[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_colvir[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_deform[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_deform[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_russet[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_russet[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_mancha[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_mancha[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_golsol[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_golsol[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_quesol[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_quesol[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_heridas[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_heridas[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_pedlar[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_pedlar[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_escama[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_escama[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_insect[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_insect[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_medlun[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_medlun[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_residu[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_residu[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_otrcal[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_otrcal[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_matext[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_matext[il_Fila]
IF Not IsNull(dw_3.Object.cpvd_fumagi[il_Fila]) THEN ld_Total = ld_Total + dw_3.Object.cpvd_fumagi[il_Fila]

IF Not IsNull(dw_4.Object.cpvd_herabi[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_herabi[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_ausped[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_ausped[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_desgap[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_desgap[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_machuc[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_machuc[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_pudric[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_pudric[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_deship[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_deship[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_frubla[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_frubla[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_dafrio[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_dafrio[il_Fila]
IF Not IsNull(dw_4.Object.cpvd_otrcon[il_Fila]) THEN ld_Total = ld_Total + dw_4.Object.cpvd_otrcon[il_Fila]


dw_4.Object.cpvd_portot[il_Fila]	=	ld_Total
end subroutine

on w_mant_deta_ctlcalplanillapaltas.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillapaltas.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
If IsNull(dw_2.object.cpvd_aparie[il_fila]) OR dw_2.object.cpvd_aparie[il_fila] = '' Then
	li_cont ++
	ls_mensaje		 	= ls_mensaje + "~rApariencia"
	ls_colu[li_cont] 	= "cpvd_aparie"
End If
...
If li_cont > 0 Then
	...
	dw_4.SetFocus()
	Message.DoubleParm = -1
ELSEIf Round(dw_3.Object.cpvd_color3[il_fila],1) > 99.9 Then
	MessageBox("Error de Consistencia", "Falta de Color no puede ser > a 99 :" + ls_mensaje + ".", StopSign!, Ok!)
	dw_3.SetColumn("cpvd_color3") 
	dw_3.SetFocus()
	Message.DoubleParm = -1
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillapaltas
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillapaltas
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillapaltas
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillapaltas
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillapaltas
integer x = 2962
integer y = 344
integer taborder = 50
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillapaltas
integer x = 2958
integer y = 156
integer taborder = 40
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillapaltas
integer x = 2958
integer y = 532
integer taborder = 60
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillapaltas
integer y = 116
integer width = 2597
integer height = 636
string dataobject = "dw_mant_ctlcalplanillapaltas"
end type
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "dw_mant_ctlcalplanillapaltas_embalaje"
...
integer height = 788
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillapaltas_calidad"
boolean vscrollbar = false
end type
...
integer height = 896
long backcolor = 16711680
string text = "Condición (% de Frutos)"
long tabtextcolor = 33554432
long tabbackcolor = 12632256
long picturemaskcolor = 536870912
dw_condicion dw_condicion
...
integer height = 712
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillapaltas_condicion"
boolean vscrollbar = false
end type
...
integer height = 480
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillapaltas_resol"
boolean vscrollbar = false
end type
...
CHOOSE CASE ls_Columna			
	...
	CASE "ccpd_rescaj"
		IF data = 'O' THEN		
			...
			SetColumn("ccda_secuen")
		ELSE	
			This.Object.ccda_secuen.protect = 1             
			This.Object.ccda_secuen.BackGround.Color	=	RGB(192,192,192)
			Tab_1.TabPage_4.dw_resolucion.Setitem(il_fila, "ccda_secuen",li_Nula)									
		END IF		
		
	CASE "ccda_secuen"		
		IF NOT Resulcaj(Integer(data)) THEN
			Tab_1.TabPage_4.dw_resolucion.Setitem(row, "ccda_secuen",li_Nula)				
			RETURN 1 			
		END IF 							
END CHOOSE
