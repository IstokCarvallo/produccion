$PBExportHeader$w_mant_deta_ctlcalplanillalimones.srw
forward
global type w_mant_deta_ctlcalplanillalimones from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillalimones
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillalimones
end type
end forward
...
global w_mant_deta_ctlcalplanillalimones w_mant_deta_ctlcalplanillalimones
...
on w_mant_deta_ctlcalplanillalimones.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillalimones.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
If li_cont > 0 Then
	...
	dw_4.SetFocus()
	Message.DoubleParm = -1
ElseIf Round(dw_5.Object.cpvd_portot[il_fila],1) > 99.9 Then
	MessageBox("Error de Consistencia", "% Total Defectos no puede ser > a 99,9 :" + ls_mensaje + ".", StopSign!, Ok!)
...
IF li_especie = 26 THEN
	dw_1.Object.t_titulo.text = "Digitación Planilla Verificación de Clementinas"
ELSEIF li_especie = 27 THEN
	dw_1.Object.t_titulo.text = "Digitación Planilla Verificación de Naranjas"
ELSE
	dw_1.Object.t_titulo.text = "Digitación Planilla Verificación de Limones"
END IF
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillalimones
string picturename = "\Desarrollo 12\Imagenes\Botones\PaginaUltimaEnab.bmp"
string disabledname = "\Desarrollo 12\Imagenes\Botones\PaginaUltimadis.bmp"
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillalimones
string picturename = "\Desarrollo 12\Imagenes\Botones\PaginaSigteEnab.bmp"
string disabledname = "\Desarrollo 12\Imagenes\Botones\PaginaSigtedis.bmp"
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillalimones
string picturename = "\Desarrollo 12\Imagenes\Botones\PaginaAnteriorEnab.BMP"
string disabledname = "\Desarrollo 12\Imagenes\Botones\PaginaAnteriordis.BMP"
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillalimones
string picturename = "\Desarrollo 12\Imagenes\Botones\PaginaPrimeraEnab.bmp"
string disabledname = "\Desarrollo 12\Imagenes\Botones\PaginaPrimeradis.bmp"
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillalimones
integer x = 2958
integer y = 332
integer taborder = 40
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillalimones
integer x = 2958
integer y = 132
integer taborder = 30
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillalimones
integer x = 2958
integer y = 532
integer taborder = 50
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillalimones
integer y = 116
integer width = 2807
integer height = 628
...
integer height = 764
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillalimones_calidad"
boolean vscrollbar = false
end type
...
integer height = 740
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillalimones_condicion"
boolean vscrollbar = false
end type
...
integer height = 768
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillanaranjas_resol"
boolean vscrollbar = false
end type
