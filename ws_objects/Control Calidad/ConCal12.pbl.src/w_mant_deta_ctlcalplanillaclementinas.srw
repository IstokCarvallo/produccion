$PBExportHeader$w_mant_deta_ctlcalplanillaclementinas.srw
forward
global type w_mant_deta_ctlcalplanillaclementinas from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillaclementinas
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillaclementinas
end type
end forward
...
global w_mant_deta_ctlcalplanillaclementinas w_mant_deta_ctlcalplanillaclementinas
...
on w_mant_deta_ctlcalplanillaclementinas.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillaclementinas.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillaclementinas
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillaclementinas
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillaclementinas
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillaclementinas
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillaclementinas
integer x = 2958
integer y = 332
integer taborder = 40
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillaclementinas
integer x = 2958
integer y = 132
integer taborder = 30
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillaclementinas
integer x = 2958
integer y = 532
integer taborder = 50
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillaclementinas
integer y = 116
integer width = 2807
integer height = 628
...
integer height = 764
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillanaranjas_calidad"
boolean vscrollbar = false
end type
...
integer height = 740
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillanaranjas_condicion"
boolean vscrollbar = false
end type
