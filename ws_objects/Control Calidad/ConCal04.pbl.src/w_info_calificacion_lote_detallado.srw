$PBExportHeader$w_info_calificacion_lote_detallado.srw
$PBExportComments$Ventana de Informe de Calificación de lote detallado
forward
global type w_info_calificacion_lote_detallado from w_para_informes
end type
type st_1 from statictext within w_info_calificacion_lote_detallado
end type
type em_fechadesde from editmask within w_info_calificacion_lote_detallado
end type
type st_12 from statictext within w_info_calificacion_lote_detallado
end type
type st_13 from statictext within w_info_calificacion_lote_detallado
end type
type em_fechahasta from editmask within w_info_calificacion_lote_detallado
end type
type st_zona from statictext within w_info_calificacion_lote_detallado
end type
type dw_zona from datawindow within w_info_calificacion_lote_detallado
end type
type cbx_todoplanta from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_consplanta from checkbox within w_info_calificacion_lote_detallado
end type
type dw_planta from datawindow within w_info_calificacion_lote_detallado
end type
type st_33 from statictext within w_info_calificacion_lote_detallado
end type
type dw_productor from datawindow within w_info_calificacion_lote_detallado
end type
type cbx_todoprod from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_consprod from checkbox within w_info_calificacion_lote_detallado
end type
type st_2 from statictext within w_info_calificacion_lote_detallado
end type
type dw_agronomo from datawindow within w_info_calificacion_lote_detallado
end type
type dw_variedades from datawindow within w_info_calificacion_lote_detallado
end type
type cbx_todosvar from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_consvariedad from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_todoszona from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_conszonas from checkbox within w_info_calificacion_lote_detallado
end type
type st_3 from statictext within w_info_calificacion_lote_detallado
end type
type cbx_todosagro from checkbox within w_info_calificacion_lote_detallado
end type
type st_5 from statictext within w_info_calificacion_lote_detallado
end type
type dw_packing from datawindow within w_info_calificacion_lote_detallado
end type
type cbx_todospacking from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_conspacking from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_consfecha from checkbox within w_info_calificacion_lote_detallado
end type
type st_6 from statictext within w_info_calificacion_lote_detallado
end type
type em_embalaje from editmask within w_info_calificacion_lote_detallado
end type
type cb_buscaembalaje from commandbutton within w_info_calificacion_lote_detallado
end type
type em_descripcion from editmask within w_info_calificacion_lote_detallado
end type
type cbx_todosemb from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_consembalaje from checkbox within w_info_calificacion_lote_detallado
end type
type st_7 from statictext within w_info_calificacion_lote_detallado
end type
type cbx_todoscalibre from checkbox within w_info_calificacion_lote_detallado
end type
type cbx_conscalibre from checkbox within w_info_calificacion_lote_detallado
end type
type em_calibre from editmask within w_info_calificacion_lote_detallado
end type
type gb_4 from groupbox within w_info_calificacion_lote_detallado
end type
type st_8 from statictext within w_info_calificacion_lote_detallado
end type
type cbx_consagro from checkbox within w_info_calificacion_lote_detallado
end type
type gb_5 from groupbox within w_info_calificacion_lote_detallado
end type
type st_44 from statictext within w_info_calificacion_lote_detallado
end type
type st_9 from statictext within w_info_calificacion_lote_detallado
end type
type st_10 from statictext within w_info_calificacion_lote_detallado
end type
type st_11 from statictext within w_info_calificacion_lote_detallado
end type
type dw_especie from datawindow within w_info_calificacion_lote_detallado
end type
type st_4 from statictext within w_info_calificacion_lote_detallado
end type
end forward
...
integer width = 3534
integer height = 2140
string title = "Calificación y Resolución de Lotes  Detallado"
...
global w_info_calificacion_lote_detallado w_info_calificacion_lote_detallado
...
on w_info_calificacion_lote_detallado.create
int iCurrent
call super::create
...
this.Control[iCurrent+28]=this.cbx_consfecha
this.Control[iCurrent+29]=this.st_6
this.Control[iCurrent+30]=this.em_embalaje
this.Control[iCurrent+31]=this.cb_buscaembalaje
this.Control[iCurrent+32]=this.em_descripcion
this.Control[iCurrent+33]=this.cbx_todosemb
this.Control[iCurrent+34]=this.cbx_consembalaje
this.Control[iCurrent+35]=this.st_7
this.Control[iCurrent+36]=this.cbx_todoscalibre
this.Control[iCurrent+37]=this.cbx_conscalibre
this.Control[iCurrent+38]=this.em_calibre
this.Control[iCurrent+39]=this.gb_4
this.Control[iCurrent+40]=this.st_8
this.Control[iCurrent+41]=this.cbx_consagro
this.Control[iCurrent+42]=this.gb_5
this.Control[iCurrent+43]=this.st_44
this.Control[iCurrent+44]=this.st_9
this.Control[iCurrent+45]=this.st_10
this.Control[iCurrent+46]=this.st_11
this.Control[iCurrent+47]=this.dw_especie
this.Control[iCurrent+48]=this.st_4
end on

on w_info_calificacion_lote_detallado.destroy
call super::destroy
destroy(this.st_1)
...
idwc_especie.SetSort("plde_nombre A")
idwc_especie.Sort()
...
type st_computador from w_para_informes`st_computador within w_info_calificacion_lote_detallado
integer x = 2391
integer y = 152
end type

type st_usuario from w_para_informes`st_usuario within w_info_calificacion_lote_detallado
integer x = 2391
integer y = 80
end type

type st_temporada from w_para_informes`st_temporada within w_info_calificacion_lote_detallado
integer x = 2391
integer y = 8
end type

type p_logo from w_para_informes`p_logo within w_info_calificacion_lote_detallado
end type

type st_titulo from w_para_informes`st_titulo within w_info_calificacion_lote_detallado
integer x = 315
integer y = 244
integer width = 2546
string text = "Calificación y Resolución de Lotes Detallado"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_calificacion_lote_detallado
...
istr_info.titulo	= 'INFORME DE CALIFICACIÓN Y RESOLUCIÓN DE LOTES DETALLADO'
OpenWithParm(vinf,istr_info)

IF iuo_especie.codigo = 11 THEN
   vinf.dw_1.DataObject = "dw_info_calificacion_lote_detallado"
ELSEIF iuo_especie.codigo <> 11 THEN
	vinf.dw_1.DataObject = "dw_informe_calificacion_lotes_detallado"
END IF
...
type pb_salir from w_para_informes`pb_salir within w_info_calificacion_lote_detallado
...
IF NOT iuo_variedades.existe(dw_especie.Object.espe_codigo[1],Integer(data),True,sqlca) THEN
...
event clicked;IF cbx_consfecha.Checked THEN
