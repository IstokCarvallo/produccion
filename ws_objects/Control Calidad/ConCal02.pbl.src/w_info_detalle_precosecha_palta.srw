$PBExportHeader$w_info_detalle_precosecha_palta.srw
$PBExportComments$Informe_General_Planilla_Cuantitativa
forward
global type w_info_detalle_precosecha_palta from w_para_informes
end type
type gb_6 from groupbox within w_info_detalle_precosecha_palta
end type
type st_33 from statictext within w_info_detalle_precosecha_palta
end type
type st_zona from statictext within w_info_detalle_precosecha_palta
end type
type st_variedad from statictext within w_info_detalle_precosecha_palta
end type
type em_fechaemb from editmask within w_info_detalle_precosecha_palta
end type
type em_fechahasta from editmask within w_info_detalle_precosecha_palta
end type
type st_desdeins from statictext within w_info_detalle_precosecha_palta
end type
type st_hastains from statictext within w_info_detalle_precosecha_palta
end type
type cbx_fechaemba from checkbox within w_info_detalle_precosecha_palta
end type
type st_2 from statictext within w_info_detalle_precosecha_palta
end type
type st_4 from statictext within w_info_detalle_precosecha_palta
end type
type st_6 from statictext within w_info_detalle_precosecha_palta
end type
type st_44 from statictext within w_info_detalle_precosecha_palta
end type
type uo_selzonas from uo_seleccion_zonas_mod within w_info_detalle_precosecha_palta
end type
type uo_selvariedad from uo_seleccion_variedad_mod within w_info_detalle_precosecha_palta
end type
type uo_selproductor from uo_seleccion_productor_zonas_mod within w_info_detalle_precosecha_palta
end type
type st_1 from statictext within w_info_detalle_precosecha_palta
end type
type uo_selpredio from uo_seleccion_prodpredio_mod within w_info_detalle_precosecha_palta
end type
end forward
...
global w_info_detalle_precosecha_palta w_info_detalle_precosecha_palta
...
on w_info_detalle_precosecha_palta.create
int iCurrent
call super::create
...
on w_info_detalle_precosecha_palta.destroy
call super::destroy
destroy(this.gb_6)
destroy(this.st_33)
...
type pb_excel from w_para_informes`pb_excel within w_info_detalle_precosecha_palta
end type

type st_computador from w_para_informes`st_computador within w_info_detalle_precosecha_palta
integer x = 1440
end type

type st_usuario from w_para_informes`st_usuario within w_info_detalle_precosecha_palta
integer x = 1440
end type

type st_temporada from w_para_informes`st_temporada within w_info_detalle_precosecha_palta
integer x = 1440
end type

type p_logo from w_para_informes`p_logo within w_info_detalle_precosecha_palta
end type

type st_titulo from w_para_informes`st_titulo within w_info_detalle_precosecha_palta
integer width = 1664
string text = "Informe Detallado Precosecha"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_detalle_precosecha_palta
...
istr_info.titulo	= 'DETALLE PRECOSECHA DE PALTAS'
OpenWithParm(vinf,istr_info)

vinf.dw_1.DataObject = "dw_info_detalleprecosecha_paltas"	
vinf.dw_1.SetTransObject(sqlca)

li_fila = vinf.dw_1.Retrieve(uo_SelZonas.Codigo, uo_SelProductor.Codigo, 81, uo_SelVariedad.Codigo, uo_SelPredio.Codigo, ld_Desde, ld_Hasta)
...
type pb_salir from w_para_informes`pb_salir within w_info_detalle_precosecha_palta
