$PBExportHeader$w_info_general_inspec_resolucion.srw
$PBExportComments$Ventana de Informe General de Revisión Inspección y Resolución
forward
global type w_info_general_inspec_resolucion from w_para_informes
end type
type st_1 from statictext within w_info_general_inspec_resolucion
end type
type st_13 from statictext within w_info_general_inspec_resolucion
end type
type em_fechahasta from editmask within w_info_general_inspec_resolucion
end type
type st_zona from statictext within w_info_general_inspec_resolucion
end type
type dw_zona from datawindow within w_info_general_inspec_resolucion
end type
type cbx_todoplanta from checkbox within w_info_general_inspec_resolucion
end type
type dw_planta from datawindow within w_info_general_inspec_resolucion
end type
type st_33 from statictext within w_info_general_inspec_resolucion
end type
type dw_tecnico from datawindow within w_info_general_inspec_resolucion
end type
type cbx_todoszona from checkbox within w_info_general_inspec_resolucion
end type
type cbx_todosagro from checkbox within w_info_general_inspec_resolucion
end type
type cbx_todosfecha from checkbox within w_info_general_inspec_resolucion
end type
type st_12 from statictext within w_info_general_inspec_resolucion
end type
type dw_especie from datawindow within w_info_general_inspec_resolucion
end type
type cbx_espe from checkbox within w_info_general_inspec_resolucion
end type
type st_3 from statictext within w_info_general_inspec_resolucion
end type
type st_5 from statictext within w_info_general_inspec_resolucion
end type
type cbx_todoproduc from checkbox within w_info_general_inspec_resolucion
end type
type dw_prod from datawindow within w_info_general_inspec_resolucion
end type
type st_6 from statictext within w_info_general_inspec_resolucion
end type
type cbx_filtro from checkbox within w_info_general_inspec_resolucion
end type
type ddlb_filtro from dropdownlistbox within w_info_general_inspec_resolucion
end type
type cbx_todoemba from checkbox within w_info_general_inspec_resolucion
end type
type dw_emba from datawindow within w_info_general_inspec_resolucion
end type
type st_8 from statictext within w_info_general_inspec_resolucion
end type
type st_4 from statictext within w_info_general_inspec_resolucion
end type
type st_2 from statictext within w_info_general_inspec_resolucion
end type
type st_7 from statictext within w_info_general_inspec_resolucion
end type
type st_9 from statictext within w_info_general_inspec_resolucion
end type
type dw_variedad from datawindow within w_info_general_inspec_resolucion
end type
type consfrigo from checkbox within w_info_general_inspec_resolucion
end type
type consagro from checkbox within w_info_general_inspec_resolucion
end type
type cbx_todovariedad from checkbox within w_info_general_inspec_resolucion
end type
type gb_3 from groupbox within w_info_general_inspec_resolucion
end type
type rb_consol from radiobutton within w_info_general_inspec_resolucion
end type
type rb_deta from radiobutton within w_info_general_inspec_resolucion
end type
type em_fechadesde from editmask within w_info_general_inspec_resolucion
end type
type st_10 from statictext within w_info_general_inspec_resolucion
end type
type gb_4 from groupbox within w_info_general_inspec_resolucion
end type
type gb_6 from groupbox within w_info_general_inspec_resolucion
end type
type gb_5 from groupbox within w_info_general_inspec_resolucion
end type
type sle_1 from singlelineedit within w_info_general_inspec_resolucion
end type
type conszona from checkbox within w_info_general_inspec_resolucion
end type
type consprod from checkbox within w_info_general_inspec_resolucion
end type
type consvar from checkbox within w_info_general_inspec_resolucion
end type
type consemba from checkbox within w_info_general_inspec_resolucion
end type
end forward
...
integer width = 2990
integer height = 1836
string title = "Resumen Gráfico de Lotes"
...
global w_info_general_inspec_resolucion w_info_general_inspec_resolucion
...
DataWindowChild		idwc_zona, idwc_planta, idwc_cliente, idwc_tecnico, &
							idwc_especie, idwc_prod, idwc_emba, idwc_variedad
uo_zonas					iuo_zonas
...
on w_info_general_inspec_resolucion.create
int iCurrent
call super::create
...
this.Control[iCurrent+21]=this.cbx_filtro
...
this.Control[iCurrent+35]=this.rb_consol
this.Control[iCurrent+36]=this.rb_deta
this.Control[iCurrent+37]=this.em_fechadesde
this.Control[iCurrent+38]=this.st_10
this.Control[iCurrent+39]=this.gb_4
this.Control[iCurrent+40]=this.gb_6
this.Control[iCurrent+41]=this.gb_5
this.Control[iCurrent+42]=this.sle_1
this.Control[iCurrent+43]=this.conszona
this.Control[iCurrent+44]=this.consprod
this.Control[iCurrent+45]=this.consvar
this.Control[iCurrent+46]=this.consemba
end on

on w_info_general_inspec_resolucion.destroy
call super::destroy
destroy(this.st_1)
destroy(this.st_13)
...
type st_computador from w_para_informes`st_computador within w_info_general_inspec_resolucion
end type

type st_usuario from w_para_informes`st_usuario within w_info_general_inspec_resolucion
end type

type st_temporada from w_para_informes`st_temporada within w_info_general_inspec_resolucion
end type

type p_logo from w_para_informes`p_logo within w_info_general_inspec_resolucion
end type

type st_titulo from w_para_informes`st_titulo within w_info_general_inspec_resolucion
integer x = 69
integer y = 32
integer width = 2533
string text = "Resumen Gráfico de Lotes"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_general_inspec_resolucion
...
Integer	li_fila, li_planta, li_Tecnico, li_zona, li_especie, li_variedad, li_Tipo = 0
Long     ll_prod
...
IF consvar.checked THEN
	li_variedad   = 9999
ELSE
  IF cbx_todovariedad.Checked THEN
	  li_variedad	 = -1
  ELSE
...
istr_info.titulo	= 'RESUMEN GRAFICO DE LOTES'

OpenWithParm(vinf,istr_info)

IF rb_consol.Checked AND li_especie = 11 THEN
	vinf.dw_1.DataObject = "dw_info_general_inspec_grafico_gerencia"
ELSEIF rb_deta.Checked AND li_especie = 11 THEN
	vinf.dw_1.DataObject = "dw_info_gral_inspec_graf_gerencia_var"
	
	vinf.dw_1.GetChild("plde_codigo", idwc_planta)
	idwc_planta.SetTransObject(sqlca)
	...
	vinf.dw_1.GetChild("prod_codigo", idwc_prod)
	idwc_prod.SetTransObject(sqlca)
	idwc_prod.Retrieve()	
ELSEIF rb_deta.Checked AND li_especie <> 11 THEN
	vinf.dw_1.DataObject = "dw_informe_gral_inspec_graf_gerencia_var"
ELSEIF rb_consol.Checked AND li_especie <> 11 THEN
	vinf.dw_1.DataObject = "dw_informe_gral_inspec_graf_gerencia"
END IF
...
li_fila = vinf.dw_1.Retrieve(gi_codexport,li_zona, li_Planta, ld_FechaEmbaini, &
									  ...
									  ll_prod,ls_filtrolotes,ls_emba,li_Tipo)
...
type pb_salir from w_para_informes`pb_salir within w_info_general_inspec_resolucion
...
event clicked;cbx_todovariedad.Checked = False
