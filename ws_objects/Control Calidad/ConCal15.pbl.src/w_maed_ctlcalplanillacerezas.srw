$PBExportHeader$w_maed_ctlcalplanillacerezas.srw
$PBExportComments$Ingresador de antecedentes para Planilla Verificación Cerezas
forward
global type w_maed_ctlcalplanillacerezas from w_mant_encab_deta_csd
end type
type dw_3 from datawindow within w_maed_ctlcalplanillacerezas
end type
type cb_aprobar from commandbutton within w_maed_ctlcalplanillacerezas
end type
type tab_1 from tab within w_maed_ctlcalplanillacerezas
end type
...
global w_maed_ctlcalplanillacerezas w_maed_ctlcalplanillacerezas
...
public subroutine habilitaencab (boolean habilita);If Habilita Then
	...
	dw_2.Object.ccpv_numero.Color	=	0
	dw_2.Object.ccpv_fecins.Color		=	0	
	dw_2.Object.ccti_codigo.Color		=	0
	dw_2.Object.prod_codigo.Color	=	0
	dw_2.Object.vari_codigo.Color		=	0	
	dw_2.Object.ccag_codigo.Color	=	0
	dw_3.Object.vaca_calibr.Color		=	0	
	dw_3.Object.emba_codigo.Color	=	0
	dw_3.Object.cclo_fecemb.Color	=	0
...
Else
	...
	dw_2.Object.ccpv_numero.Color	=	Rgb(255,255,255)
	dw_2.Object.ccpv_fecins.Color		=	Rgb(255,255,255)
	dw_2.Object.ccti_codigo.Color		=	Rgb(255,255,255)
	dw_2.Object.prod_codigo.Color	=	Rgb(255,255,255)
	dw_2.Object.vari_codigo.Color		=	Rgb(255,255,255)
	dw_2.Object.ccag_codigo.Color	=	Rgb(255,255,255)
	dw_3.Object.vaca_calibr.Color		=	Rgb(255,255,255)
	dw_3.Object.emba_codigo.Color	=	Rgb(255,255,255)	
	dw_3.Object.cclo_fecemb.Color	=	Rgb(255,255,255)
...
on w_maed_ctlcalplanillacerezas.create
int iCurrent
call super::create
...
on w_maed_ctlcalplanillacerezas.destroy
call super::destroy
destroy(this.dw_3)
...
ElseIf iuo_Especie.Codigo = 26 Or iuo_Especie.Codigo = 27 or iuo_Especie.Codigo = 10 or iuo_Especie.Codigo = 36 Then
...
*/
UPDATE	dbo.ctlcalplaniverifideta
	SET	ccpv_numero=0
	WHERE	1=2;
...
type dw_1 from w_mant_encab_deta_csd`dw_1 within w_maed_ctlcalplanillacerezas
integer x = 105
integer y = 1020
integer width = 4594
integer height = 1192
...
type dw_2 from w_mant_encab_deta_csd`dw_2 within w_maed_ctlcalplanillacerezas
integer x = 745
integer y = 4
integer width = 3205
integer height = 704
...
type pb_nuevo from w_mant_encab_deta_csd`pb_nuevo within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 492
integer taborder = 0
end type

type pb_eliminar from w_mant_encab_deta_csd`pb_eliminar within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 672
integer taborder = 0
end type

type pb_grabar from w_mant_encab_deta_csd`pb_grabar within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 856
end type

type pb_imprimir from w_mant_encab_deta_csd`pb_imprimir within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 1032
end type

type pb_salir from w_mant_encab_deta_csd`pb_salir within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 1212
end type

type pb_ins_det from w_mant_encab_deta_csd`pb_ins_det within w_maed_ctlcalplanillacerezas
integer x = 4741
integer y = 1504
integer taborder = 30
end type

type pb_eli_det from w_mant_encab_deta_csd`pb_eli_det within w_maed_ctlcalplanillacerezas
integer x = 4741
integer y = 1676
integer taborder = 0
end type

type pb_buscar from w_mant_encab_deta_csd`pb_buscar within w_maed_ctlcalplanillacerezas
integer x = 4736
integer y = 312
integer taborder = 0
end type
