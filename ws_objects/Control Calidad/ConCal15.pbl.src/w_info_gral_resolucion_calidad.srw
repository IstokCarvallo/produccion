$PBExportHeader$w_info_gral_resolucion_calidad.srw
$PBExportComments$Ventana de Informe General de Causales Objeción
forward
global type w_info_gral_resolucion_calidad from w_para_informes
end type
type gb_3 from groupbox within w_info_gral_resolucion_calidad
end type
type st_1 from statictext within w_info_gral_resolucion_calidad
end type
type em_fechadesde from editmask within w_info_gral_resolucion_calidad
end type
type st_13 from statictext within w_info_gral_resolucion_calidad
end type
type em_fechahasta from editmask within w_info_gral_resolucion_calidad
end type
type st_zona from statictext within w_info_gral_resolucion_calidad
end type
type st_33 from statictext within w_info_gral_resolucion_calidad
end type
type cbx_todosfecha from checkbox within w_info_gral_resolucion_calidad
end type
type gb_4 from groupbox within w_info_gral_resolucion_calidad
end type
type st_2 from statictext within w_info_gral_resolucion_calidad
end type
type st_4 from statictext within w_info_gral_resolucion_calidad
end type
type st_5 from statictext within w_info_gral_resolucion_calidad
end type
type st_3 from statictext within w_info_gral_resolucion_calidad
end type
type dw_1 from uo_dw within w_info_gral_resolucion_calidad
end type
type uo_selespecie from uo_seleccion_especie within w_info_gral_resolucion_calidad
end type
type uo_selzona from uo_seleccion_zonas_mod within w_info_gral_resolucion_calidad
end type
type uo_selproductor from uo_seleccion_productor_zonas_mod within w_info_gral_resolucion_calidad
end type
type st_6 from statictext within w_info_gral_resolucion_calidad
end type
type uo_selplanta from uo_seleccion_planta_mod within w_info_gral_resolucion_calidad
end type
type uo_selpacking from uo_seleccion_plantapacking_mod within w_info_gral_resolucion_calidad
end type
type st_7 from statictext within w_info_gral_resolucion_calidad
end type
type st_12 from statictext within w_info_gral_resolucion_calidad
end type
type uo_selvari from uo_seleccion_variedad_mod within w_info_gral_resolucion_calidad
end type
type st_8 from statictext within w_info_gral_resolucion_calidad
end type
end forward
...
integer width = 2885
integer height = 1996
string title = "RESOLUCION CALIDAD"
...
global w_info_gral_resolucion_calidad w_info_gral_resolucion_calidad
...
on w_info_gral_resolucion_calidad.create
int iCurrent
call super::create
...
this.Control[iCurrent+16]=this.uo_selzona
...
on w_info_gral_resolucion_calidad.destroy
call super::destroy
destroy(this.gb_3)
destroy(this.st_1)
...
Else	
	...
	uo_SelProductor.cbx_Todos.Checked=True
	uo_SelProductor.Codigo						= -1
	uo_SelPlanta.cbx_Consolida.Checked=True
	uo_selplanta.Codigo						= -9
	...
	uo_Selpacking.Codigo						= -9
	uo_selvari.filtra(11)
...
type pb_excel from w_para_informes`pb_excel within w_info_gral_resolucion_calidad
integer x = 2501
integer y = 344
end type

type st_computador from w_para_informes`st_computador within w_info_gral_resolucion_calidad
end type

type st_usuario from w_para_informes`st_usuario within w_info_gral_resolucion_calidad
end type

type st_temporada from w_para_informes`st_temporada within w_info_gral_resolucion_calidad
end type

type p_logo from w_para_informes`p_logo within w_info_gral_resolucion_calidad
end type

type st_titulo from w_para_informes`st_titulo within w_info_gral_resolucion_calidad
integer x = 247
integer width = 2085
string text = "Resolucion Calidad"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_gral_resolucion_calidad
...
istr_info.titulo	= 'INFORME DE RESOLUCION CALIDAD' 
OpenWithParm(vinf,istr_info)

vinf.dw_1.DataObject = "dw_info_resolucion_calidad"

vinf.dw_1.SetTransObject(sqlca)


li_fila = vinf.dw_1.Retrieve(gi_CodExport, uo_selplanta.Codigo, uo_SelZona.Codigo, ld_FechaEmbaini, ld_FechaEmbafin, uo_SelEspecie.Codigo, uo_selvari.Codigo, uo_SelProductor.Codigo, uo_selpacking.Codigo )
...
type pb_salir from w_para_informes`pb_salir within w_info_gral_resolucion_calidad
...
IF uo_SelEspecie.Codigo = 11 THEN
	dw_1.DataObject = "dw_info_resolucion_calidad_excel"
ELSE
	dw_1.DataObject = "dw_info_resolucion_calidad_otrasesp_excel"
END IF
...
li_fila = dw_1.Retrieve(gi_CodExport, uo_selplanta.Codigo, uo_SelZona.Codigo, ld_FechaEmbaini, ld_FechaEmbafin, uo_SelEspecie.Codigo, uo_selvari.Codigo, uo_SelProductor.Codigo, uo_selpacking.Codigo )
