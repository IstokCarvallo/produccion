$PBExportHeader$w_mant_deta_ctlcalplanillacerezas.srw
forward
global type w_mant_deta_ctlcalplanillacerezas from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillacerezas
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillacerezas
end type
end forward
...
global w_mant_deta_ctlcalplanillacerezas w_mant_deta_ctlcalplanillacerezas
...
public function boolean causales2 (integer ai_causal, integer ai_especie)
end prototypes
...
li_Valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_color1[il_Fila]
li_Valor2	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_color2[il_Fila]
li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_color3[il_Fila]
li_valor4 	=	Tab_1.TabPage_2.dw_Calidad.Object.ccvd_inten1[il_Fila]
li_valor5	=	Tab_1.TabPage_2.dw_Calidad.Object.ccvd_inten2[il_Fila]
li_valor6 	=	Tab_1.TabPage_2.dw_Calidad.Object.ccvd_inten3[il_Fila]
...
If IsNull(li_Valor6) Then  li_Valor6 = 0

Choose Case Columna
	Case "cpvd_color1"
		li_valor1	=	Integer(valor)
		If Integer(istr_Mant.Argumento[10]) <> 17 Then
...
//			MessageBox("Error de Consistencia", "La Suma de Color debe dar siempre 100.", StopSign!, Ok!)
//			dw_3.SetFocus()
//			Return FALSE
//		End If
End Choose
...
public function boolean cienporciento (string columna, string valor);Integer	li_valor1, li_valor2, li_valor3, li_valor4, li_valor5, li_valor6,&
         li_valor7, li_suma
String	ls_Null
...
CHOOSE CASE Columna
	...
	CASE "cpvd_calmay"
		li_valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_camay1[il_Fila]
		li_valor2   =  Integer(valor)
		li_Suma		=	li_Valor1	+ li_valor2
		IF li_suma > 100	THEN
				MessageBox("Error de Consistencia", "Valor no debe exceder el 100%", StopSign!, Ok!)
	...
	CASE "cpvd_calma2"
		li_valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_camay1[il_Fila]
		li_valor2   =  Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calmay[il_Fila]
		li_valor3	=	Integer(valor)
	...
	CASE "cpvd_calma3"
		li_valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_camay1[il_Fila]
		li_valor2   =  Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calmay[il_Fila]
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]	
		li_valor4	=	Integer(valor)
		li_Suma		=	li_Valor1	+	li_Valor2	+	li_Valor3 + li_valor4
		IF  li_suma > 100	THEN
				MessageBox("Error de Consistencia", "Valor no debe exceder el 100%", StopSign!, Ok!)
	...
	CASE "cpvd_calma4"
		...
		li_valor2   =  Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calmay[il_Fila]
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]
		li_Valor4	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]	
		li_valor5 	=	Integer(valor)
		...
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]
		li_valor4 	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]
		li_Valor5	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma4[il_Fila]		
		li_valor6 	=	Integer(valor)
		li_Suma		=	li_Valor1	+	li_Valor2	+	li_Valor3	+	li_Valor4 + li_valor5 + li_valor6 
		IF  li_suma > 100	THEN
				MessageBox("Error de Consistencia", "Valor no debe exceder el 100%", StopSign!, Ok!)
	...
	CASE "cpvd_calmen"
		...
		li_Valor4	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]		
		li_valor5 	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma4[il_Fila]
		li_valor6 	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma5[il_Fila]
		li_Valor7	=	Integer(valor)
		li_Suma		=	li_Valor1	+	li_Valor2	+	li_Valor3	+	li_Valor4 + li_valor5 + li_valor6 + li_valor7
		IF  li_suma > 100 OR	li_Suma	<	100	THEN
...
public function boolean calificacion (string columna, string valor, boolean ab_boolean);
Integer	li_cont, li_suma, li_Nula, li_Sw
...
IF IsNull(dw_3.object.cpvd_camay1[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_camay1[il_fila])
END IF
...
IF IsNull(dw_3.object.cpvd_calma2[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_calma2[il_fila])
END IF	

IF IsNull(dw_3.object.cpvd_calma3[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_calma3[il_fila])
END IF	

IF IsNull(dw_3.object.cpvd_calma4[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_calma4[il_fila])
END IF

IF IsNull(dw_3.object.cpvd_calma5[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_calma5[il_fila])
END IF
...
IF IsNull(dw_3.object.cpvd_color1[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_color1[il_fila])	
END IF	

IF IsNull(dw_3.object.cpvd_color2[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_color2[il_fila])	
END IF	

IF IsNull(dw_3.object.cpvd_color3[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_color3[il_fila])	
END IF

IF IsNull(dw_3.object.cpvd_color4[il_fila]) = FALSE THEN
	li_suma = li_suma + (dw_3.object.cpvd_color4[il_fila])	
END IF
...
public function boolean causales2 (integer ai_causal, integer ai_especie);Integer	li_Existe 
Boolean	lb_Retorno	
String 	ls_nombre

If isnull(ai_Causal) Then Return True

SELECT Count(*)
INTO	 :li_Existe 
FROM	 dbo.ctlcaldanoespecie
WHERE	 espe_codigo	=	:ai_especie
AND    ccda_secuen	=	:ai_Causal;
...
on w_mant_deta_ctlcalplanillacerezas.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillacerezas.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
IF istr_mant.Argumento[22] ='0'OR dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModified!  THEN 		
		...
		ias_campo[64]  =  String(dw_1.Object.cpvd_hombla[il_fila])

//parrafo comentado 20140929
//		IF ias_campo[54] = 'A' THEN
//			dw_5.Object.cpvd_rescaj.protect = 0
//			//dw_5.Object.cpvd_secuen.protect = 1             				  
//			//dw_5.Object.cpvd_secuen.BackGround.Color	=	RGB(192,192,192)
//		ELSE
//			dw_5.Object.cpvd_rescaj.protect = 1
//			//dw_5.Object.cpvd_secuen.protect = 0             				  
//			//dw_5.Object.cpvd_secuen.BackGround.Color	=	RGB(255,255,255)
//		END IF	      
...
event ue_deshace;call super::ue_deshace;IF istr_mant.Argumento[22] ='0'OR dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModified!  THEN
	IF UpperBound(ias_campo) > 0 THEN
		...
		dw_1.SetItem(il_fila, "cpvd_hombla", Integer(ias_campo[64]))
...
SetNull(li_Nula)
/*
se valida por requerimiento de VCosta correo  07-11-2012
*/
li_suma  = 0 
...
If li_suma > 100 Then
	MessageBox("Error de Consistencia", "La Suma de Calibres No debe Ser Superior a 100.", StopSign!, Ok!)
	dw_3.SetFocus()
	Message.DoubleParm = -1	
End If
...
End If
/*
Vallida Intensidad de Color solo en Variedad Reinier
*/
If Integer(istr_Mant.Argumento[10]) = 17 Then
	If IsNull(dw_3.object.ccvd_inten1[il_fila]) = FALSE Then
		li_suma = li_suma + (dw_3.object.ccvd_inten1[il_fila])	
	End If
	
	If IsNull(dw_3.object.ccvd_inten2[il_fila]) = FALSE Then
		li_suma = li_suma + (dw_3.object.ccvd_inten2[il_fila])	
	End If
	
	If IsNull(dw_3.object.ccvd_inten3[il_fila]) = FALSE Then
		li_suma = li_suma + (dw_3.object.ccvd_inten3[il_fila])	
	End If
End if
/*
comentado porrequerimiento de VCosta correo  23-10-2013
...
If li_suma = 0 Then
	MessageBox("Error ", "No puede calificar si no ha ingresado calidad color.", StopSign!, Ok!)
End If
*/
...
/*20140929 se agrega scrip en reemplazo de parrafo anterior*/
IF IsNull(dw_5.object.cpvd_rescaj[il_fila]) or Trim(dw_5.object.cpvd_rescaj[il_fila]) = '' THEN
	li_cont ++
	ls_mensaje		 	= ls_mensaje + "~rResolución Caja"
	ls_colu[li_cont] 	= "cpvd_rescaj"
ELSE
...
dw_2.object.cpvd_cobjem.Background.color	= 553648127
dw_3.object.cpvd_cobjca.Background.color	= 553648127
dw_4.object.cpvd_cobjco.Background.color	= 553648127

If Integer(Istr_Mant.Argumento[10]) <> 17 Then
	dw_3.Object.ccvd_inten1.Protect = 1
	dw_3.Object.ccvd_inten2.Protect = 1
	dw_3.Object.ccvd_inten3.Protect = 1
	dw_3.Object.ccvd_inten1.Background.color	= 553648127
	dw_3.Object.ccvd_inten2.Background.color	= 553648127
	dw_3.Object.ccvd_inten3.Background.color	= 553648127
End if
...
This.Height			=	dw_1.Height + Tab_1.Height + 500
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillacerezas
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillacerezas
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillacerezas
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillacerezas
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillacerezas
integer x = 2962
integer y = 344
integer taborder = 40
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillacerezas
integer x = 2958
integer y = 116
integer taborder = 30
...
Else
	If Not istr_mant.borra Then  /*solo borrar*/		
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillacerezas
integer x = 2958
integer y = 532
integer taborder = 50
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillacerezas
integer y = 88
integer width = 2702
integer height = 632
string dataobject = "dw_mant_ctlcalplanillacerezas"
end type
...
integer height = 804
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillacerezas_embalaje"
...
Choose Case ls_Columna			
	Case  "cpvd_paleti","cpvd_rotula","cpvd_materi","cpvd_empaq", "cpvd_aparie"
		...
		If data='M' OR dw_2.Object.cpvd_paleti[row] = 'M' OR dw_2.Object.cpvd_rotula[row] = 'M' OR  &
			dw_2.Object.cpvd_materi[row] = 'M'OR dw_2.Object.cpvd_empaq[row] = 'M' OR dw_2.Object.cpvd_aparie[row] = 'M' Then
			This.SetItem(Row, "cpvd_resemb",'M')
       		dw_2.Object.cpvd_cobjem.protect = 0
			dw_2.object.cpvd_cobjem.Background.color = RGB(255, 255, 255)
			dw_2.SetItem(il_fila, "cpvd_cobjem", Long(ls_nula))
			//dw_2.setcolumn("cpvd_cobjem")
   			dw_2.setfocus()
		ElseIf data <> 'M' Then
			dw_2.Object.cpvd_cobjem.protect = 1
			dw_2.object.cpvd_cobjem.Background.color = RGB(192, 192, 192)
			This.SetItem(il_fila,"cpvd_cobjem", Long(ls_nula))
			This.SetItem(Row, "cpvd_resemb",'B')
		End If
	...
	Case "cpvd_resemb"//calIficacion embalaje
		...
		Else			
			...
			ElseIf data <> 'M' Then
				...
				dw_2.object.cpvd_cobjem.Background.color = RGB(192, 192, 192)
				This.SetItem(il_fila,"cpvd_cobjem", Long(ls_nula))
				This.SetItem(il_fila,"cpvd_porob1", Long(ls_nula))				
			...
			ElseIf ls_resolucioncaja = 'O' Then
				tab_1.Tabpage_4.dw_resolucion.Object.cpvd_rescaj.protect = 1
		...
		Case  "cpvd_muest1","cpvd_muest2","cpvd_muest3","cpvd_muest4","cpvd_muest5", &
				"cpvd_muest6","cpvd_muest7","cpvd_muest8","cpvd_muest9","cpvd_mues10",&
				"cpvd_mues11","cpvd_mues12","cpvd_mues13","cpvd_mues14","cpvd_mues15", &
				"cpvd_mues16","cpvd_mues17","cpvd_mues18","cpvd_mues19","cpvd_mues20"
...
integer height = 788
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillacerezas_calidad"
boolean vscrollbar = false
end type
...
Choose Case ls_Columna			
	Case "cpvd_camay1","cpvd_calmay","cpvd_calma2","cpvd_calma3","cpvd_calma4","cpvd_calma5","cpvd_calmen"
//		Comentado por requerimiemto de VCosta correo 20121109
//		If Not Calificacion(ls_columna,data,False) Then
//			         
//		ElseIf  Not CienporCiento(ls_columna,data)	Then 
//			
//		End If
		
	Case "cpvd_color4"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","% de Cubrimiento no puede ser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_color4",li_Nula)
			dw_Calidad.SetColumn("cpvd_color4")
			Return 1
		End If
			
	Case "cpvd_color1","cpvd_color2","cpvd_color3", "ccvd_inten1", "ccvd_inten2", "ccvd_inten3"
		//		Comentado por requerimiemto de VCosta correo 20131024
	...
	Case	"cpvd_ausped"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Ausencia de Pedicelo no puede wser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_ausped",li_Nula)
			dw_Calidad.SetColumn("cpvd_ausped")
			Return 1
		End If
  ...
  Case	"cpvd_heridas"
	...
	Case	"cpvd_mandor"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Mancha Dorada no puede ser mayor a 100")
	...
	Case	"cpvd_golsol"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Golpe de Sol no puede ser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_golsol",li_Nula)
			dw_Calidad.SetColumn("cpvd_golsol")
			Return 1
		End If
	...
	Case "cpvd_mancha"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Manchas  no puede ser Mayor a 100")
	...
	Case "cpvd_rescal"
		...
		Comentado por requerimiemto de VCosta correo 20121109
		*/
		/*If Not Calificacion(ls_columna,data,True) Then
		...
		Else
	         If data='M' Then
				...
				dw_3.SetItem(il_fila, "cpvd_porob2", Long(ls_nula))
	...
	Case "cpvd_cobjca"
		If Not valida_causal(ls_Columna,Integer(Data)) Then
			dw_3.SetItem(Row, "cpvd_cobjca", li_Nula)
			Return 1
		End If
...
integer height = 760
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillacerezas_condicion"
boolean vscrollbar = false
end type
...
Choose Case ls_Columna
	...
	Case "cpvd_herabi"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Herida Abierta no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_herabi")
			Return 1
		End If
	...
	Case "cpvd_medlun"	
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Media Luna no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_medlun")
			Return 1
		End If
	...
	Case "cpvd_ausped"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Ausencia de pedicelo no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_ausped")
			Return 1
		End If
	...
	Case "cpvd_frubla"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Frutos Blandos no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_frubla")
			Return 1
		End If
	...
	Case "cpvd_pudric"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Pudrición no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_pudric")
			Return 1
		End If
	...
	Case "cpvd_deship"	
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Deshidratación pedicelo puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_deship")
			Return 1
		End If
	...
	Case "cpvd_pittin"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Pitting puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_pittin")
			Return 1
		End If
	...
	Case "cpvd_machuc"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Machucon puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_machuc")
			Return 1
		End If
	...
	Case "cpvd_desgap"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","desgarro pedicelar puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_desgap")
			Return 1
		End If
	...
	Case "cpvd_desfru"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","deshidratación frutos no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
			This.SetColumn("cpvd_desfru")
			Return 1
		End If
	...
	Case "cpvd_rescon"
		...
		Else
			...
			If data='M' Then
				...
				dw_4.SetItem(il_fila, "cpvd_porob3", Long(ls_nula))
	...
	Case "cpvd_cobjco"
		If Not valida_causal(ls_Columna,Integer(Data)) Then
			dw_4.SetItem(Row, "cpvd_cobjco", li_Nula)
			Return 1
		End If
	...
	Case "cpvd_hombla"
		If Integer(Data)	>	100	Then
			MessageBox("Atención","Hombros Blandos no puede ser mayor a 100")
			This.SetITem(il_Fila,ls_columna,li_Nula)
...
integer height = 664
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillacerezas_resolucion"
boolean vscrollbar = false
end type

event itemchanged;ib_modIfica = True

String		ls_Columna, ls_Nula, ls_resolucioncaja
Integer	li_Nula
...
CHOOSE CASE ls_Columna
	...
	Case	"cpvd_cobjca"
		If Causales2(Integer(data),Integer(istr_mant.argumento[9])) Then
			...
			Return 1
//		Else
//			If Not isnull(data) AND (isnull(This.Object.cpvd_cobjem[il_fila]) OR isnull(This.Object.cpvd_porob1[il_fila])) Then
//				MessageBox("Error de Consistencia", "Falta el ingreso de Causal 1 y Su Respectivo %.", StopSign!, Ok!)
//				This.SetItem(il_fila, "cpvd_cobjca", li_Nula)
//				Return 1
//			End If
		End If
	...
	Case	"cpvd_cobjco"
		If Causales2(Integer(data),Integer(istr_mant.argumento[9])) Then
			...
			Return 1
//		Else
//			If Not isnull(data) AND (isnull(This.Object.cpvd_cobjca[il_fila]) OR isnull(This.Object.cpvd_porob2[il_fila])) Then
//				MessageBox("Error de Consistencia", "Falta el ingreso de Causal 2 y Su Respectivo %.", StopSign!, Ok!)	
//				This.SetItem(il_fila, "cpvd_cobjco", li_Nula)
//				Return 1
//			End If
		End If
...
//	Case "cpvd_porob2"
//		If isnull(This.Object.cpvd_cobjca[il_fila]) Then
//			MessageBox("Error de Consistencia", "Falta el ingreso de Causal 2.", StopSign!, Ok!)	
//			This.SetItem(il_fila, "cpvd_porob2", li_Nula)
//			Return 1
//		End If
//			
//	Case "cpvd_porob3"
//		If isnull(This.Object.cpvd_cobjco[il_fila]) Then
//			MessageBox("Error de Consistencia", "Falta el ingreso de Causal 3.", StopSign!, Ok!)
