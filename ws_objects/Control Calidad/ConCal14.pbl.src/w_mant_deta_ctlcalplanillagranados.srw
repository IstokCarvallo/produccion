$PBExportHeader$w_mant_deta_ctlcalplanillagranados.srw
forward
global type w_mant_deta_ctlcalplanillagranados from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillagranados
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillagranados
end type
end forward
...
global w_mant_deta_ctlcalplanillagranados w_mant_deta_ctlcalplanillagranados
...
on w_mant_deta_ctlcalplanillagranados.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillagranados.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
event ue_deshace;call super::ue_deshace;IF ias_campo[54]	<>	'' OR Not IsNull(ias_campo[54]) THEN
	IF istr_mant.Argumento[22] ='0'OR dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModified!  THEN
...
IF IsNull(dw_5.object.cpvd_rescom[il_fila]) or dw_5.object.cpvd_rescom[il_fila] = '' THEN
	li_cont ++
	ls_mensaje		 	= ls_mensaje + "~rResolución Comercial"
	ls_colu[li_cont] 	= "cpvd_rescom"
END IF
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillagranados
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillagranados
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillagranados
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillagranados
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillagranados
integer x = 2958
integer y = 344
integer taborder = 50
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillagranados
integer x = 2949
integer y = 140
integer taborder = 40
end type
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillagranados
integer x = 2958
integer y = 544
integer taborder = 60
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillagranados
integer y = 116
integer width = 2597
integer height = 636
string dataobject = "dw_mant_ctlcalplanillagranados"
end type
...
integer height = 780
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillagranados_embalaje"
	...
	Case "cpvd_resemb"//calIficacion embalaje
		...
		Else
			...
			If ls_resolucioncaja = 'A' Then
				...
				tab_1.Tabpage_4.dw_resolucion.Object.cpvd_rescom.protect = 0
				tab_1.Tabpage_4.dw_resolucion.SetItem(il_fila, "cpvd_rescom", 'A')
			...
			ElseIf ls_resolucioncaja = 'O' Then
				...
				tab_1.Tabpage_4.dw_resolucion.Object.cpvd_rescom.protect = 0
				tab_1.Tabpage_4.dw_resolucion.SetItem(il_fila, "cpvd_rescom", 'O')
...
integer height = 1024
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillagranados_calidad"
boolean vscrollbar = false
end type
...
CHOOSE Case ls_Columna
  Case	"cpvd_heridas"
	...
	Case "cpvd_corrot"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Corona Rotas no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
			dw_Calidad.SetColumn("cpvd_russet")
			Return 1
		End If
	...
	Case "cpvd_sobcat"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Sobre categoria no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
			dw_Calidad.SetColumn("cpvd_russet")
			Return 1
		End If
	...
	Case "cpvd_grieta"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Grietas Peduncular no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
			dw_Calidad.SetColumn("cpvd_grieta")
			Return 1
		End If
		
	Case "cpvd_grilat"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Grietas lateral no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
			dw_Calidad.SetColumn("cpvd_grilat")
			Return 1
		End If

	Case "cpvd_deform"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Grietas no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
...
integer height = 644
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillagranados_condicion"
boolean vscrollbar = false
end type
...
integer height = 768
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillagranados_resolucion"
boolean vscrollbar = false
end type
