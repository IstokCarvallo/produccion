$PBExportHeader$w_mant_deta_ctlcalplanillakiwis.srw
forward
global type w_mant_deta_ctlcalplanillakiwis from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillakiwis
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillakiwis
end type
end forward
...
global w_mant_deta_ctlcalplanillakiwis w_mant_deta_ctlcalplanillakiwis
...
public function boolean cienporciento (string columna, string valor);Integer	li_valor1, li_valor2, li_valor3, li_valor4, li_valor5, li_valor6, li_suma
String	ls_Null
...
CHOOSE CASE Columna
	...
	CASE "cpvd_calma3"
		li_Valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calmay[il_Fila]
		li_Valor2	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]
		li_valor3	=	Integer(valor)
		li_Suma		=	li_Valor1	+	li_Valor2	+	li_Valor3
		IF  li_suma > 100	THEN
				MessageBox("Error de Consistencia", "Valor no debe exceder el 100%", StopSign!, Ok!)
	...
	CASE "cpvd_calma4"
		li_Valor1	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calmay[il_Fila]
		li_Valor2	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]		
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]		
		li_valor4 	=	Integer(valor)
		li_Suma		=	li_Valor1	+	li_Valor2	+	li_Valor3	+	li_Valor4
		IF  li_suma > 100	THEN
				MessageBox("Error de Consistencia", "Valor no debe exceder el 100%", StopSign!, Ok!)
		...
		li_Valor2	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma2[il_Fila]		
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]
		li_Valor4	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma4[il_Fila]		
	...
	CASE "cpvd_calmen"
		...
		li_Valor3	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma3[il_Fila]		
		li_valor4 	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma4[il_Fila]
		li_valor5 	=	Tab_1.TabPage_2.dw_Calidad.Object.cpvd_calma5[il_Fila]
...
public function boolean causales (integer ai_causa, integer ai_especie);Integer	li_Causal, li_Existe 
Boolean	lb_Retorno	
li_Causal	=	ai_causa
...
public function long existepallet (integer ai_cliente, integer ai_planta, long al_lote, long al_pallet);Integer	li_existepallet,li_existeplanilla
Long		ll_ccajas
string  ls_planilla
...
on w_mant_deta_ctlcalplanillakiwis.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillakiwis.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
IF istr_mant.Argumento[22] ='0'OR dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModified!  THEN 		
		...
		ias_campo[64]	=	String(dw_1.Object.cpvd_firpu3[il_fila])
		ias_campo[65]	=	String(dw_1.Object.cpvd_firpu4[il_fila])
		ias_campo[66]  =  String(dw_1.Object.cpvd_bajfir[il_fila])
		ias_campo[67]  =  String(dw_1.Object.cpvd_firbla[il_fila])
		ias_campo[68]  =  String(dw_1.Object.cpvd_profir[il_fila])
			
//		if dw_5.Object.cpvd_rescaj[1] = "A" and dw_5.Object.cpvd_rescom[1] =  "A" then
//			dw_5.Object.cpvd_rescom.protect = 1
//			dw_5.Object.cpvd_respal.protect = 1
//		end if
		
		if dw_5.Object.cpvd_rescaj[1] = "O" and dw_5.Object.cpvd_rescom[1] =  "O" then
			dw_5.Object.cpvd_respal.protect = 0
		end if
		
		IF dw_5.Object.cpvd_rescaj[il_fila] = "O" AND  isnull(dw_5.Object.cpvd_rescom[il_fila]) THEN
			dw_5.Object.cpvd_rescom.protect = 0
		END IF	
		
//		if dw_5.Object.cpvd_rescaj[1] = "O" and dw_5.Object.cpvd_rescom[1] =  "A" then
//			dw_5.Object.cpvd_respal.protect = 1
//		end if
...
event ue_deshace;call super::ue_deshace;IF istr_mant.Argumento[22] ='0'OR dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModified!  THEN
	IF UpperBound(ias_campo) > 0 THEN
		...
		dw_1.SetItem(il_fila, "cpvd_firpu3", Dec(ias_campo[64]))
		dw_1.SetItem(il_fila, "cpvd_firpu4", Dec(ias_campo[65]))
		dw_1.SetItem(il_fila, "cpvd_bajfir", Dec(ias_campo[66]))
		dw_1.SetItem(il_fila, "cpvd_firbla", Dec(ias_campo[67]))
		dw_1.SetItem(il_fila, "cpvd_profir", Dec(ias_campo[68]))
		dw_1.SetItem(il_fila, "cpvd_numpal", Long(ias_campo[70]))
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillakiwis
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillakiwis
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillakiwis
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillakiwis
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillakiwis
integer x = 2962
integer y = 344
integer taborder = 50
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillakiwis
integer x = 2958
integer y = 156
integer taborder = 40
end type
...
ELSE
	 IF istr_mant.borra = FALSE THEN  /*solo borrar*/	
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillakiwis
integer x = 2958
integer y = 532
integer taborder = 60
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillakiwis
integer y = 116
integer width = 2651
integer height = 668
string dataobject = "dw_mant_ctlcalplanillakiwis"
end type
...
integer height = 816
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillakiwis_embalaje"
...
Choose Case ls_Columna			
	Case  "cpvd_paleti","cpvd_rotula","cpvd_materi","cpvd_empaq", "cpvd_aparie"
		...
		If data = 'M' Then	
			...
			This.Object.cpvd_cobjem.protect = 0
			This.object.cpvd_cobjem.Background.color = RGB(255, 255, 255)
//			This.setcolumn("cpvd_cobjem")
		End If
...
integer height = 784
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillakiwis_calidad"
boolean vscrollbar = false
end type
...
CHOOSE CASE ls_Columna			
	CASE "cpvd_calmay","cpvd_calmen"
			
	CASE	"cpvd_deform"
		
		IF Integer(Data)	>	100	THEN
			MessageBox("Atención","Planos no puede ser mayor a 100")
	...
	CASE	"cpvd_defor2"
		...
		IF Integer(Data)	>	100	THEN
			MessageBox("Atención","Abanicos no puede ser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_defor2",li_Nula)
			dw_Calidad.SetColumn("cpvd_defor2")
			RETURN 1
		END IF
  	...
  	CASE	"cpvd_defor3"
		...
		IF Integer(Data)	>	100	THEN
			MessageBox("Atención","Hombros Caídos no puede ser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_defor3",li_Nula)
			dw_Calidad.SetColumn("cpvd_defor3")
			RETURN 1
		END IF
		...
		IF Integer(Data)	>	100	THEN
			MessageBox("Atención","Otros Deformes no puede ser mayor a 100")
			dw_Calidad.SetITem(il_Fila,"cpvd_defor4",li_Nula)
			dw_Calidad.SetColumn("cpvd_defor4")
			RETURN 1
		END IF
...
integer height = 608
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillakiwis_condicion"
boolean vscrollbar = false
end type
...
integer height = 760
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillakiwis_resolucion"
boolean vscrollbar = false
end type
...
//		END IF 
  ...
  CASE "cpvd_respal"
	...
	Case	"cpvd_portot"		
			If Integer(data) > 100.00 Then
				MessageBox('Atencion', 'Valor no puede ser mayor a 100') 
				This.SetItem(il_fila, "cpvd_portot", li_Nula)
				RETURN 1 
			End If		
