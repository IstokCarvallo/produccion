$PBExportHeader$w_mant_deta_ctlcalplanillaciruelas.srw
forward
global type w_mant_deta_ctlcalplanillaciruelas from w_mant_detalle_csd
end type
type tab_1 from tab within w_mant_deta_ctlcalplanillaciruelas
end type
...
type dw_7 from datawindow within w_mant_deta_ctlcalplanillaciruelas
end type
end forward
...
global w_mant_deta_ctlcalplanillaciruelas w_mant_deta_ctlcalplanillaciruelas
...
on w_mant_deta_ctlcalplanillaciruelas.create
int iCurrent
call super::create
...
on w_mant_deta_ctlcalplanillaciruelas.destroy
call super::destroy
destroy(this.tab_1)
destroy(this.dw_7)
end on
...
If ias_campo[54]	<>	'' Or Not IsNull(ias_campo[54]) Then
	...
	If istr_mant.Argumento[22] ='0' Or dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModIfied!  Then 		
		...
		ias_campo[69]  =  String(dw_1.Object.cpvd_danins[il_fila])
		ias_campo[70]  =  String(dw_1.Object.cpvd_carpar[il_fila])
		ias_campo[71]  =  String(dw_1.Object.cpvd_sobmad[il_fila])
...
event ue_deshace;call super::ue_deshace;If ias_campo[54]	<>	'' Or Not IsNull(ias_campo[54]) Then
	If istr_mant.Argumento[22] ='0' Or dw_1.GetItemStatus(il_Fila, 0, Primary!) = NewModIfied!  Then
		If UpperBound(ias_campo) > 0 Then
			...
			dw_1.SetItem(il_fila, "cpvd_danins", Dec(ias_campo[69]))
			dw_1.SetItem(il_fila, "cpvd_carpar", Dec(ias_campo[70]))
			dw_1.SetItem(il_fila, "cpvd_sobmad", Dec(ias_campo[71]))
		End If
	End If
End If
end event
...
type pb_ultimo from w_mant_detalle_csd`pb_ultimo within w_mant_deta_ctlcalplanillaciruelas
end type

type pb_siguiente from w_mant_detalle_csd`pb_siguiente within w_mant_deta_ctlcalplanillaciruelas
end type

type pb_anterior from w_mant_detalle_csd`pb_anterior within w_mant_deta_ctlcalplanillaciruelas
end type

type pb_primero from w_mant_detalle_csd`pb_primero within w_mant_deta_ctlcalplanillaciruelas
end type

type pb_cancela from w_mant_detalle_csd`pb_cancela within w_mant_deta_ctlcalplanillaciruelas
integer x = 2962
integer y = 344
integer taborder = 50
end type

type pb_acepta from w_mant_detalle_csd`pb_acepta within w_mant_deta_ctlcalplanillaciruelas
integer x = 2958
integer y = 156
integer taborder = 40
end type

event pb_acepta::clicked;call super::clicked;//istr_mant.respuesta = 1
//
//IF istr_mant.agrega THEN
...
type pb_salir from w_mant_detalle_csd`pb_salir within w_mant_deta_ctlcalplanillaciruelas
integer x = 2958
integer y = 532
integer taborder = 60
end type

type dw_1 from w_mant_detalle_csd`dw_1 within w_mant_deta_ctlcalplanillaciruelas
integer y = 116
integer width = 2565
integer height = 600
string dataobject = "dw_mant_ctlcalplanillaciruelas"
end type
...
integer height = 780
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillaciruelas_embalaje"
...
integer height = 1024
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillaciruelas_calidad"
boolean vscrollbar = false
end type
...
Choose Case ls_Columna
  Case	"cpvd_heridas"
	...
	Case "cpvd_deform"
		If	Integer(Data)	>	100	Then
			MessageBox("Atención","Deforme no puede ser Mayor a 100")
			dw_Calidad.SetItem(il_Fila,ls_Columna,li_Nula)
...
integer height = 676
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillaciruelas_condicion"
boolean vscrollbar = false
end type
...
integer height = 480
integer taborder = 11
string dataobject = "dw_mant_ctlcalplanillaciruelas_resolucion"
boolean vscrollbar = false
end type
