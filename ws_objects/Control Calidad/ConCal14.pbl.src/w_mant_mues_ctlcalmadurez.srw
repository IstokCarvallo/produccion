$PBExportHeader$w_mant_mues_ctlcalmadurez.srw
$PBExportComments$Mantenedor de Solidos Solubles por Especie
forward
global type w_mant_mues_ctlcalmadurez from w_mant_directo
end type
type st_1 from statictext within w_mant_mues_ctlcalmadurez
end type
type uo_selespecie from uo_seleccion_especie within w_mant_mues_ctlcalmadurez
end type
end forward
...
global w_mant_mues_ctlcalmadurez w_mant_mues_ctlcalmadurez
...
on w_mant_mues_ctlcalmadurez.create
int iCurrent
call super::create
...
on w_mant_mues_ctlcalmadurez.destroy
call super::destroy
destroy(this.st_1)
...
For ll_Fila	= 1 To dw_1.RowCount()
	If Isnull(dw_1.Object.madu_codigo[ll_Fila]) OR dw_1.Object.madu_codigo[ll_Fila] = 0 Then
		li_cont ++
		ls_mensaje 			= ls_mensaje + "~nCódigo de Parametros Madurez"
		ls_colu[li_cont]	= "madu_codigo"
	End If
	
	If Isnull(dw_1.Object.madu_nombre[ll_Fila]) OR dw_1.Object.madu_nombre[ll_Fila] = "" Then
		li_cont ++
		ls_mensaje 			= ls_mensaje + "~nDescripción de Parametros Madurez"
...
event ue_nuevo;call super::ue_nuevo;dw_1.SetColumn('madu_codigo')
end event

type st_encabe from w_mant_directo`st_encabe within w_mant_mues_ctlcalmadurez
integer x = 82
integer y = 52
integer width = 2263
integer height = 220
...
type pb_nuevo from w_mant_directo`pb_nuevo within w_mant_mues_ctlcalmadurez
integer x = 2482
integer y = 404
integer taborder = 40
end type
...
type pb_lectura from w_mant_directo`pb_lectura within w_mant_mues_ctlcalmadurez
integer y = 136
integer taborder = 30
end type
...
type pb_eliminar from w_mant_directo`pb_eliminar within w_mant_mues_ctlcalmadurez
integer y = 792
integer taborder = 60
end type

type pb_insertar from w_mant_directo`pb_insertar within w_mant_mues_ctlcalmadurez
integer y = 612
integer taborder = 50
end type

type pb_salir from w_mant_directo`pb_salir within w_mant_mues_ctlcalmadurez
integer y = 1536
integer taborder = 90
end type

type pb_imprimir from w_mant_directo`pb_imprimir within w_mant_mues_ctlcalmadurez
integer y = 1152
integer taborder = 80
end type

type pb_grabar from w_mant_directo`pb_grabar within w_mant_mues_ctlcalmadurez
integer y = 972
integer taborder = 70
end type

type dw_1 from w_mant_directo`dw_1 within w_mant_mues_ctlcalmadurez
integer x = 82
integer y = 292
integer width = 2263
integer height = 1472
