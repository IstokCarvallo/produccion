$PBExportHeader$w_busc_ctlcalplanillamadurez.srw
forward
global type w_busc_ctlcalplanillamadurez from w_busqueda
end type
end forward
...
global w_busc_ctlcalplanillamadurez w_busc_ctlcalplanillamadurez
...
is_ordena = 'Planilla:pmen_numero,Zona:zona_codigo,Productor:prod_codigo,Predio:prpr_codigo,Cuartel:prcc_codigo'
...
on w_busc_ctlcalplanillamadurez.create
call super::create
end on

on w_busc_ctlcalplanillamadurez.destroy
call super::destroy
end on
...
istr_busq.argum[5]	= String(dw_1.GetItemNumber(dw_1.GetRow(), "pmen_numero"))

CloseWithReturn(This, istr_busq)
end event

type pb_insertar from w_busqueda`pb_insertar within w_busc_ctlcalplanillamadurez
...
type dw_1 from w_busqueda`dw_1 within w_busc_ctlcalplanillamadurez
integer y = 760
integer width = 2551
integer height = 900
integer taborder = 60
string dataobject = "dw_mues_ctlcalpanillamadurezenca"
end type

type pb_salir from w_busqueda`pb_salir within w_busc_ctlcalplanillamadurez
integer x = 2747
integer y = 1412
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_ctlcalplanillamadurez
integer x = 73
integer y = 96
integer width = 2555
integer height = 628
