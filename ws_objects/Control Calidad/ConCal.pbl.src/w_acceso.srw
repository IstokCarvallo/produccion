...
SELECT empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,
		 ...
		 empr_disco,empr_especi,empr_varied,empr_embala,empr_zona//,empr_passwd
 INTO :empr_razsoc,:empr_nombre,:empr_rutemp,:empr_direcc,:empr_comuna,:empr_ciudad,:empr_giroem,&
      :empr_nrotel,:empr_nrofax,:empr_repleg,:empr_rutrle,:gi_codexport,:gi_codplanta,:empr_oficin,&
		:gs_disco,:gi_CodEspecie,:gi_CodVariedad,:gs_CodEmbalaje,:gi_CodZona//,:gs_Password
 FROM dbo.parempresa;
 
 IF sqlca.SQLCode	= -1 THEN
	F_ErrorBaseDatos(sqlca, "Lectura de Usuarios Tabla ParamEmpresa")
	RETURN
END IF
...
string picturename = "\Desarrollo 17\Imagenes\Sistemas\control_calidad.jpg"
end type
