$PBExportHeader$w_busc_lotes.srw
...
forward
global type w_busc_lotes from w_busqueda
end type
end forward
...
global w_busc_lotes w_busc_lotes
...
on w_busc_lotes.create
call super::create
end on

on w_busc_lotes.destroy
call super::destroy
end on

event open;/*Argumetno
istr_busq.argum[1]	=  Cliente
istr_busq.argum[2]	=	Planta
istr_busq.argum[3]	=	Productor
istr_busq.argum[4]	=	Especie
istr_busq.argum[5]	=	Variedad
istr_busq.argum[6]	=	Embalaje
istr_busq.argum[7]	=	Calibre
istr_busq.argum[8]	=	Packing
istr_busq.argum[9]	=	Fecha Embalaje
istr_busq.argum[10]	=	Tamaño Lote
istr_busq.argum[11]	=	Número Lote
istr_busq.argum[12]	=	Fecha de Aprobación
istr_busq.argum[13]	=	Estado
...
dw_1.Retrieve(Integer(istr_busq.argum[2]),&
				  long(istr_busq.argum[3]),Integer(istr_busq.argum[4]),&
				  Integer(istr_busq.argum[5]),istr_busq.argum[6],&
			     istr_busq.argum[7],Integer(istr_busq.argum[8]),Date(istr_busq.argum[9]))


IF dw_1.RowCount()=0	THEN
	MessageBox("Atención","No Existen lotes con la Identificación señalada")
	istr_busq.Argum[1]	=	''
...
type pb_insertar from w_busqueda`pb_insertar within w_busc_lotes
boolean visible = false
end type

type dw_1 from w_busqueda`dw_1 within w_busc_lotes
integer y = 696
...
type pb_salir from w_busqueda`pb_salir within w_busc_lotes
end type
...
type tab_1 from w_busqueda`tab_1 within w_busc_lotes
integer x = 82
