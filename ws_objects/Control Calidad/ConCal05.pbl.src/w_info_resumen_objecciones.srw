$PBExportHeader$w_info_resumen_objecciones.srw
$PBExportComments$Ventana de Informe de Resumen Objeciones
forward
global type w_info_resumen_objecciones from w_para_informes
end type
type gb_3 from groupbox within w_info_resumen_objecciones
end type
type st_1 from statictext within w_info_resumen_objecciones
end type
type em_fechadesde from editmask within w_info_resumen_objecciones
end type
type st_44 from statictext within w_info_resumen_objecciones
end type
type st_12 from statictext within w_info_resumen_objecciones
end type
type st_13 from statictext within w_info_resumen_objecciones
end type
type em_fechahasta from editmask within w_info_resumen_objecciones
end type
type st_zona from statictext within w_info_resumen_objecciones
end type
type dw_zona from datawindow within w_info_resumen_objecciones
end type
type cbx_todoplanta from checkbox within w_info_resumen_objecciones
end type
type cbx_consplanta from checkbox within w_info_resumen_objecciones
end type
type dw_planta from datawindow within w_info_resumen_objecciones
end type
type st_33 from statictext within w_info_resumen_objecciones
end type
type dw_productor from datawindow within w_info_resumen_objecciones
end type
type cbx_todoprod from checkbox within w_info_resumen_objecciones
end type
type cbx_consprod from checkbox within w_info_resumen_objecciones
end type
type st_2 from statictext within w_info_resumen_objecciones
end type
type dw_agronomo from datawindow within w_info_resumen_objecciones
end type
type dw_variedades from datawindow within w_info_resumen_objecciones
end type
type cbx_todosvar from checkbox within w_info_resumen_objecciones
end type
type cbx_consvariedad from checkbox within w_info_resumen_objecciones
end type
type cbx_todoszona from checkbox within w_info_resumen_objecciones
end type
type cbx_conszonas from checkbox within w_info_resumen_objecciones
end type
type st_3 from statictext within w_info_resumen_objecciones
end type
type cbx_todosagro from checkbox within w_info_resumen_objecciones
end type
type cbx_consagro from checkbox within w_info_resumen_objecciones
end type
type st_5 from statictext within w_info_resumen_objecciones
end type
type dw_packing from datawindow within w_info_resumen_objecciones
end type
type cbx_todospacking from checkbox within w_info_resumen_objecciones
end type
type cbx_conspacking from checkbox within w_info_resumen_objecciones
end type
type cbx_todosfecha from checkbox within w_info_resumen_objecciones
end type
type cbx_consfecha from checkbox within w_info_resumen_objecciones
end type
type st_6 from statictext within w_info_resumen_objecciones
end type
type em_embalaje from editmask within w_info_resumen_objecciones
end type
type cb_buscaembalaje from commandbutton within w_info_resumen_objecciones
end type
type em_descripcion from editmask within w_info_resumen_objecciones
end type
type cbx_todosemb from checkbox within w_info_resumen_objecciones
end type
type cbx_consembalaje from checkbox within w_info_resumen_objecciones
end type
type st_7 from statictext within w_info_resumen_objecciones
end type
type cbx_todoscalibre from checkbox within w_info_resumen_objecciones
end type
type cbx_conscalibre from checkbox within w_info_resumen_objecciones
end type
type em_calibre from editmask within w_info_resumen_objecciones
end type
type gb_4 from groupbox within w_info_resumen_objecciones
end type
type st_8 from statictext within w_info_resumen_objecciones
end type
type st_11 from statictext within w_info_resumen_objecciones
end type
type dw_especie from datawindow within w_info_resumen_objecciones
end type
type st_9 from statictext within w_info_resumen_objecciones
end type
type st_10 from statictext within w_info_resumen_objecciones
end type
type st_4 from statictext within w_info_resumen_objecciones
end type
end forward
...
integer width = 2967
integer height = 1792
string title = "Resoluciones con Distribución de Objeciones"
...
global w_info_resumen_objecciones w_info_resumen_objecciones
...
on w_info_resumen_objecciones.create
int iCurrent
call super::create
...
this.Control[iCurrent+8]=this.st_zona
this.Control[iCurrent+9]=this.dw_zona
this.Control[iCurrent+10]=this.cbx_todoplanta
this.Control[iCurrent+11]=this.cbx_consplanta
this.Control[iCurrent+12]=this.dw_planta
this.Control[iCurrent+13]=this.st_33
this.Control[iCurrent+14]=this.dw_productor
this.Control[iCurrent+15]=this.cbx_todoprod
this.Control[iCurrent+16]=this.cbx_consprod
this.Control[iCurrent+17]=this.st_2
this.Control[iCurrent+18]=this.dw_agronomo
this.Control[iCurrent+19]=this.dw_variedades
this.Control[iCurrent+20]=this.cbx_todosvar
this.Control[iCurrent+21]=this.cbx_consvariedad
this.Control[iCurrent+22]=this.cbx_todoszona
this.Control[iCurrent+23]=this.cbx_conszonas
this.Control[iCurrent+24]=this.st_3
this.Control[iCurrent+25]=this.cbx_todosagro
this.Control[iCurrent+26]=this.cbx_consagro
this.Control[iCurrent+27]=this.st_5
this.Control[iCurrent+28]=this.dw_packing
this.Control[iCurrent+29]=this.cbx_todospacking
this.Control[iCurrent+30]=this.cbx_conspacking
this.Control[iCurrent+31]=this.cbx_todosfecha
this.Control[iCurrent+32]=this.cbx_consfecha
this.Control[iCurrent+33]=this.st_6
this.Control[iCurrent+34]=this.em_embalaje
this.Control[iCurrent+35]=this.cb_buscaembalaje
this.Control[iCurrent+36]=this.em_descripcion
this.Control[iCurrent+37]=this.cbx_todosemb
this.Control[iCurrent+38]=this.cbx_consembalaje
this.Control[iCurrent+39]=this.st_7
this.Control[iCurrent+40]=this.cbx_todoscalibre
this.Control[iCurrent+41]=this.cbx_conscalibre
this.Control[iCurrent+42]=this.em_calibre
this.Control[iCurrent+43]=this.gb_4
this.Control[iCurrent+44]=this.st_8
this.Control[iCurrent+45]=this.st_11
this.Control[iCurrent+46]=this.dw_especie
this.Control[iCurrent+47]=this.st_9
this.Control[iCurrent+48]=this.st_10
this.Control[iCurrent+49]=this.st_4
end on

on w_info_resumen_objecciones.destroy
call super::destroy
destroy(this.gb_3)
destroy(this.st_1)
...
type st_computador from w_para_informes`st_computador within w_info_resumen_objecciones
end type

type st_usuario from w_para_informes`st_usuario within w_info_resumen_objecciones
end type

type st_temporada from w_para_informes`st_temporada within w_info_resumen_objecciones
end type

type p_logo from w_para_informes`p_logo within w_info_resumen_objecciones
end type

type st_titulo from w_para_informes`st_titulo within w_info_resumen_objecciones
integer x = 73
integer y = 64
integer width = 2464
string text = "Resoluciones con Distribución de Objeciones"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_resumen_objecciones
...
Integer	li_fila, li_planta,  li_Variedad, li_Agronomo,li_Packing, &
			li_zona, li_ConsPlanta, li_ConsPacking, li_conszonas, li_ConsAgro,&
			li_ConsFechaEmb, li_ConsCalibre, li_ConsEmbalaje, li_ConsProd,li_ConsVari,li_especie
...
ELSE
	...
	ELSE
	   ...
	   MessageBox("Atención","Debe Seleccionar un Frigorifico Previamente",Exclamation!)
		RETURN 
	   END IF
	END IF
END IF
...
IF cbx_conspacking.Checked THEN
	li_packing	 = -9
ELSE
	IF cbx_todospacking.Checked THEN
	   li_packing	 = -1
	ELSE
...
IF cbx_conscalibre.Checked THEN
	ls_calibre	= '**'
ELSE
	IF cbx_todoscalibre.Checked THEN
	   ls_calibre	= '*' 
	ELSE
...
istr_info.titulo	= 'RESOLUCIONES CON DISTRIBUCION DE OBJECIONES'

OpenWithParm(vinf,istr_info)

IF li_especie = 11 THEN
	vinf.dw_1.DataObject = "dw_info_resumen_objecciones"
ELSE
	vinf.dw_1.DataObject = "dw_informe_resumen_objecciones"	
END IF
...
type pb_salir from w_para_informes`pb_salir within w_info_resumen_objecciones
...
ELSE
	//dw_planta.Enabled 		=	FALSE
	dw_planta.Setfocus()
	dw_planta.SetItem(1, "plde_codigo", ls_nula)
END IF
RETURN 0
end event
...
ELSE
	dw_variedades.Setfocus()
	dw_variedades.SetItem(1, "vari_codigo", ls_nula)
	//dw_variedades.Enabled	=	FALSE
END IF
RETURN 0
end event
...
IF This.CheCked THEN
	...
	idwc_planta.Sort()
ELSE
	dw_zona.SetItem(1, "zona_codigo", ls_nula)
	dw_zona.SetFocus()
	//dw_planta.Enabled	=	FALSE
END IF
RETURN 0
...
IF This.CheCked THEN
	...
	dw_agronomo.SetItem(1, "ccag_codigo", Long(ls_nula))
ELSE
	dw_agronomo.SetItem(1, "ccag_codigo", ls_nula)
	dw_agronomo.SetFocus()
	//dw_agronomo.Enabled	=	FALSE
END IF
RETURN 0
...
IF This.CheCked THEN
	...
	dw_packing.SetItem(1, "plde_codigo", Long(ls_nula))
ELSE
	dw_packing.SetItem(1, "plde_codigo",ls_Nula)
	dw_packing.SetFocus()
	//dw_packing.Enabled	=	FALSE
END IF
RETURN 0
...
ELSE
	//cbx_todoscalibre.Enabled	=	FALSE
	//cbx_todoscalibre.Checked	=	FALSE
	em_calibre.Enabled	=	TRUE
	em_calibre.Setfocus()
END IF
