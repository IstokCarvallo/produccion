...
event ue_datosempresa;String	empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,empr_nrotel, &
...
SELECT empr_razsoc,empr_nombre,empr_rutemp,empr_direcc,empr_comuna,empr_ciudad,empr_giroem,
		 ...
		 empr_disco,empr_especi,empr_varied,empr_embala,empr_passwd,empr_clibas
	INTO :empr_razsoc,:empr_nombre,:empr_rutemp,:empr_direcc,:empr_comuna,:empr_ciudad,&
			...
			:gi_codplanta,:empr_oficin,:gs_disco,:gi_CodEspecie,:gi_CodVariedad,:gs_CodEmbalaje,:gs_Password,:gi_cliebase
	FROM dba.parempresa;
...
string picturename = "\Desarrollo 17\Imagenes\Sistemas\valida.jpg"
end type
